...
main(int argc, char *argv[])
{
  ...
  50:	68 af 07 00 00       	push   $0x7af
  55:	50                   	push   %eax
  56:	68 aa 07 00 00       	push   $0x7aa
  5b:	6a 01                	push   $0x1
  5d:	e8 1e 04 00 00       	call   480 <printf>
  62:	83 c4 10             	add    $0x10,%esp
  exit();
  65:	e8 b9 02 00 00       	call   323 <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax

00000070 <test_and_set>:
#include "stat.h"
#include "fcntl.h"
#include "user.h"
#include "x86.h"
...
void lock_acquire(lock_t *lock){
  ...
  96:	83 38 01             	cmpl   $0x1,(%eax)
  99:	75 05                	jne    a0 <lock_acquire+0x10>
  9b:	eb fe                	jmp    9b <lock_acquire+0xb>
  9d:	8d 76 00             	lea    0x0(%esi),%esi
  a0:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
  a6:	5d                   	pop    %ebp
  a7:	c3                   	ret    
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 b8 07 00 00 	jmp    *0x7b8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba b1 07 00 00       	mov    $0x7b1,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 44 0b 00 00       	mov    0xb44,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 44 0b 00 00    	mov    %edx,0xb44
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 44 0b 00 00    	mov    %edx,0xb44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d 44 0b 00 00    	mov    0xb44,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d 44 0b 00 00    	mov    0xb44,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 44 0b 00 00    	mov    0xb44,%edx
 ...
 75c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 75f:	89 15 44 0b 00 00    	mov    %edx,0xb44
}
 ...
 76f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 44 0b 00 00 48 	movl   $0xb48,0xb44
 777:	0b 00 00 
    base.s.size = 0;
 77a:	bf 48 0b 00 00       	mov    $0xb48,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 48 0b 00 00 48 	movl   $0xb48,0xb48
 786:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 4c 0b 00 00 00 	movl   $0x0,0xb4c
 792:	00 00 00 
    if(p->s.size >= nunits){
