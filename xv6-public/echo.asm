...
main(int argc, char *argv[])
{
  ...
  2e:	6a 01                	push   $0x1
  30:	e8 a2 03 00 00       	call   3d7 <printf>
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
  ...
  6d:	e8 8b 05 00 00       	call   5fd <malloc>
  if(n_stack == 0){
  ...
  83:	e8 9a 02 00 00       	call   322 <clone>
...
int thread_join() {
  ...
  97:	83 ec 24             	sub    $0x24,%esp
  void *stk_addr;
  int pid = join(&stk_addr);
  9a:	8d 45 f4             	lea    -0xc(%ebp),%eax
  9d:	50                   	push   %eax
  9e:	e8 87 02 00 00       	call   32a <join>
...
void lock_acquire(lock_t *lock){
  ...
  b2:	6a 01                	push   $0x1
  b4:	53                   	push   %ebx
  b5:	e8 97 ff ff ff       	call   51 <test_and_set>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 388:	0f b6 92 ec 06 00 00 	movzbl 0x6ec(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 455:	ff 24 85 94 06 00 00 	jmp    *0x694(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 4ba:	75 15                	jne    4d1 <printf+0xfa>
          s = "(null)";
 4bc:	be 8d 06 00 00       	mov    $0x68d,%esi
...
free(void *ap)
{
 ...
 549:	a1 60 0a 00 00       	mov    0xa60,%eax
 ...
 585:	89 08                	mov    %ecx,(%eax)
  freep = p;
 587:	a3 60 0a 00 00       	mov    %eax,0xa60
}
 58c:	5b                   	pop    %ebx
 58d:	5e                   	pop    %esi
 58e:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 5e4:	e8 54 ff ff ff       	call   53d <free>
  return freep;
 5e9:	a1 60 0a 00 00       	mov    0xa60,%eax
...
malloc(uint nbytes)
{
 ...
 60d:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 610:	8b 0d 60 0a 00 00    	mov    0xa60,%ecx
 ...
 61c:	eb 4a                	jmp    668 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 61e:	c7 05 60 0a 00 00 64 	movl   $0xa64,0xa60
 625:	0a 00 00 
 628:	c7 05 64 0a 00 00 64 	movl   $0xa64,0xa64
 62f:	0a 00 00 
    base.s.size = 0;
 632:	c7 05 68 0a 00 00 00 	movl   $0x0,0xa68
 639:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 63c:	b9 64 0a 00 00       	mov    $0xa64,%ecx
 ...
 64d:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 650:	89 0d 60 0a 00 00    	mov    %ecx,0xa60
      return (void*)(p + 1);
 ...
 66d:	73 d4                	jae    643 <malloc+0x46>
    if(p == freep)
 66f:	39 05 60 0a 00 00    	cmp    %eax,0xa60
