...
main(int argc, char *argv[])
{
  ...
  4c:	ff 36                	push   (%esi)
  4e:	e8 82 02 00 00       	call   2d5 <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 373:	0f b6 92 04 07 00 00 	movzbl 0x704(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 440:	ff 24 85 ac 06 00 00 	jmp    *0x6ac(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 4a5:	75 15                	jne    4bc <printf+0xfa>
          s = "(null)";
 4a7:	be a3 06 00 00       	mov    $0x6a3,%esi
...
free(void *ap)
{
 ...
 534:	a1 5c 0a 00 00       	mov    0xa5c,%eax
 ...
 570:	89 08                	mov    %ecx,(%eax)
  freep = p;
 572:	a3 5c 0a 00 00       	mov    %eax,0xa5c
}
 577:	5b                   	pop    %ebx
 578:	5e                   	pop    %esi
 579:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 5cf:	e8 54 ff ff ff       	call   528 <free>
  return freep;
 5d4:	a1 5c 0a 00 00       	mov    0xa5c,%eax
...
malloc(uint nbytes)
{
 ...
 5f8:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 5fb:	8b 0d 5c 0a 00 00    	mov    0xa5c,%ecx
 ...
 607:	eb 4a                	jmp    653 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 609:	c7 05 5c 0a 00 00 60 	movl   $0xa60,0xa5c
 610:	0a 00 00 
 613:	c7 05 60 0a 00 00 60 	movl   $0xa60,0xa60
 61a:	0a 00 00 
    base.s.size = 0;
 61d:	c7 05 64 0a 00 00 00 	movl   $0x0,0xa64
 624:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 627:	b9 60 0a 00 00       	mov    $0xa60,%ecx
 ...
 638:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 63b:	89 0d 5c 0a 00 00    	mov    %ecx,0xa5c
      return (void*)(p + 1);
 ...
 658:	73 d4                	jae    62e <malloc+0x46>
    if(p == freep)
 65a:	39 05 5c 0a 00 00    	cmp    %eax,0xa5c
