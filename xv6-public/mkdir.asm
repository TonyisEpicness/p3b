...
main(int argc, char *argv[])
{
  ...
  4c:	ff 36                	push   (%esi)
  4e:	e8 ae 02 00 00       	call   301 <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39f:	0f b6 92 30 07 00 00 	movzbl 0x730(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 46c:	ff 24 85 d8 06 00 00 	jmp    *0x6d8(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 4d1:	75 15                	jne    4e8 <printf+0xfa>
          s = "(null)";
 4d3:	be cf 06 00 00       	mov    $0x6cf,%esi
...
free(void *ap)
{
 ...
 560:	a1 98 0a 00 00       	mov    0xa98,%eax
 ...
 59c:	89 08                	mov    %ecx,(%eax)
  freep = p;
 59e:	a3 98 0a 00 00       	mov    %eax,0xa98
}
 5a3:	5b                   	pop    %ebx
 5a4:	5e                   	pop    %esi
 5a5:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 5fb:	e8 54 ff ff ff       	call   554 <free>
  return freep;
 600:	a1 98 0a 00 00       	mov    0xa98,%eax
...
malloc(uint nbytes)
{
 ...
 624:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 627:	8b 0d 98 0a 00 00    	mov    0xa98,%ecx
 ...
 633:	eb 4a                	jmp    67f <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 635:	c7 05 98 0a 00 00 9c 	movl   $0xa9c,0xa98
 63c:	0a 00 00 
 63f:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 646:	0a 00 00 
    base.s.size = 0;
 649:	c7 05 a0 0a 00 00 00 	movl   $0x0,0xaa0
 650:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 653:	b9 9c 0a 00 00       	mov    $0xa9c,%ecx
 ...
 664:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 667:	89 0d 98 0a 00 00    	mov    %ecx,0xa98
      return (void*)(p + 1);
 ...
 684:	73 d4                	jae    65a <malloc+0x46>
    if(p == freep)
 686:	39 05 98 0a 00 00    	cmp    %eax,0xa98
