...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 81 03 00 00       	call   3bb <mkdir>
...
free(void *ap)
{
 ...
 661:	a1 dc 0b 00 00       	mov    0xbdc,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 dc 0b 00 00    	mov    %edx,0xbdc
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 dc 0b 00 00    	mov    %edx,0xbdc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d dc 0b 00 00    	mov    0xbdc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d dc 0b 00 00    	mov    0xbdc,%edi
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 dc 0b 00 00    	mov    0xbdc,%edx
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 dc 0b 00 00 e0 	movl   $0xbe0,0xbdc
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf e0 0b 00 00       	mov    $0xbe0,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 e0 0b 00 00 e0 	movl   $0xbe0,0xbe0
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 e4 0b 00 00 00 	movl   $0x0,0xbe4
 7d2:	00 00 00 
    if(p->s.size >= nunits){
