...
80100046:	e8 a3 3b 00 00       	call   80103bee <acquire>
...
8010007c:	e8 d2 3b 00 00       	call   80103c53 <release>
      acquiresleep(&b->lock);
80100081:	8d 43 0c             	lea    0xc(%ebx),%eax
80100084:	89 04 24             	mov    %eax,(%esp)
80100087:	e8 4e 39 00 00       	call   801039da <acquiresleep>
      return b;
...
801000ca:	e8 84 3b 00 00       	call   80103c53 <release>
      acquiresleep(&b->lock);
801000cf:	8d 43 0c             	lea    0xc(%ebx),%eax
801000d2:	89 04 24             	mov    %eax,(%esp)
801000d5:	e8 00 39 00 00       	call   801039da <acquiresleep>
      return b;
...
80100105:	e8 a8 39 00 00       	call   80103ab2 <initlock>
...
80100143:	e8 5f 38 00 00       	call   801039a7 <initsleeplock>
...
801001a8:	e8 b7 38 00 00       	call   80103a64 <holdingsleep>
...
801001e4:	e8 7b 38 00 00       	call   80103a64 <holdingsleep>
...
801001f4:	e8 30 38 00 00       	call   80103a29 <releasesleep>

  acquire(&bcache.lock);
801001f9:	c7 04 24 20 95 10 80 	movl   $0x80109520,(%esp)
80100200:	e8 e9 39 00 00       	call   80103bee <acquire>
  b->refcnt--;
...
8010024c:	e8 02 3a 00 00       	call   80103c53 <release>
}
...
8010028a:	e8 5f 39 00 00       	call   80103bee <acquire>
  while(n > 0){
...
801002bf:	e8 2f 34 00 00       	call   801036f3 <sleep>
801002c4:	83 c4 10             	add    $0x10,%esp
801002c7:	eb d1                	jmp    8010029a <consoleread+0x32>
        release(&cons.lock);
801002c9:	83 ec 0c             	sub    $0xc,%esp
801002cc:	68 20 df 10 80       	push   $0x8010df20
801002d1:	e8 7d 39 00 00       	call   80103c53 <release>
        ilock(ip);
...
80100331:	e8 1d 39 00 00       	call   80103c53 <release>
  ilock(ip);
...
80100373:	e8 8f 02 00 00       	call   80100607 <cprintf>
  cprintf("\n");
80100378:	c7 04 24 7f 6f 10 80 	movl   $0x80106f7f,(%esp)
...
8010038f:	e8 39 37 00 00       	call   80103acd <getcallerpcs>
  for(i=0; i<10; i++)
...
80100492:	68 65 66 10 80       	push   $0x80106665
...
801004ae:	e8 5f 38 00 00       	call   80103d12 <memmove>
    pos -= 80;
...
801004cd:	e8 c8 37 00 00       	call   80103c9a <memset>
...
801004fa:	e8 8e 4b 00 00       	call   8010508d <uartputc>
...
80100513:	e8 75 4b 00 00       	call   8010508d <uartputc>
80100518:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
8010051f:	e8 69 4b 00 00       	call   8010508d <uartputc>
80100524:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010052b:	e8 5d 4b 00 00       	call   8010508d <uartputc>
...
80100568:	0f b6 92 90 66 10 80 	movzbl -0x7fef9970(%edx),%edx
...
801005c6:	e8 23 36 00 00       	call   80103bee <acquire>
  for(i = 0; i < n; i++)
...
801005ed:	e8 61 36 00 00       	call   80103c53 <release>
  ilock(ip);
...
801006cb:	75 12                	jne    801006df <cprintf+0xd8>
        s = "(null)";
801006cd:	bb 78 66 10 80       	mov    $0x80106678,%ebx
...
80100729:	e8 25 35 00 00       	call   80103c53 <release>
...
80100744:	e8 a5 34 00 00       	call   80103bee <acquire>
  while((c = getc()) >= 0){
...
801007f2:	e8 61 30 00 00       	call   80103858 <wakeup>
...
8010086f:	e8 df 33 00 00       	call   80103c53 <release>
  if(doprocdump) {
...
80100883:	e8 6d 30 00 00       	call   801038f5 <procdump>
}
...
8010089a:	e8 13 32 00 00       	call   80103ab2 <initlock>
...
8010095a:	68 a1 66 10 80       	push   $0x801066a1
...
8010096c:	eb dc                	jmp    8010094a <exec+0x7c>
  if((pgdir = setupkvm()) == 0)
8010096e:	e8 42 5a 00 00       	call   801063b5 <setupkvm>
...
80100a02:	e8 54 58 00 00       	call   8010625b <allocuvm>
...
80100a34:	e8 f5 56 00 00       	call   8010612e <loaduvm>
...
80100a71:	e8 e5 57 00 00       	call   8010625b <allocuvm>
...
80100a9c:	e8 a4 58 00 00       	call   80106345 <freevm>
...
80100ab4:	e8 81 59 00 00       	call   8010643a <clearpteu>
...
80100ae6:	e8 58 33 00 00       	call   80103e43 <strlen>
...
80100af8:	e8 46 33 00 00       	call   80103e43 <strlen>
...
80100b0a:	e8 79 5a 00 00       	call   80106588 <copyout>
...
80100b6a:	e8 19 5a 00 00       	call   80106588 <copyout>
...
80100ba7:	e8 5a 32 00 00       	call   80103e06 <safestrcpy>
...
80100bd5:	e8 8b 53 00 00       	call   80105f65 <switchuvm>
  freevm(oldpgdir);
80100bda:	89 1c 24             	mov    %ebx,(%esp)
80100bdd:	e8 63 57 00 00       	call   80106345 <freevm>
  return 0;
...
80100c13:	e8 9a 2e 00 00       	call   80103ab2 <initlock>
}
...
80100c29:	e8 c0 2f 00 00       	call   80103bee <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
80100c2e:	83 c4 10             	add    $0x10,%esp
80100c31:	bb 94 df 10 80       	mov    $0x8010df94,%ebx
80100c36:	81 fb f4 e8 10 80    	cmp    $0x8010e8f4,%ebx
...
80100c58:	e8 f6 2f 00 00       	call   80103c53 <release>
      return f;
...
80100c6f:	e8 df 2f 00 00       	call   80103c53 <release>
  return 0;
...
80100c8d:	e8 5c 2f 00 00       	call   80103bee <acquire>
  if(f->ref < 1)
...
80100caa:	e8 a4 2f 00 00       	call   80103c53 <release>
  return f;
}
...
80100cb9:	68 b4 66 10 80       	push   $0x801066b4
...
80100cd2:	e8 17 2f 00 00       	call   80103bee <acquire>
  if(f->ref < 1)
...
80100d23:	e8 2b 2f 00 00       	call   80103c53 <release>
...
80100e44:	68 c6 66 10 80       	push   $0x801066c6
...
80100f0a:	68 cf 66 10 80       	push   $0x801066cf
...
80100f31:	68 d5 66 10 80       	push   $0x801066d5
...
80100f81:	e8 8c 2d 00 00       	call   80103d12 <memmove>
...
80100f91:	e8 7c 2d 00 00       	call   80103d12 <memmove>
    name[len] = 0;
...
80100fd6:	e8 bf 2c 00 00       	call   80103c9a <memset>
  log_write(bp);
...
80101004:	03 05 cc 05 11 80    	add    0x801105cc,%eax
...
8010105f:	68 df 66 10 80       	push   $0x801066df
...
80101096:	39 05 b4 05 11 80    	cmp    %eax,0x801105b4
...
801010b2:	03 05 cc 05 11 80    	add    0x801105cc,%eax
...
801010d9:	3b 1d b4 05 11 80    	cmp    0x801105b4,%ebx
...
80101116:	68 f2 66 10 80       	push   $0x801066f2
...
801011ed:	68 08 67 10 80       	push   $0x80106708
...
8010120a:	e8 df 29 00 00       	call   80103bee <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
8010120f:	83 c4 10             	add    $0x10,%esp
  empty = 0;
80101212:	be 00 00 00 00       	mov    $0x0,%esi
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
80101217:	bb 94 e9 10 80       	mov    $0x8010e994,%ebx
...
80101228:	81 fb b4 05 11 80    	cmp    $0x801105b4,%ebx
...
80101251:	e8 fd 29 00 00       	call   80103c53 <release>
      return ip;
...
80101287:	e8 c7 29 00 00       	call   80103c53 <release>
  return ip;
...
8010129c:	68 1b 67 10 80       	push   $0x8010671b
...
801012c5:	e8 48 2a 00 00       	call   80103d12 <memmove>
  brelse(bp);
...
801012eb:	e8 c2 27 00 00       	call   80103ab2 <initlock>
  for(i = 0; i < NINODE; i++) {
...
801012fd:	68 32 67 10 80       	push   $0x80106732
80101302:	8d 14 db             	lea    (%ebx,%ebx,8),%edx
80101305:	89 d0                	mov    %edx,%eax
80101307:	c1 e0 04             	shl    $0x4,%eax
8010130a:	05 a0 e9 10 80       	add    $0x8010e9a0,%eax
8010130f:	50                   	push   %eax
80101310:	e8 92 26 00 00       	call   801039a7 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
80101323:	68 b4 05 11 80       	push   $0x801105b4
80101328:	ff 75 08             	push   0x8(%ebp)
8010132b:	e8 76 ff ff ff       	call   801012a6 <readsb>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
80101330:	ff 35 cc 05 11 80    	push   0x801105cc
80101336:	ff 35 c8 05 11 80    	push   0x801105c8
8010133c:	ff 35 c4 05 11 80    	push   0x801105c4
80101342:	ff 35 c0 05 11 80    	push   0x801105c0
80101348:	ff 35 bc 05 11 80    	push   0x801105bc
8010134e:	ff 35 b8 05 11 80    	push   0x801105b8
80101354:	ff 35 b4 05 11 80    	push   0x801105b4
8010135a:	68 98 67 10 80       	push   $0x80106798
...
80101383:	39 1d bc 05 11 80    	cmp    %ebx,0x801105bc
...
80101393:	03 05 c8 05 11 80    	add    0x801105c8,%eax
...
801013cd:	68 38 67 10 80       	push   $0x80106738
...
801013df:	e8 b6 28 00 00       	call   80103c9a <memset>
      dip->type = type;
...
8010141f:	03 05 c8 05 11 80    	add    0x801105c8,%eax
...
8010146e:	e8 9f 28 00 00       	call   80103d12 <memmove>
  log_write(bp);
...
8010154e:	e8 9b 26 00 00       	call   80103bee <acquire>
  ip->ref++;
...
80101563:	e8 eb 26 00 00       	call   80103c53 <release>
}
...
80101588:	e8 4d 24 00 00       	call   801039da <acquiresleep>
  if(ip->valid == 0){
...
801015a0:	68 4a 67 10 80       	push   $0x8010674a
...
801015b3:	03 05 c8 05 11 80    	add    0x801105c8,%eax
...
80101602:	e8 0b 27 00 00       	call   80103d12 <memmove>
    brelse(bp);
...
80101627:	68 50 67 10 80       	push   $0x80106750
...
80101644:	e8 1b 24 00 00       	call   80103a64 <holdingsleep>
...
8010165a:	e8 ca 23 00 00       	call   80103a29 <releasesleep>
}
...
8010166c:	68 5f 67 10 80       	push   $0x8010675f
...
80101686:	e8 4f 23 00 00       	call   801039da <acquiresleep>
...
8010169f:	e8 85 23 00 00       	call   80103a29 <releasesleep>
  acquire(&icache.lock);
801016a4:	c7 04 24 60 e9 10 80 	movl   $0x8010e960,(%esp)
801016ab:	e8 3e 25 00 00       	call   80103bee <acquire>
  ip->ref--;
...
801016c0:	e8 8e 25 00 00       	call   80103c53 <release>
}
...
801016d8:	e8 11 25 00 00       	call   80103bee <acquire>
    int r = ip->ref;
801016dd:	8b 7b 08             	mov    0x8(%ebx),%edi
    release(&icache.lock);
801016e0:	c7 04 24 60 e9 10 80 	movl   $0x8010e960,(%esp)
801016e7:	e8 67 25 00 00       	call   80103c53 <release>
    if(r == 1){
...
801017b1:	98                   	cwtl   
801017b2:	8b 04 c5 00 e9 10 80 	mov    -0x7fef1700(,%eax,8),%eax
...
80101818:	e8 f5 24 00 00       	call   80103d12 <memmove>
    brelse(bp);
...
801018b0:	98                   	cwtl   
801018b1:	8b 04 c5 04 e9 10 80 	mov    -0x7fef16fc(,%eax,8),%eax
...
80101915:	e8 f8 23 00 00       	call   80103d12 <memmove>
    log_write(bp);
...
80101998:	e8 e1 23 00 00       	call   80103d7e <strncmp>
}
8010199d:	c9                   	leave  
8010199e:	c3                   	ret    
...
801019bf:	68 67 67 10 80       	push   $0x80106767
801019c4:	e8 7f e9 ff ff       	call   80100348 <panic>
      panic("dirlookup read");
801019c9:	83 ec 0c             	sub    $0xc,%esp
801019cc:	68 79 67 10 80       	push   $0x80106779
...
80101b7e:	68 88 67 10 80       	push   $0x80106788
...
80101b95:	e8 23 22 00 00       	call   80103dbd <strncpy>
  de.inum = inum;
...
80101bc3:	68 78 6d 10 80       	push   $0x80106d78
...
80101cc5:	68 eb 67 10 80       	push   $0x801067eb
80101cca:	e8 79 e6 ff ff       	call   80100348 <panic>
    panic("incorrect blockno");
80101ccf:	83 ec 0c             	sub    $0xc,%esp
80101cd2:	68 f4 67 10 80       	push   $0x801067f4
...
80101cf9:	e8 b4 1d 00 00       	call   80103ab2 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
80101cfe:	83 c4 08             	add    $0x8,%esp
80101d01:	a1 84 07 11 80       	mov    0x80110784,%eax
...
80101d43:	eb e9                	jmp    80101d2e <ideinit+0x45>
      havedisk1 = 1;
80101d45:	c7 05 e0 05 11 80 01 	movl   $0x1,0x801105e0
80101d4c:	00 00 00 
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
80101d69:	e8 80 1e 00 00       	call   80103bee <acquire>

  if((b = idequeue) == 0){
80101d6e:	8b 1d e4 05 11 80    	mov    0x801105e4,%ebx
...
80101d7e:	a3 e4 05 11 80       	mov    %eax,0x801105e4
...
80101d98:	e8 bb 1a 00 00       	call   80103858 <wakeup>

  // Start disk on next buf in queue.
  if(idequeue != 0)
80101d9d:	a1 e4 05 11 80       	mov    0x801105e4,%eax
...
80101db6:	e8 98 1e 00 00       	call   80103c53 <release>
...
80101dcd:	e8 81 1e 00 00       	call   80103c53 <release>
    return;
...
80101e05:	e8 5a 1c 00 00       	call   80103a64 <holdingsleep>
...
80101e21:	83 3d e0 05 11 80 00 	cmpl   $0x0,0x801105e0
...
80101e32:	e8 b7 1d 00 00       	call   80103bee <acquire>
...
80101e78:	89 1a                	mov    %ebx,(%edx)
  ...
  if(idequeue == b)
80101e7a:	39 1d e4 05 11 80    	cmp    %ebx,0x801105e4
...
80101e8e:	68 00 06 11 80       	push   $0x80110600
80101e93:	53                   	push   %ebx
80101e94:	e8 5a 18 00 00       	call   801036f3 <sleep>
...
80101eae:	e8 a0 1d 00 00       	call   80103c53 <release>
}
...
{
  ioapic->reg = reg;
80101ebb:	8b 15 34 06 11 80    	mov    0x80110634,%edx
80101ec1:	89 02                	mov    %eax,(%edx)
  return ioapic->data;
80101ec3:	a1 34 06 11 80       	mov    0x80110634,%eax
...
{
  ioapic->reg = reg;
80101ecc:	8b 0d 34 06 11 80    	mov    0x80110634,%ecx
80101ed2:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80101ed4:	a1 34 06 11 80       	mov    0x80110634,%eax
...
80101ee6:	c7 05 34 06 11 80 00 	movl   $0xfec00000,0x80110634
80101eed:	00 c0 fe 
...
80101f0a:	c1 e8 18             	shr    $0x18,%eax
  if(id != ioapicid)
80101f0d:	0f b6 15 80 07 11 80 	movzbl 0x80110780,%edx
...
80101f22:	68 54 68 10 80       	push   $0x80106854
...
80101f9e:	81 fb d0 44 11 80    	cmp    $0x801144d0,%ebx
...
80101fbe:	e8 d7 1c 00 00       	call   80103c9a <memset>

  if(kmem.use_lock)
80101fc3:	83 c4 10             	add    $0x10,%esp
80101fc6:	83 3d 74 06 11 80 00 	cmpl   $0x0,0x80110674
80101fcd:	75 28                	jne    80101ff7 <kfree+0x6b>
    acquire(&kmem.lock);
  r = (struct run*)v;
  r->next = kmem.freelist;
80101fcf:	a1 78 06 11 80       	mov    0x80110678,%eax
80101fd4:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
80101fd6:	89 1d 78 06 11 80    	mov    %ebx,0x80110678
  if(kmem.use_lock)
80101fdc:	83 3d 74 06 11 80 00 	cmpl   $0x0,0x80110674
...
80102011:	e8 3d 1c 00 00       	call   80103c53 <release>
...
80102061:	e8 4c 1a 00 00       	call   80103ab2 <initlock>
  kmem.use_lock = 0;
80102066:	c7 05 74 06 11 80 00 	movl   $0x0,0x80110674
8010206d:	00 00 00 
...
8010208f:	e8 87 ff ff ff       	call   8010201b <freerange>
  kmem.use_lock = 1;
80102094:	c7 05 74 06 11 80 01 	movl   $0x1,0x80110674
8010209b:	00 00 00 
}
...
801020a7:	83 ec 04             	sub    $0x4,%esp
  ...
  if(kmem.use_lock)
801020aa:	83 3d 74 06 11 80 00 	cmpl   $0x0,0x80110674
801020b1:	75 21                	jne    801020d4 <kalloc+0x31>
    acquire(&kmem.lock);
  r = kmem.freelist;
801020b3:	8b 1d 78 06 11 80    	mov    0x80110678,%ebx
  if(r)
801020b9:	85 db                	test   %ebx,%ebx
801020bb:	74 07                	je     801020c4 <kalloc+0x21>
    kmem.freelist = r->next;
801020bd:	8b 03                	mov    (%ebx),%eax
801020bf:	a3 78 06 11 80       	mov    %eax,0x80110678
  if(kmem.use_lock)
801020c4:	83 3d 74 06 11 80 00 	cmpl   $0x0,0x80110674
...
80102117:	8b 15 7c 06 11 80    	mov    0x8011067c,%edx
...
8010212b:	89 15 7c 06 11 80    	mov    %edx,0x8011067c
  }

  shift |= shiftcode[data];
80102131:	0f b6 91 c0 69 10 80 	movzbl -0x7fef9640(%ecx),%edx
80102138:	0b 15 7c 06 11 80    	or     0x8011067c,%edx
8010213e:	89 15 7c 06 11 80    	mov    %edx,0x8011067c
  shift ^= togglecode[data];
80102144:	0f b6 81 c0 68 10 80 	movzbl -0x7fef9740(%ecx),%eax
8010214b:	31 c2                	xor    %eax,%edx
8010214d:	89 15 7c 06 11 80    	mov    %edx,0x8011067c
  c = charcode[shift & (CTL | SHIFT)][data];
80102153:	89 d0                	mov    %edx,%eax
80102155:	83 e0 03             	and    $0x3,%eax
80102158:	8b 04 85 a0 68 10 80 	mov    -0x7fef9760(,%eax,4),%eax
...
80102173:	c3                   	ret    
    shift |= E0ESC;
80102174:	83 0d 7c 06 11 80 40 	orl    $0x40,0x8011067c
    return 0;
8010217b:	b8 00 00 00 00       	mov    $0x0,%eax
80102180:	c3                   	ret    
    data = (shift & E0ESC ? data : data & 0x7F);
80102181:	8b 15 7c 06 11 80    	mov    0x8011067c,%edx
...
{
  lapic[index] = value;
801021d5:	8b 0d 80 06 11 80    	mov    0x80110680,%ecx
801021db:	8d 04 81             	lea    (%ecx,%eax,4),%eax
801021de:	89 10                	mov    %edx,(%eax)
  lapic[ID];  // wait for write to finish, by reading
801021e0:	a1 80 06 11 80       	mov    0x80110680,%eax
...
80102254 <lapicinit>:
  if(!lapic)
80102254:	83 3d 80 06 11 80 00 	cmpl   $0x0,0x80110680
...
801022c1:	a1 80 06 11 80       	mov    0x80110680,%eax
...
8010232a:	a1 80 06 11 80       	mov    0x80110680,%eax
...
80102360 <lapicid>:
  if (!lapic)
80102360:	a1 80 06 11 80       	mov    0x80110680,%eax
...
80102376 <lapiceoi>:
  if(lapic)
80102376:	83 3d 80 06 11 80 00 	cmpl   $0x0,0x80110680
...
80102478:	e8 60 18 00 00       	call   80103cdd <memcmp>
...
80102539:	ff 35 d4 06 11 80    	push   0x801106d4
8010253f:	ff 35 e4 06 11 80    	push   0x801106e4
80102545:	e8 22 dc ff ff       	call   8010016c <bread>
  struct logheader *lh = (struct logheader *) (buf->data);
  int i;
  log.lh.n = lh->n;
8010254a:	8b 58 5c             	mov    0x5c(%eax),%ebx
8010254d:	89 1d e8 06 11 80    	mov    %ebx,0x801106e8
...
80102561:	89 0c 95 ec 06 11 80 	mov    %ecx,-0x7feef914(,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
801025d3:	e8 3a 17 00 00       	call   80103d12 <memmove>
...
801025f6:	39 35 e8 06 11 80    	cmp    %esi,0x801106e8
...
8010260a:	83 ec 0c             	sub    $0xc,%esp
  struct buf *buf = bread(log.dev, log.start);
8010260d:	ff 35 d4 06 11 80    	push   0x801106d4
80102613:	ff 35 e4 06 11 80    	push   0x801106e4
80102619:	e8 4e db ff ff       	call   8010016c <bread>
8010261e:	89 c3                	mov    %eax,%ebx
  struct logheader *hb = (struct logheader *) (buf->data);
  int i;
  hb->n = log.lh.n;
80102620:	8b 0d e8 06 11 80    	mov    0x801106e8,%ecx
...
80102633:	8b 14 85 ec 06 11 80 	mov    -0x7feef914(,%eax,4),%edx
...
80102669:	e8 12 ff ff ff       	call   80102580 <install_trans>
  log.lh.n = 0;
8010266e:	c7 05 e8 06 11 80 00 	movl   $0x0,0x801106e8
80102675:	00 00 00 
...
801026d2:	e8 3b 16 00 00       	call   80103d12 <memmove>
...
801026f5:	39 35 e8 06 11 80    	cmp    %esi,0x801106e8
...
{
  if (log.lh.n > 0) {
80102705:	83 3d e8 06 11 80 00 	cmpl   $0x0,0x801106e8
...
8010271f:	e8 5c fe ff ff       	call   80102580 <install_trans>
    log.lh.n = 0;
80102724:	c7 05 e8 06 11 80 00 	movl   $0x0,0x801106e8
8010272b:	00 00 00 
...
80102749:	e8 64 13 00 00       	call   80103ab2 <initlock>
  readsb(dev, &sb);
...
8010275e:	a3 d4 06 11 80       	mov    %eax,0x801106d4
  log.size = sb.nlog;
80102763:	8b 45 e8             	mov    -0x18(%ebp),%eax
80102766:	a3 d8 06 11 80       	mov    %eax,0x801106d8
  log.dev = dev;
8010276b:	89 1d e4 06 11 80    	mov    %ebx,0x801106e4
  recover_from_log();
...
80102789:	e8 60 14 00 00       	call   80103bee <acquire>
...
80102804:	e8 e5 13 00 00       	call   80103bee <acquire>
  log.outstanding -= 1;
80102809:	a1 dc 06 11 80       	mov    0x801106dc,%eax
8010280e:	83 e8 01             	sub    $0x1,%eax
80102811:	a3 dc 06 11 80       	mov    %eax,0x801106dc
  if(log.committing)
80102816:	8b 1d e0 06 11 80    	mov    0x801106e0,%ebx
...
80102825:	75 35                	jne    8010285c <end_op+0x64>
    log.committing = 1;
80102827:	c7 05 e0 06 11 80 01 	movl   $0x1,0x801106e0
8010282e:	00 00 00 
    do_commit = 1;
...
8010283e:	e8 10 14 00 00       	call   80103c53 <release>
  if(do_commit){
...
8010287b:	e8 6e 13 00 00       	call   80103bee <acquire>
    log.committing = 0;
80102880:	c7 05 e0 06 11 80 00 	movl   $0x0,0x801106e0
80102887:	00 00 00 
    wakeup(&log);
8010288a:	c7 04 24 a0 06 11 80 	movl   $0x801106a0,(%esp)
80102891:	e8 c2 0f 00 00       	call   80103858 <wakeup>
    release(&log.lock);
80102896:	c7 04 24 a0 06 11 80 	movl   $0x801106a0,(%esp)
8010289d:	e8 b1 13 00 00       	call   80103c53 <release>
...
801028d9:	e8 10 13 00 00       	call   80103bee <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102934:	e8 1a 13 00 00       	call   80103c53 <release>
}
...
80102944:	89 15 e8 06 11 80    	mov    %edx,0x801106e8
...
80102958:	68 8c 94 10 80       	push   $0x8010948c
8010295d:	68 00 70 00 80       	push   $0x80007000
80102962:	e8 ab 13 00 00       	call   80103d12 <memmove>

  for(c = cpus; c < cpus+ncpu; c++){
80102967:	83 c4 10             	add    $0x10,%esp
8010296a:	bb a0 07 11 80       	mov    $0x801107a0,%ebx
8010296f:	eb 06                	jmp    80102977 <startothers+0x2b>
80102971:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80102977:	69 05 84 07 11 80 b0 	imul   $0xb0,0x80110784,%eax
8010297e:	00 00 00 
80102981:	05 a0 07 11 80       	add    $0x801107a0,%eax
...
801029ac:	c7 05 f4 6f 00 80 00 	movl   $0x108000,0x80006ff4
801029b3:	80 10 00 
...
801029f3:	68 04 6b 10 80       	push   $0x80106b04
801029f8:	e8 0a dc ff ff       	call   80100607 <cprintf>
  idtinit();       // load idt register
801029fd:	e8 29 24 00 00       	call   80104e2b <idtinit>
...
80102a15:	e8 b4 0a 00 00       	call   801034ce <scheduler>
...
80102a1d:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102a20:	e8 32 35 00 00       	call   80105f57 <switchkvm>
  seginit();
80102a25:	e8 b8 32 00 00       	call   80105ce2 <seginit>
  lapicinit();
...
80102a77:	e8 56 26 00 00       	call   801050d2 <uartinit>
  pinit();         // process table
80102a7c:	e8 a3 06 00 00       	call   80103124 <pinit>
  tvinit();        // trap vectors
80102a81:	e8 a0 22 00 00       	call   80104d26 <tvinit>
  binit();         // buffer cache
...
80102af7:	68 18 6b 10 80       	push   $0x80106b18
80102afc:	53                   	push   %ebx
80102afd:	e8 db 11 00 00       	call   80103cdd <memcmp>
...
80102bba:	68 1d 6b 10 80       	push   $0x80106b1d
80102bbf:	57                   	push   %edi
80102bc0:	e8 18 11 00 00       	call   80103cdd <memcmp>
...
80102c37:	89 15 80 06 11 80    	mov    %edx,0x80110680
...
80102c50:	68 22 6b 10 80       	push   $0x80106b22
...
80102c85:	eb e6                	jmp    80102c6d <mpinit+0x4e>
      if(ncpu < NCPU) {
80102c87:	8b 35 84 07 11 80    	mov    0x80110784,%esi
...
80102c9c:	88 87 a0 07 11 80    	mov    %al,-0x7feef860(%edi)
        ncpu++;
80102ca2:	83 c6 01             	add    $0x1,%esi
80102ca5:	89 35 84 07 11 80    	mov    %esi,0x80110784
...
80102cb4:	a2 80 07 11 80       	mov    %al,0x80110780
      p += sizeof(struct mpioapic);
...
80102ceb:	68 3c 6b 10 80       	push   $0x80106b3c
...
80102d72:	68 5b 6b 10 80       	push   $0x80106b5b
80102d77:	50                   	push   %eax
80102d78:	e8 35 0d 00 00       	call   80103ab2 <initlock>
  (*f0)->type = FD_PIPE;
...
80102dfc:	e8 ed 0d 00 00       	call   80103bee <acquire>
  if(writable){
...
80102e1e:	e8 35 0a 00 00       	call   80103858 <wakeup>
...
80102e3c:	e8 12 0e 00 00       	call   80103c53 <release>
...
80102e5d:	e8 f6 09 00 00       	call   80103858 <wakeup>
...
80102e6b:	e8 e3 0d 00 00       	call   80103c53 <release>
    kfree((char*)p);
...
80102e8d:	e8 5c 0d 00 00       	call   80103bee <acquire>
  for(i = 0; i < n; i++){
...
80102ea8:	e8 ab 09 00 00       	call   80103858 <wakeup>
  release(&p->lock);
80102ead:	89 1c 24             	mov    %ebx,(%esp)
80102eb0:	e8 9e 0d 00 00       	call   80103c53 <release>
  return n;
...
80102f0b:	e8 43 0d 00 00       	call   80103c53 <release>
        return -1;
...
80102f52:	e8 97 0c 00 00       	call   80103bee <acquire>
...
80102f67:	e8 87 07 00 00       	call   801036f3 <sleep>
...
80102f96:	e8 b8 0c 00 00       	call   80103c53 <release>
      return -1;
...
80102fdb:	e8 78 08 00 00       	call   80103858 <wakeup>
  release(&p->lock);
80102fe0:	89 1c 24             	mov    %ebx,(%esp)
80102fe3:	e8 6b 0c 00 00       	call   80103c53 <release>
  return i;
...
80102ffc:	ba 54 0d 11 80       	mov    $0x80110d54,%edx
80103001:	eb 03                	jmp    80103006 <wakeup1+0xa>
80103003:	83 c2 7c             	add    $0x7c,%edx
80103006:	81 fa 54 2c 11 80    	cmp    $0x80112c54,%edx
...
8010302f:	e8 ba 0b 00 00       	call   80103bee <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103034:	83 c4 10             	add    $0x10,%esp
80103037:	bb 54 0d 11 80       	mov    $0x80110d54,%ebx
8010303c:	eb 03                	jmp    80103041 <allocproc+0x1e>
8010303e:	83 c3 7c             	add    $0x7c,%ebx
80103041:	81 fb 54 2c 11 80    	cmp    $0x80112c54,%ebx
...
8010308c:	c7 80 b0 0f 00 00 1b 	movl   $0x80104d1b,0xfb0(%eax)
80103093:	4d 10 80 
  sp -= sizeof *p->context;
...
801030a6:	e8 ef 0b 00 00       	call   80103c9a <memset>
...
801030c7:	e8 87 0b 00 00       	call   80103c53 <release>
  return 0;
...
801030ec:	e8 62 0b 00 00       	call   80103c53 <release>
  if (first) {
801030f1:	83 c4 10             	add    $0x10,%esp
801030f4:	83 3d 00 90 10 80 00 	cmpl   $0x0,0x80109000
801030fb:	75 02                	jne    801030ff <forkret+0x1e>
}
801030fd:	c9                   	leave  
801030fe:	c3                   	ret    
    first = 0;
801030ff:	c7 05 00 90 10 80 00 	movl   $0x0,0x80109000
80103106:	00 00 00 
    iinit(ROOTDEV);
...
80103134:	e8 79 09 00 00       	call   80103ab2 <initlock>
}
...
80103155:	39 15 84 07 11 80    	cmp    %edx,0x80110784
8010315b:	7e 23                	jle    80103180 <mycpu+0x42>
    if (cpus[i].apicid == apicid)
8010315d:	69 ca b0 00 00 00    	imul   $0xb0,%edx,%ecx
80103163:	0f b6 89 a0 07 11 80 	movzbl -0x7feef860(%ecx),%ecx
...
801031a5:	2d a0 07 11 80       	sub    $0x801107a0,%eax
...
801031b9:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801031bc:	e8 52 09 00 00       	call   80103b13 <pushcli>
  c = mycpu();
801031c1:	e8 78 ff ff ff       	call   8010313e <mycpu>
  p = c->proc;
801031c6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801031cc:	e8 7e 09 00 00       	call   80103b4f <popcli>
}
...
801031e4:	89 c3                	mov    %eax,%ebx
  initproc = p;
801031e6:	a3 54 2c 11 80       	mov    %eax,0x80112c54
  if((p->pgdir = setupkvm()) == 0)
801031eb:	e8 c5 31 00 00       	call   801063b5 <setupkvm>
...
80103203:	68 60 94 10 80       	push   $0x80109460
80103208:	50                   	push   %eax
80103209:	e8 b7 2e 00 00       	call   801060c5 <inituvm>
  p->sz = PGSIZE;
...
8010321f:	e8 76 0a 00 00       	call   80103c9a <memset>
...
80103272:	68 90 6b 10 80       	push   $0x80106b90
80103277:	50                   	push   %eax
80103278:	e8 89 0b 00 00       	call   80103e06 <safestrcpy>
  p->cwd = namei("/");
8010327d:	c7 04 24 99 6b 10 80 	movl   $0x80106b99,(%esp)
...
801032b6:	68 77 6b 10 80       	push   $0x80106b77
...
801032dd:	e8 83 2c 00 00       	call   80105f65 <switchuvm>
  return 0;
...
801032fb:	e8 5b 2f 00 00       	call   8010625b <allocuvm>
...
80103318:	e8 ac 2e 00 00       	call   801061c9 <deallocuvm>
...
80103345:	74 6d                	je     801033b4 <clone+0x89>
80103347:	89 c1                	mov    %eax,%ecx
  np->pgdir = curproc->pgdir;
80103349:	8b 43 04             	mov    0x4(%ebx),%eax
8010334c:	89 41 04             	mov    %eax,0x4(%ecx)
  np->kstack = stack;
8010334f:	8b 45 14             	mov    0x14(%ebp),%eax
80103352:	89 41 08             	mov    %eax,0x8(%ecx)
  np->sz = curproc->sz; 
80103355:	8b 03                	mov    (%ebx),%eax
80103357:	89 01                	mov    %eax,(%ecx)
  np->parent = curproc;
80103359:	89 c8                	mov    %ecx,%eax
8010335b:	89 59 14             	mov    %ebx,0x14(%ecx)
  *np->tf = *curproc->tf;
8010335e:	8b 73 18             	mov    0x18(%ebx),%esi
80103361:	8b 79 18             	mov    0x18(%ecx),%edi
80103364:	b9 13 00 00 00       	mov    $0x13,%ecx
80103369:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  np->tf->eip = (uint)fcn;
8010336b:	8b 40 18             	mov    0x18(%eax),%eax
8010336e:	8b 55 08             	mov    0x8(%ebp),%edx
80103371:	89 50 38             	mov    %edx,0x38(%eax)
  for(i = 0; i < NOFILE; i++)
80103374:	be 00 00 00 00       	mov    $0x0,%esi
80103379:	eb 16                	jmp    80103391 <clone+0x66>
      np->ofile[i] = filedup(curproc->ofile[i]);
8010337b:	83 ec 0c             	sub    $0xc,%esp
8010337e:	50                   	push   %eax
8010337f:	e8 fa d8 ff ff       	call   80100c7e <filedup>
80103384:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80103387:	89 44 b2 28          	mov    %eax,0x28(%edx,%esi,4)
8010338b:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NOFILE; i++)
8010338e:	83 c6 01             	add    $0x1,%esi
80103391:	83 fe 0f             	cmp    $0xf,%esi
80103394:	7f 0a                	jg     801033a0 <clone+0x75>
    if(curproc->ofile[i])
80103396:	8b 44 b3 28          	mov    0x28(%ebx,%esi,4),%eax
8010339a:	85 c0                	test   %eax,%eax
8010339c:	75 dd                	jne    8010337b <clone+0x50>
8010339e:	eb ee                	jmp    8010338e <clone+0x63>
  np->cwd = idup(curproc->cwd);
801033a0:	83 ec 0c             	sub    $0xc,%esp
801033a3:	ff 73 68             	push   0x68(%ebx)
801033a6:	e8 94 e1 ff ff       	call   8010153f <idup>
801033ab:	8b 7d e4             	mov    -0x1c(%ebp),%edi
801033ae:	89 47 68             	mov    %eax,0x68(%edi)
  return pid;
...
801033c1:	b8 00 00 00 00       	mov    $0x0,%eax
801033c6:	c3                   	ret    
...
801033ca:	57                   	push   %edi
801033cb:	56                   	push   %esi
801033cc:	53                   	push   %ebx
801033cd:	83 ec 1c             	sub    $0x1c,%esp
  struct proc *curproc = myproc();
801033d0:	e8 e0 fd ff ff       	call   801031b5 <myproc>
801033d5:	89 c3                	mov    %eax,%ebx
  if((np = allocproc()) == 0){
801033d7:	e8 47 fc ff ff       	call   80103023 <allocproc>
801033dc:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801033df:	85 c0                	test   %eax,%eax
801033e1:	0f 84 e0 00 00 00    	je     801034c7 <fork+0x100>
801033e7:	89 c7                	mov    %eax,%edi
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
801033e9:	83 ec 08             	sub    $0x8,%esp
801033ec:	ff 33                	push   (%ebx)
801033ee:	ff 73 04             	push   0x4(%ebx)
801033f1:	e8 70 30 00 00       	call   80106466 <copyuvm>
801033f6:	89 47 04             	mov    %eax,0x4(%edi)
801033f9:	83 c4 10             	add    $0x10,%esp
801033fc:	85 c0                	test   %eax,%eax
801033fe:	74 2a                	je     8010342a <fork+0x63>
  np->sz = curproc->sz;
80103400:	8b 03                	mov    (%ebx),%eax
80103402:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80103405:	89 01                	mov    %eax,(%ecx)
  np->parent = curproc;
80103407:	89 c8                	mov    %ecx,%eax
80103409:	89 59 14             	mov    %ebx,0x14(%ecx)
  *np->tf = *curproc->tf;
8010340c:	8b 73 18             	mov    0x18(%ebx),%esi
8010340f:	8b 79 18             	mov    0x18(%ecx),%edi
80103412:	b9 13 00 00 00       	mov    $0x13,%ecx
80103417:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)
  np->tf->eax = 0;
80103419:	8b 40 18             	mov    0x18(%eax),%eax
8010341c:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
  for(i = 0; i < NOFILE; i++)
80103423:	be 00 00 00 00       	mov    $0x0,%esi
80103428:	eb 29                	jmp    80103453 <fork+0x8c>
    kfree(np->kstack);
8010342a:	83 ec 0c             	sub    $0xc,%esp
8010342d:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80103430:	ff 73 08             	push   0x8(%ebx)
80103433:	e8 54 eb ff ff       	call   80101f8c <kfree>
    np->kstack = 0;
80103438:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
    np->state = UNUSED;
8010343f:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
    return -1;
80103446:	83 c4 10             	add    $0x10,%esp
80103449:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
8010344e:	eb 6d                	jmp    801034bd <fork+0xf6>
  for(i = 0; i < NOFILE; i++)
80103450:	83 c6 01             	add    $0x1,%esi
80103453:	83 fe 0f             	cmp    $0xf,%esi
80103456:	7f 1d                	jg     80103475 <fork+0xae>
    if(curproc->ofile[i])
80103458:	8b 44 b3 28          	mov    0x28(%ebx,%esi,4),%eax
8010345c:	85 c0                	test   %eax,%eax
8010345e:	74 f0                	je     80103450 <fork+0x89>
      np->ofile[i] = filedup(curproc->ofile[i]);
80103460:	83 ec 0c             	sub    $0xc,%esp
80103463:	50                   	push   %eax
80103464:	e8 15 d8 ff ff       	call   80100c7e <filedup>
80103469:	8b 55 e4             	mov    -0x1c(%ebp),%edx
8010346c:	89 44 b2 28          	mov    %eax,0x28(%edx,%esi,4)
80103470:	83 c4 10             	add    $0x10,%esp
80103473:	eb db                	jmp    80103450 <fork+0x89>
  np->cwd = idup(curproc->cwd);
80103475:	83 ec 0c             	sub    $0xc,%esp
80103478:	ff 73 68             	push   0x68(%ebx)
8010347b:	e8 bf e0 ff ff       	call   8010153f <idup>
80103480:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80103483:	89 47 68             	mov    %eax,0x68(%edi)
  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
80103486:	83 c3 6c             	add    $0x6c,%ebx
80103489:	8d 47 6c             	lea    0x6c(%edi),%eax
8010348c:	83 c4 0c             	add    $0xc,%esp
8010348f:	6a 10                	push   $0x10
80103491:	53                   	push   %ebx
80103492:	50                   	push   %eax
80103493:	e8 6e 09 00 00       	call   80103e06 <safestrcpy>
  pid = np->pid;
80103498:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
8010349b:	c7 04 24 20 0d 11 80 	movl   $0x80110d20,(%esp)
801034a2:	e8 47 07 00 00       	call   80103bee <acquire>
  np->state = RUNNABLE;
801034a7:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
801034ae:	c7 04 24 20 0d 11 80 	movl   $0x80110d20,(%esp)
801034b5:	e8 99 07 00 00       	call   80103c53 <release>
  return pid;
801034ba:	83 c4 10             	add    $0x10,%esp
}
801034bd:	89 d8                	mov    %ebx,%eax
801034bf:	8d 65 f4             	lea    -0xc(%ebp),%esp
801034c2:	5b                   	pop    %ebx
801034c3:	5e                   	pop    %esi
801034c4:	5f                   	pop    %edi
801034c5:	5d                   	pop    %ebp
801034c6:	c3                   	ret    
    return -1;
801034c7:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801034cc:	eb ef                	jmp    801034bd <fork+0xf6>
...
801034d2:	53                   	push   %ebx
  struct cpu *c = mycpu();
801034d3:	e8 66 fc ff ff       	call   8010313e <mycpu>
801034d8:	89 c6                	mov    %eax,%esi
  c->proc = 0;
801034da:	c7 80 ac 00 00 00 00 	movl   $0x0,0xac(%eax)
801034e1:	00 00 00 
801034e4:	eb 5a                	jmp    80103540 <scheduler+0x72>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801034e6:	83 c3 7c             	add    $0x7c,%ebx
801034e9:	81 fb 54 2c 11 80    	cmp    $0x80112c54,%ebx
801034ef:	73 3f                	jae    80103530 <scheduler+0x62>
      if(p->state != RUNNABLE)
801034f1:	83 7b 0c 03          	cmpl   $0x3,0xc(%ebx)
801034f5:	75 ef                	jne    801034e6 <scheduler+0x18>
      c->proc = p;
801034f7:	89 9e ac 00 00 00    	mov    %ebx,0xac(%esi)
      switchuvm(p);
801034fd:	83 ec 0c             	sub    $0xc,%esp
80103500:	53                   	push   %ebx
80103501:	e8 5f 2a 00 00       	call   80105f65 <switchuvm>
      p->state = RUNNING;
80103506:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
8010350d:	83 c4 08             	add    $0x8,%esp
80103510:	ff 73 1c             	push   0x1c(%ebx)
80103513:	8d 46 04             	lea    0x4(%esi),%eax
80103516:	50                   	push   %eax
80103517:	e8 3f 09 00 00       	call   80103e5b <swtch>
      switchkvm();
8010351c:	e8 36 2a 00 00       	call   80105f57 <switchkvm>
      c->proc = 0;
80103521:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103528:	00 00 00 
8010352b:	83 c4 10             	add    $0x10,%esp
8010352e:	eb b6                	jmp    801034e6 <scheduler+0x18>
    release(&ptable.lock);
80103530:	83 ec 0c             	sub    $0xc,%esp
80103533:	68 20 0d 11 80       	push   $0x80110d20
80103538:	e8 16 07 00 00       	call   80103c53 <release>
    sti();
...
80103544:	68 20 0d 11 80       	push   $0x80110d20
80103549:	e8 a0 06 00 00       	call   80103bee <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010354e:	83 c4 10             	add    $0x10,%esp
80103551:	bb 54 0d 11 80       	mov    $0x80110d54,%ebx
80103556:	eb 91                	jmp    801034e9 <scheduler+0x1b>

80103558 <sched>:
{
80103558:	55                   	push   %ebp
80103559:	89 e5                	mov    %esp,%ebp
8010355b:	56                   	push   %esi
8010355c:	53                   	push   %ebx
  struct proc *p = myproc();
8010355d:	e8 53 fc ff ff       	call   801031b5 <myproc>
80103562:	89 c3                	mov    %eax,%ebx
  if(!holding(&ptable.lock))
80103564:	83 ec 0c             	sub    $0xc,%esp
80103567:	68 20 0d 11 80       	push   $0x80110d20
8010356c:	e8 3e 06 00 00       	call   80103baf <holding>
80103571:	83 c4 10             	add    $0x10,%esp
80103574:	85 c0                	test   %eax,%eax
80103576:	74 4f                	je     801035c7 <sched+0x6f>
  if(mycpu()->ncli != 1)
80103578:	e8 c1 fb ff ff       	call   8010313e <mycpu>
8010357d:	83 b8 a4 00 00 00 01 	cmpl   $0x1,0xa4(%eax)
80103584:	75 4e                	jne    801035d4 <sched+0x7c>
  if(p->state == RUNNING)
80103586:	83 7b 0c 04          	cmpl   $0x4,0xc(%ebx)
8010358a:	74 55                	je     801035e1 <sched+0x89>
  asm volatile("pushfl; popl %0" : "=r" (eflags));
8010358c:	9c                   	pushf  
8010358d:	58                   	pop    %eax
  if(readeflags()&FL_IF)
8010358e:	f6 c4 02             	test   $0x2,%ah
80103591:	75 5b                	jne    801035ee <sched+0x96>
  intena = mycpu()->intena;
80103593:	e8 a6 fb ff ff       	call   8010313e <mycpu>
80103598:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
8010359e:	e8 9b fb ff ff       	call   8010313e <mycpu>
801035a3:	83 ec 08             	sub    $0x8,%esp
801035a6:	ff 70 04             	push   0x4(%eax)
801035a9:	83 c3 1c             	add    $0x1c,%ebx
801035ac:	53                   	push   %ebx
801035ad:	e8 a9 08 00 00       	call   80103e5b <swtch>
  mycpu()->intena = intena;
801035b2:	e8 87 fb ff ff       	call   8010313e <mycpu>
801035b7:	89 b0 a8 00 00 00    	mov    %esi,0xa8(%eax)
}
801035bd:	83 c4 10             	add    $0x10,%esp
801035c0:	8d 65 f8             	lea    -0x8(%ebp),%esp
801035c3:	5b                   	pop    %ebx
801035c4:	5e                   	pop    %esi
801035c5:	5d                   	pop    %ebp
801035c6:	c3                   	ret    
...
801035ca:	68 9b 6b 10 80       	push   $0x80106b9b
801035cf:	e8 74 cd ff ff       	call   80100348 <panic>
    panic("sched locks");
801035d4:	83 ec 0c             	sub    $0xc,%esp
801035d7:	68 ad 6b 10 80       	push   $0x80106bad
801035dc:	e8 67 cd ff ff       	call   80100348 <panic>
    panic("sched running");
801035e1:	83 ec 0c             	sub    $0xc,%esp
801035e4:	68 b9 6b 10 80       	push   $0x80106bb9
801035e9:	e8 5a cd ff ff       	call   80100348 <panic>
    panic("sched interruptible");
801035ee:	83 ec 0c             	sub    $0xc,%esp
801035f1:	68 c7 6b 10 80       	push   $0x80106bc7
801035f6:	e8 4d cd ff ff       	call   80100348 <panic>

801035fb <exit>:
{
801035fb:	55                   	push   %ebp
801035fc:	89 e5                	mov    %esp,%ebp
801035fe:	56                   	push   %esi
801035ff:	53                   	push   %ebx
  struct proc *curproc = myproc();
80103600:	e8 b0 fb ff ff       	call   801031b5 <myproc>
  if(curproc == initproc)
80103605:	39 05 54 2c 11 80    	cmp    %eax,0x80112c54
8010360b:	74 09                	je     80103616 <exit+0x1b>
8010360d:	89 c6                	mov    %eax,%esi
  for(fd = 0; fd < NOFILE; fd++){
8010360f:	bb 00 00 00 00       	mov    $0x0,%ebx
80103614:	eb 24                	jmp    8010363a <exit+0x3f>
    panic("init exiting");
80103616:	83 ec 0c             	sub    $0xc,%esp
80103619:	68 db 6b 10 80       	push   $0x80106bdb
8010361e:	e8 25 cd ff ff       	call   80100348 <panic>
      fileclose(curproc->ofile[fd]);
80103623:	83 ec 0c             	sub    $0xc,%esp
80103626:	50                   	push   %eax
80103627:	e8 97 d6 ff ff       	call   80100cc3 <fileclose>
      curproc->ofile[fd] = 0;
8010362c:	c7 44 9e 28 00 00 00 	movl   $0x0,0x28(%esi,%ebx,4)
80103633:	00 
80103634:	83 c4 10             	add    $0x10,%esp
  for(fd = 0; fd < NOFILE; fd++){
80103637:	83 c3 01             	add    $0x1,%ebx
8010363a:	83 fb 0f             	cmp    $0xf,%ebx
8010363d:	7f 0a                	jg     80103649 <exit+0x4e>
    if(curproc->ofile[fd]){
8010363f:	8b 44 9e 28          	mov    0x28(%esi,%ebx,4),%eax
80103643:	85 c0                	test   %eax,%eax
80103645:	75 dc                	jne    80103623 <exit+0x28>
80103647:	eb ee                	jmp    80103637 <exit+0x3c>
  begin_op();
80103649:	e8 30 f1 ff ff       	call   8010277e <begin_op>
  iput(curproc->cwd);
8010364e:	83 ec 0c             	sub    $0xc,%esp
80103651:	ff 76 68             	push   0x68(%esi)
80103654:	e8 1d e0 ff ff       	call   80101676 <iput>
  end_op();
80103659:	e8 9a f1 ff ff       	call   801027f8 <end_op>
  curproc->cwd = 0;
8010365e:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103665:	c7 04 24 20 0d 11 80 	movl   $0x80110d20,(%esp)
8010366c:	e8 7d 05 00 00       	call   80103bee <acquire>
  wakeup1(curproc->parent);
80103671:	8b 46 14             	mov    0x14(%esi),%eax
80103674:	e8 83 f9 ff ff       	call   80102ffc <wakeup1>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103679:	83 c4 10             	add    $0x10,%esp
8010367c:	bb 54 0d 11 80       	mov    $0x80110d54,%ebx
80103681:	eb 03                	jmp    80103686 <exit+0x8b>
80103683:	83 c3 7c             	add    $0x7c,%ebx
80103686:	81 fb 54 2c 11 80    	cmp    $0x80112c54,%ebx
8010368c:	73 1a                	jae    801036a8 <exit+0xad>
    if(p->parent == curproc){
8010368e:	39 73 14             	cmp    %esi,0x14(%ebx)
80103691:	75 f0                	jne    80103683 <exit+0x88>
      p->parent = initproc;
80103693:	a1 54 2c 11 80       	mov    0x80112c54,%eax
80103698:	89 43 14             	mov    %eax,0x14(%ebx)
      if(p->state == ZOMBIE)
8010369b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010369f:	75 e2                	jne    80103683 <exit+0x88>
        wakeup1(initproc);
801036a1:	e8 56 f9 ff ff       	call   80102ffc <wakeup1>
801036a6:	eb db                	jmp    80103683 <exit+0x88>
  curproc->state = ZOMBIE;
801036a8:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  sched();
801036af:	e8 a4 fe ff ff       	call   80103558 <sched>
  panic("zombie exit");
801036b4:	83 ec 0c             	sub    $0xc,%esp
801036b7:	68 e8 6b 10 80       	push   $0x80106be8
801036bc:	e8 87 cc ff ff       	call   80100348 <panic>
...
801036c7:	68 20 0d 11 80       	push   $0x80110d20
801036cc:	e8 1d 05 00 00       	call   80103bee <acquire>
  myproc()->state = RUNNABLE;
801036d1:	e8 df fa ff ff       	call   801031b5 <myproc>
801036d6:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
801036dd:	e8 76 fe ff ff       	call   80103558 <sched>
  release(&ptable.lock);
801036e2:	c7 04 24 20 0d 11 80 	movl   $0x80110d20,(%esp)
801036e9:	e8 65 05 00 00       	call   80103c53 <release>
}
...
801036f8:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
801036fb:	e8 b5 fa ff ff       	call   801031b5 <myproc>
  if(p == 0)
80103700:	85 c0                	test   %eax,%eax
80103702:	74 66                	je     8010376a <sleep+0x77>
80103704:	89 c3                	mov    %eax,%ebx
  if(lk == 0)
80103706:	85 f6                	test   %esi,%esi
80103708:	74 6d                	je     80103777 <sleep+0x84>
  if(lk != &ptable.lock){  //DOC: sleeplock0
8010370a:	81 fe 20 0d 11 80    	cmp    $0x80110d20,%esi
80103710:	74 18                	je     8010372a <sleep+0x37>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103712:	83 ec 0c             	sub    $0xc,%esp
80103715:	68 20 0d 11 80       	push   $0x80110d20
8010371a:	e8 cf 04 00 00       	call   80103bee <acquire>
    release(lk);
8010371f:	89 34 24             	mov    %esi,(%esp)
80103722:	e8 2c 05 00 00       	call   80103c53 <release>
80103727:	83 c4 10             	add    $0x10,%esp
  p->chan = chan;
8010372a:	8b 45 08             	mov    0x8(%ebp),%eax
8010372d:	89 43 20             	mov    %eax,0x20(%ebx)
  p->state = SLEEPING;
80103730:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103737:	e8 1c fe ff ff       	call   80103558 <sched>
  p->chan = 0;
8010373c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
  if(lk != &ptable.lock){  //DOC: sleeplock2
80103743:	81 fe 20 0d 11 80    	cmp    $0x80110d20,%esi
80103749:	74 18                	je     80103763 <sleep+0x70>
    release(&ptable.lock);
8010374b:	83 ec 0c             	sub    $0xc,%esp
8010374e:	68 20 0d 11 80       	push   $0x80110d20
80103753:	e8 fb 04 00 00       	call   80103c53 <release>
    acquire(lk);
80103758:	89 34 24             	mov    %esi,(%esp)
8010375b:	e8 8e 04 00 00       	call   80103bee <acquire>
...
8010376d:	68 f4 6b 10 80       	push   $0x80106bf4
80103772:	e8 d1 cb ff ff       	call   80100348 <panic>
    panic("sleep without lk");
80103777:	83 ec 0c             	sub    $0xc,%esp
8010377a:	68 fa 6b 10 80       	push   $0x80106bfa
8010377f:	e8 c4 cb ff ff       	call   80100348 <panic>
...
80103788:	53                   	push   %ebx
  struct proc *curproc = myproc();
80103789:	e8 27 fa ff ff       	call   801031b5 <myproc>
8010378e:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103790:	83 ec 0c             	sub    $0xc,%esp
80103793:	68 20 0d 11 80       	push   $0x80110d20
80103798:	e8 51 04 00 00       	call   80103bee <acquire>
8010379d:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
801037a0:	b8 00 00 00 00       	mov    $0x0,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801037a5:	bb 54 0d 11 80       	mov    $0x80110d54,%ebx
801037aa:	eb 5b                	jmp    80103807 <wait+0x83>
        pid = p->pid;
801037ac:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
801037af:	83 ec 0c             	sub    $0xc,%esp
801037b2:	ff 73 08             	push   0x8(%ebx)
801037b5:	e8 d2 e7 ff ff       	call   80101f8c <kfree>
        p->kstack = 0;
801037ba:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
801037c1:	83 c4 04             	add    $0x4,%esp
801037c4:	ff 73 04             	push   0x4(%ebx)
801037c7:	e8 79 2b 00 00       	call   80106345 <freevm>
        p->pid = 0;
801037cc:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
801037d3:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
801037da:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
801037de:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
801037e5:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801037ec:	c7 04 24 20 0d 11 80 	movl   $0x80110d20,(%esp)
801037f3:	e8 5b 04 00 00       	call   80103c53 <release>
        return pid;
801037f8:	83 c4 10             	add    $0x10,%esp
}
801037fb:	89 f0                	mov    %esi,%eax
...
80103803:	c3                   	ret    
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103804:	83 c3 7c             	add    $0x7c,%ebx
80103807:	81 fb 54 2c 11 80    	cmp    $0x80112c54,%ebx
8010380d:	73 12                	jae    80103821 <wait+0x9d>
      if(p->parent != curproc)
8010380f:	39 73 14             	cmp    %esi,0x14(%ebx)
80103812:	75 f0                	jne    80103804 <wait+0x80>
      if(p->state == ZOMBIE){
80103814:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103818:	74 92                	je     801037ac <wait+0x28>
      havekids = 1;
8010381a:	b8 01 00 00 00       	mov    $0x1,%eax
8010381f:	eb e3                	jmp    80103804 <wait+0x80>
    if(!havekids || curproc->killed){
80103821:	85 c0                	test   %eax,%eax
80103823:	74 06                	je     8010382b <wait+0xa7>
80103825:	83 7e 24 00          	cmpl   $0x0,0x24(%esi)
80103829:	74 17                	je     80103842 <wait+0xbe>
      release(&ptable.lock);
8010382b:	83 ec 0c             	sub    $0xc,%esp
8010382e:	68 20 0d 11 80       	push   $0x80110d20
80103833:	e8 1b 04 00 00       	call   80103c53 <release>
      return -1;
80103838:	83 c4 10             	add    $0x10,%esp
8010383b:	be ff ff ff ff       	mov    $0xffffffff,%esi
80103840:	eb b9                	jmp    801037fb <wait+0x77>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103842:	83 ec 08             	sub    $0x8,%esp
80103845:	68 20 0d 11 80       	push   $0x80110d20
8010384a:	56                   	push   %esi
8010384b:	e8 a3 fe ff ff       	call   801036f3 <sleep>
    havekids = 0;
80103850:	83 c4 10             	add    $0x10,%esp
80103853:	e9 48 ff ff ff       	jmp    801037a0 <wait+0x1c>
...
8010385b:	83 ec 14             	sub    $0x14,%esp
  acquire(&ptable.lock);
8010385e:	68 20 0d 11 80       	push   $0x80110d20
80103863:	e8 86 03 00 00       	call   80103bee <acquire>
  wakeup1(chan);
80103868:	8b 45 08             	mov    0x8(%ebp),%eax
8010386b:	e8 8c f7 ff ff       	call   80102ffc <wakeup1>
  release(&ptable.lock);
80103870:	c7 04 24 20 0d 11 80 	movl   $0x80110d20,(%esp)
80103877:	e8 d7 03 00 00       	call   80103c53 <release>
}
...
80103888:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *p;

  acquire(&ptable.lock);
8010388b:	68 20 0d 11 80       	push   $0x80110d20
80103890:	e8 59 03 00 00       	call   80103bee <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103895:	83 c4 10             	add    $0x10,%esp
80103898:	b8 54 0d 11 80       	mov    $0x80110d54,%eax
8010389d:	eb 0c                	jmp    801038ab <kill+0x2a>
    if(p->pid == pid){
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
        p->state = RUNNABLE;
8010389f:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
801038a6:	eb 1c                	jmp    801038c4 <kill+0x43>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801038a8:	83 c0 7c             	add    $0x7c,%eax
801038ab:	3d 54 2c 11 80       	cmp    $0x80112c54,%eax
801038b0:	73 2c                	jae    801038de <kill+0x5d>
    if(p->pid == pid){
801038b2:	39 58 10             	cmp    %ebx,0x10(%eax)
801038b5:	75 f1                	jne    801038a8 <kill+0x27>
      p->killed = 1;
801038b7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
801038be:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
801038c2:	74 db                	je     8010389f <kill+0x1e>
      release(&ptable.lock);
801038c4:	83 ec 0c             	sub    $0xc,%esp
801038c7:	68 20 0d 11 80       	push   $0x80110d20
801038cc:	e8 82 03 00 00       	call   80103c53 <release>
      return 0;
...
801038e1:	68 20 0d 11 80       	push   $0x80110d20
801038e6:	e8 68 03 00 00       	call   80103c53 <release>
  return -1;
801038eb:	83 c4 10             	add    $0x10,%esp
801038ee:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801038f3:	eb e4                	jmp    801038d9 <kill+0x58>
...
801038fa:	83 ec 30             	sub    $0x30,%esp
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801038fd:	bb 54 0d 11 80       	mov    $0x80110d54,%ebx
80103902:	eb 33                	jmp    80103937 <procdump+0x42>
    if(p->state == UNUSED)
      continue;
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
      ...
      state = "???";
80103904:	b8 0b 6c 10 80       	mov    $0x80106c0b,%eax
    cprintf("%d %s %s", p->pid, state, p->name);
80103909:	8d 53 6c             	lea    0x6c(%ebx),%edx
8010390c:	52                   	push   %edx
8010390d:	50                   	push   %eax
8010390e:	ff 73 10             	push   0x10(%ebx)
80103911:	68 0f 6c 10 80       	push   $0x80106c0f
80103916:	e8 ec cc ff ff       	call   80100607 <cprintf>
    if(p->state == SLEEPING){
8010391b:	83 c4 10             	add    $0x10,%esp
8010391e:	83 7b 0c 02          	cmpl   $0x2,0xc(%ebx)
80103922:	74 39                	je     8010395d <procdump+0x68>
...
80103927:	68 7f 6f 10 80       	push   $0x80106f7f
8010392c:	e8 d6 cc ff ff       	call   80100607 <cprintf>
80103931:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103934:	83 c3 7c             	add    $0x7c,%ebx
80103937:	81 fb 54 2c 11 80    	cmp    $0x80112c54,%ebx
8010393d:	73 61                	jae    801039a0 <procdump+0xab>
    if(p->state == UNUSED)
8010393f:	8b 43 0c             	mov    0xc(%ebx),%eax
80103942:	85 c0                	test   %eax,%eax
80103944:	74 ee                	je     80103934 <procdump+0x3f>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103946:	83 f8 05             	cmp    $0x5,%eax
80103949:	77 b9                	ja     80103904 <procdump+0xf>
8010394b:	8b 04 85 6c 6c 10 80 	mov    -0x7fef9394(,%eax,4),%eax
80103952:	85 c0                	test   %eax,%eax
80103954:	75 b3                	jne    80103909 <procdump+0x14>
      state = "???";
80103956:	b8 0b 6c 10 80       	mov    $0x80106c0b,%eax
8010395b:	eb ac                	jmp    80103909 <procdump+0x14>
      getcallerpcs((uint*)p->context->ebp+2, pc);
8010395d:	8b 43 1c             	mov    0x1c(%ebx),%eax
80103960:	8b 40 0c             	mov    0xc(%eax),%eax
80103963:	83 c0 08             	add    $0x8,%eax
80103966:	83 ec 08             	sub    $0x8,%esp
80103969:	8d 55 d0             	lea    -0x30(%ebp),%edx
8010396c:	52                   	push   %edx
8010396d:	50                   	push   %eax
8010396e:	e8 5a 01 00 00       	call   80103acd <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
80103973:	83 c4 10             	add    $0x10,%esp
80103976:	be 00 00 00 00       	mov    $0x0,%esi
8010397b:	eb 14                	jmp    80103991 <procdump+0x9c>
        cprintf(" %p", pc[i]);
8010397d:	83 ec 08             	sub    $0x8,%esp
80103980:	50                   	push   %eax
80103981:	68 61 66 10 80       	push   $0x80106661
80103986:	e8 7c cc ff ff       	call   80100607 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
8010398b:	83 c6 01             	add    $0x1,%esi
8010398e:	83 c4 10             	add    $0x10,%esp
80103991:	83 fe 09             	cmp    $0x9,%esi
80103994:	7f 8e                	jg     80103924 <procdump+0x2f>
80103996:	8b 44 b5 d0          	mov    -0x30(%ebp,%esi,4),%eax
8010399a:	85 c0                	test   %eax,%eax
8010399c:	75 df                	jne    8010397d <procdump+0x88>
8010399e:	eb 84                	jmp    80103924 <procdump+0x2f>
  }
}
...
801039ae:	8b 5d 08             	mov    0x8(%ebp),%ebx
  initlock(&lk->lk, "sleep lock");
801039b1:	68 84 6c 10 80       	push   $0x80106c84
801039b6:	8d 43 04             	lea    0x4(%ebx),%eax
801039b9:	50                   	push   %eax
801039ba:	e8 f3 00 00 00       	call   80103ab2 <initlock>
  lk->name = name;
801039bf:	8b 45 0c             	mov    0xc(%ebp),%eax
801039c2:	89 43 38             	mov    %eax,0x38(%ebx)
  lk->locked = 0;
801039c5:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
801039cb:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
}
...
801039df:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
801039e2:	8d 73 04             	lea    0x4(%ebx),%esi
801039e5:	83 ec 0c             	sub    $0xc,%esp
801039e8:	56                   	push   %esi
801039e9:	e8 00 02 00 00       	call   80103bee <acquire>
  while (lk->locked) {
801039ee:	83 c4 10             	add    $0x10,%esp
801039f1:	eb 0d                	jmp    80103a00 <acquiresleep+0x26>
    sleep(lk, &lk->lk);
801039f3:	83 ec 08             	sub    $0x8,%esp
801039f6:	56                   	push   %esi
801039f7:	53                   	push   %ebx
801039f8:	e8 f6 fc ff ff       	call   801036f3 <sleep>
801039fd:	83 c4 10             	add    $0x10,%esp
  while (lk->locked) {
80103a00:	83 3b 00             	cmpl   $0x0,(%ebx)
80103a03:	75 ee                	jne    801039f3 <acquiresleep+0x19>
  }
  lk->locked = 1;
80103a05:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80103a0b:	e8 a5 f7 ff ff       	call   801031b5 <myproc>
80103a10:	8b 40 10             	mov    0x10(%eax),%eax
80103a13:	89 43 3c             	mov    %eax,0x3c(%ebx)
  release(&lk->lk);
80103a16:	83 ec 0c             	sub    $0xc,%esp
80103a19:	56                   	push   %esi
80103a1a:	e8 34 02 00 00       	call   80103c53 <release>
}
...
80103a2e:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
80103a31:	8d 73 04             	lea    0x4(%ebx),%esi
80103a34:	83 ec 0c             	sub    $0xc,%esp
80103a37:	56                   	push   %esi
80103a38:	e8 b1 01 00 00       	call   80103bee <acquire>
  lk->locked = 0;
80103a3d:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  lk->pid = 0;
80103a43:	c7 43 3c 00 00 00 00 	movl   $0x0,0x3c(%ebx)
  wakeup(lk);
80103a4a:	89 1c 24             	mov    %ebx,(%esp)
80103a4d:	e8 06 fe ff ff       	call   80103858 <wakeup>
  release(&lk->lk);
80103a52:	89 34 24             	mov    %esi,(%esp)
80103a55:	e8 f9 01 00 00       	call   80103c53 <release>
}
...
80103a69:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&lk->lk);
80103a6c:	8d 73 04             	lea    0x4(%ebx),%esi
80103a6f:	83 ec 0c             	sub    $0xc,%esp
80103a72:	56                   	push   %esi
80103a73:	e8 76 01 00 00       	call   80103bee <acquire>
  r = lk->locked && (lk->pid == myproc()->pid);
80103a78:	83 c4 10             	add    $0x10,%esp
80103a7b:	83 3b 00             	cmpl   $0x0,(%ebx)
80103a7e:	75 17                	jne    80103a97 <holdingsleep+0x33>
80103a80:	bb 00 00 00 00       	mov    $0x0,%ebx
  release(&lk->lk);
80103a85:	83 ec 0c             	sub    $0xc,%esp
80103a88:	56                   	push   %esi
80103a89:	e8 c5 01 00 00       	call   80103c53 <release>
  return r;
}
...
80103a96:	c3                   	ret    
  r = lk->locked && (lk->pid == myproc()->pid);
80103a97:	8b 5b 3c             	mov    0x3c(%ebx),%ebx
80103a9a:	e8 16 f7 ff ff       	call   801031b5 <myproc>
80103a9f:	3b 58 10             	cmp    0x10(%eax),%ebx
80103aa2:	74 07                	je     80103aab <holdingsleep+0x47>
80103aa4:	bb 00 00 00 00       	mov    $0x0,%ebx
80103aa9:	eb da                	jmp    80103a85 <holdingsleep+0x21>
80103aab:	bb 01 00 00 00       	mov    $0x1,%ebx
80103ab0:	eb d3                	jmp    80103a85 <holdingsleep+0x21>
...
80103ab5:	8b 45 08             	mov    0x8(%ebp),%eax
  lk->name = name;
80103ab8:	8b 55 0c             	mov    0xc(%ebp),%edx
80103abb:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80103abe:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80103ac4:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80103acb:	5d                   	pop    %ebp
80103acc:	c3                   	ret    

80103acd <getcallerpcs>:
}
...
80103ad1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  uint *ebp;
  int i;

  ebp = (uint*)v - 2;
80103ad4:	8b 45 08             	mov    0x8(%ebp),%eax
80103ad7:	8d 50 f8             	lea    -0x8(%eax),%edx
  for(i = 0; i < 10; i++){
80103ada:	b8 00 00 00 00       	mov    $0x0,%eax
80103adf:	83 f8 09             	cmp    $0x9,%eax
80103ae2:	7f 25                	jg     80103b09 <getcallerpcs+0x3c>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80103ae4:	8d 9a 00 00 00 80    	lea    -0x80000000(%edx),%ebx
80103aea:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
80103af0:	77 17                	ja     80103b09 <getcallerpcs+0x3c>
      break;
    pcs[i] = ebp[1];     // saved %eip
80103af2:	8b 5a 04             	mov    0x4(%edx),%ebx
80103af5:	89 1c 81             	mov    %ebx,(%ecx,%eax,4)
    ebp = (uint*)ebp[0]; // saved %ebp
80103af8:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
80103afa:	83 c0 01             	add    $0x1,%eax
80103afd:	eb e0                	jmp    80103adf <getcallerpcs+0x12>
  }
  for(; i < 10; i++)
    pcs[i] = 0;
80103aff:	c7 04 81 00 00 00 00 	movl   $0x0,(%ecx,%eax,4)
  for(; i < 10; i++)
80103b06:	83 c0 01             	add    $0x1,%eax
80103b09:	83 f8 09             	cmp    $0x9,%eax
80103b0c:	7e f1                	jle    80103aff <getcallerpcs+0x32>
}
...
80103b1c:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
80103b1d:	e8 1c f6 ff ff       	call   8010313e <mycpu>
80103b22:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103b29:	74 11                	je     80103b3c <pushcli+0x29>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80103b2b:	e8 0e f6 ff ff       	call   8010313e <mycpu>
80103b30:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
80103b37:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103b3a:	c9                   	leave  
80103b3b:	c3                   	ret    
    mycpu()->intena = eflags & FL_IF;
80103b3c:	e8 fd f5 ff ff       	call   8010313e <mycpu>
80103b41:	81 e3 00 02 00 00    	and    $0x200,%ebx
80103b47:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80103b4d:	eb dc                	jmp    80103b2b <pushcli+0x18>
...
80103b5a:	75 28                	jne    80103b84 <popcli+0x35>
    panic("popcli - interruptible");
  if(--mycpu()->ncli < 0)
80103b5c:	e8 dd f5 ff ff       	call   8010313e <mycpu>
80103b61:	8b 88 a4 00 00 00    	mov    0xa4(%eax),%ecx
80103b67:	8d 51 ff             	lea    -0x1(%ecx),%edx
80103b6a:	89 90 a4 00 00 00    	mov    %edx,0xa4(%eax)
80103b70:	85 d2                	test   %edx,%edx
80103b72:	78 1d                	js     80103b91 <popcli+0x42>
    panic("popcli");
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103b74:	e8 c5 f5 ff ff       	call   8010313e <mycpu>
80103b79:	83 b8 a4 00 00 00 00 	cmpl   $0x0,0xa4(%eax)
80103b80:	74 1c                	je     80103b9e <popcli+0x4f>
    sti();
}
80103b82:	c9                   	leave  
80103b83:	c3                   	ret    
...
80103b87:	68 8f 6c 10 80       	push   $0x80106c8f
80103b8c:	e8 b7 c7 ff ff       	call   80100348 <panic>
    panic("popcli");
80103b91:	83 ec 0c             	sub    $0xc,%esp
80103b94:	68 a6 6c 10 80       	push   $0x80106ca6
80103b99:	e8 aa c7 ff ff       	call   80100348 <panic>
  if(mycpu()->ncli == 0 && mycpu()->intena)
80103b9e:	e8 9b f5 ff ff       	call   8010313e <mycpu>
80103ba3:	83 b8 a8 00 00 00 00 	cmpl   $0x0,0xa8(%eax)
80103baa:	74 d6                	je     80103b82 <popcli+0x33>
  asm volatile("sti");
80103bac:	fb                   	sti    
}
80103bad:	eb d3                	jmp    80103b82 <popcli+0x33>
...
80103bb6:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pushcli();
80103bb9:	e8 55 ff ff ff       	call   80103b13 <pushcli>
  r = lock->locked && lock->cpu == mycpu();
80103bbe:	83 3b 00             	cmpl   $0x0,(%ebx)
80103bc1:	75 11                	jne    80103bd4 <holding+0x25>
80103bc3:	bb 00 00 00 00       	mov    $0x0,%ebx
  popcli();
80103bc8:	e8 82 ff ff ff       	call   80103b4f <popcli>
}
80103bcd:	89 d8                	mov    %ebx,%eax
80103bcf:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103bd2:	c9                   	leave  
80103bd3:	c3                   	ret    
  r = lock->locked && lock->cpu == mycpu();
80103bd4:	8b 5b 08             	mov    0x8(%ebx),%ebx
80103bd7:	e8 62 f5 ff ff       	call   8010313e <mycpu>
80103bdc:	39 c3                	cmp    %eax,%ebx
80103bde:	74 07                	je     80103be7 <holding+0x38>
80103be0:	bb 00 00 00 00       	mov    $0x0,%ebx
80103be5:	eb e1                	jmp    80103bc8 <holding+0x19>
80103be7:	bb 01 00 00 00       	mov    $0x1,%ebx
80103bec:	eb da                	jmp    80103bc8 <holding+0x19>
...
80103bf5:	e8 19 ff ff ff       	call   80103b13 <pushcli>
  if(holding(lk))
80103bfa:	83 ec 0c             	sub    $0xc,%esp
80103bfd:	ff 75 08             	push   0x8(%ebp)
80103c00:	e8 aa ff ff ff       	call   80103baf <holding>
80103c05:	83 c4 10             	add    $0x10,%esp
80103c08:	85 c0                	test   %eax,%eax
80103c0a:	75 3a                	jne    80103c46 <acquire+0x58>
  while(xchg(&lk->locked, 1) != 0)
80103c0c:	8b 55 08             	mov    0x8(%ebp),%edx
  asm volatile("lock; xchgl %0, %1" :
80103c0f:	b8 01 00 00 00       	mov    $0x1,%eax
80103c14:	f0 87 02             	lock xchg %eax,(%edx)
80103c17:	85 c0                	test   %eax,%eax
80103c19:	75 f1                	jne    80103c0c <acquire+0x1e>
  __sync_synchronize();
80103c1b:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  lk->cpu = mycpu();
80103c20:	8b 5d 08             	mov    0x8(%ebp),%ebx
80103c23:	e8 16 f5 ff ff       	call   8010313e <mycpu>
80103c28:	89 43 08             	mov    %eax,0x8(%ebx)
  getcallerpcs(&lk, lk->pcs);
80103c2b:	8b 45 08             	mov    0x8(%ebp),%eax
80103c2e:	83 c0 0c             	add    $0xc,%eax
80103c31:	83 ec 08             	sub    $0x8,%esp
80103c34:	50                   	push   %eax
80103c35:	8d 45 08             	lea    0x8(%ebp),%eax
80103c38:	50                   	push   %eax
80103c39:	e8 8f fe ff ff       	call   80103acd <getcallerpcs>
}
80103c3e:	83 c4 10             	add    $0x10,%esp
80103c41:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103c44:	c9                   	leave  
80103c45:	c3                   	ret    
    panic("acquire");
80103c46:	83 ec 0c             	sub    $0xc,%esp
80103c49:	68 ad 6c 10 80       	push   $0x80106cad
...
80103c5e:	e8 4c ff ff ff       	call   80103baf <holding>
80103c63:	83 c4 10             	add    $0x10,%esp
80103c66:	85 c0                	test   %eax,%eax
80103c68:	74 23                	je     80103c8d <release+0x3a>
  lk->pcs[0] = 0;
80103c6a:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
  lk->cpu = 0;
80103c71:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
80103c78:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80103c7d:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
  popcli();
80103c83:	e8 c7 fe ff ff       	call   80103b4f <popcli>
}
...
80103c90:	68 b5 6c 10 80       	push   $0x80106cb5
...
80103ca5:	8b 4d 10             	mov    0x10(%ebp),%ecx
  if ((int)dst%4 == 0 && n%4 == 0){
80103ca8:	f6 c2 03             	test   $0x3,%dl
80103cab:	75 25                	jne    80103cd2 <memset+0x38>
80103cad:	f6 c1 03             	test   $0x3,%cl
80103cb0:	75 20                	jne    80103cd2 <memset+0x38>
    c &= 0xFF;
80103cb2:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80103cb5:	c1 e9 02             	shr    $0x2,%ecx
80103cb8:	c1 e0 18             	shl    $0x18,%eax
80103cbb:	89 fb                	mov    %edi,%ebx
80103cbd:	c1 e3 10             	shl    $0x10,%ebx
80103cc0:	09 d8                	or     %ebx,%eax
80103cc2:	89 fb                	mov    %edi,%ebx
80103cc4:	c1 e3 08             	shl    $0x8,%ebx
80103cc7:	09 d8                	or     %ebx,%eax
80103cc9:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
80103ccb:	89 d7                	mov    %edx,%edi
80103ccd:	fc                   	cld    
80103cce:	f3 ab                	rep stos %eax,%es:(%edi)
}
80103cd0:	eb 05                	jmp    80103cd7 <memset+0x3d>
  asm volatile("cld; rep stosb" :
80103cd2:	89 d7                	mov    %edx,%edi
80103cd4:	fc                   	cld    
...
80103ce8:	8b 45 10             	mov    0x10(%ebp),%eax
  ...
  s2 = v2;
  while(n-- > 0){
80103ceb:	eb 08                	jmp    80103cf5 <memcmp+0x18>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
80103ced:	83 c1 01             	add    $0x1,%ecx
80103cf0:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80103cf3:	89 f0                	mov    %esi,%eax
80103cf5:	8d 70 ff             	lea    -0x1(%eax),%esi
80103cf8:	85 c0                	test   %eax,%eax
80103cfa:	74 12                	je     80103d0e <memcmp+0x31>
    if(*s1 != *s2)
80103cfc:	0f b6 01             	movzbl (%ecx),%eax
80103cff:	0f b6 1a             	movzbl (%edx),%ebx
80103d02:	38 d8                	cmp    %bl,%al
80103d04:	74 e7                	je     80103ced <memcmp+0x10>
      return *s1 - *s2;
80103d06:	0f b6 c0             	movzbl %al,%eax
80103d09:	0f b6 db             	movzbl %bl,%ebx
80103d0c:	29 d8                	sub    %ebx,%eax
  }
...
80103d17:	8b 75 08             	mov    0x8(%ebp),%esi
80103d1a:	8b 55 0c             	mov    0xc(%ebp),%edx
80103d1d:	8b 45 10             	mov    0x10(%ebp),%eax
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80103d20:	39 f2                	cmp    %esi,%edx
80103d22:	73 3c                	jae    80103d60 <memmove+0x4e>
80103d24:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
80103d27:	39 f1                	cmp    %esi,%ecx
80103d29:	76 39                	jbe    80103d64 <memmove+0x52>
    s += n;
    d += n;
80103d2b:	8d 14 06             	lea    (%esi,%eax,1),%edx
    while(n-- > 0)
80103d2e:	eb 0d                	jmp    80103d3d <memmove+0x2b>
      *--d = *--s;
80103d30:	83 e9 01             	sub    $0x1,%ecx
80103d33:	83 ea 01             	sub    $0x1,%edx
80103d36:	0f b6 01             	movzbl (%ecx),%eax
80103d39:	88 02                	mov    %al,(%edx)
    while(n-- > 0)
80103d3b:	89 d8                	mov    %ebx,%eax
80103d3d:	8d 58 ff             	lea    -0x1(%eax),%ebx
80103d40:	85 c0                	test   %eax,%eax
80103d42:	75 ec                	jne    80103d30 <memmove+0x1e>
80103d44:	eb 14                	jmp    80103d5a <memmove+0x48>
  } else
    while(n-- > 0)
      *d++ = *s++;
80103d46:	0f b6 02             	movzbl (%edx),%eax
80103d49:	88 01                	mov    %al,(%ecx)
80103d4b:	8d 49 01             	lea    0x1(%ecx),%ecx
80103d4e:	8d 52 01             	lea    0x1(%edx),%edx
    while(n-- > 0)
80103d51:	89 d8                	mov    %ebx,%eax
80103d53:	8d 58 ff             	lea    -0x1(%eax),%ebx
80103d56:	85 c0                	test   %eax,%eax
80103d58:	75 ec                	jne    80103d46 <memmove+0x34>

  return dst;
}
80103d5a:	89 f0                	mov    %esi,%eax
80103d5c:	5b                   	pop    %ebx
80103d5d:	5e                   	pop    %esi
80103d5e:	5d                   	pop    %ebp
80103d5f:	c3                   	ret    
80103d60:	89 f1                	mov    %esi,%ecx
80103d62:	eb ef                	jmp    80103d53 <memmove+0x41>
80103d64:	89 f1                	mov    %esi,%ecx
80103d66:	eb eb                	jmp    80103d53 <memmove+0x41>
...
80103d6e:	ff 75 10             	push   0x10(%ebp)
80103d71:	ff 75 0c             	push   0xc(%ebp)
80103d74:	ff 75 08             	push   0x8(%ebp)
80103d77:	e8 96 ff ff ff       	call   80103d12 <memmove>
}
80103d7c:	c9                   	leave  
80103d7d:	c3                   	ret    
...
80103d88:	8b 45 10             	mov    0x10(%ebp),%eax
  while(n > 0 && *p && *p == *q)
80103d8b:	eb 09                	jmp    80103d96 <strncmp+0x18>
    n--, p++, q++;
80103d8d:	83 e8 01             	sub    $0x1,%eax
80103d90:	83 c2 01             	add    $0x1,%edx
80103d93:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
80103d96:	85 c0                	test   %eax,%eax
80103d98:	74 0b                	je     80103da5 <strncmp+0x27>
80103d9a:	0f b6 1a             	movzbl (%edx),%ebx
80103d9d:	84 db                	test   %bl,%bl
80103d9f:	74 04                	je     80103da5 <strncmp+0x27>
80103da1:	3a 19                	cmp    (%ecx),%bl
80103da3:	74 e8                	je     80103d8d <strncmp+0xf>
  if(n == 0)
80103da5:	85 c0                	test   %eax,%eax
80103da7:	74 0d                	je     80103db6 <strncmp+0x38>
    return 0;
  return (uchar)*p - (uchar)*q;
80103da9:	0f b6 02             	movzbl (%edx),%eax
80103dac:	0f b6 11             	movzbl (%ecx),%edx
80103daf:	29 d0                	sub    %edx,%eax
}
...
80103dbb:	eb f4                	jmp    80103db1 <strncmp+0x33>
...
80103dc0:	57                   	push   %edi
80103dc1:	56                   	push   %esi
80103dc2:	53                   	push   %ebx
80103dc3:	8b 7d 08             	mov    0x8(%ebp),%edi
80103dc6:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80103dc9:	8b 45 10             	mov    0x10(%ebp),%eax
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
80103dcc:	89 fa                	mov    %edi,%edx
80103dce:	eb 04                	jmp    80103dd4 <strncpy+0x17>
80103dd0:	89 f1                	mov    %esi,%ecx
80103dd2:	89 da                	mov    %ebx,%edx
80103dd4:	89 c3                	mov    %eax,%ebx
80103dd6:	83 e8 01             	sub    $0x1,%eax
80103dd9:	85 db                	test   %ebx,%ebx
80103ddb:	7e 11                	jle    80103dee <strncpy+0x31>
80103ddd:	8d 71 01             	lea    0x1(%ecx),%esi
80103de0:	8d 5a 01             	lea    0x1(%edx),%ebx
80103de3:	0f b6 09             	movzbl (%ecx),%ecx
80103de6:	88 0a                	mov    %cl,(%edx)
80103de8:	84 c9                	test   %cl,%cl
80103dea:	75 e4                	jne    80103dd0 <strncpy+0x13>
80103dec:	89 da                	mov    %ebx,%edx
    ;
  while(n-- > 0)
80103dee:	8d 48 ff             	lea    -0x1(%eax),%ecx
80103df1:	85 c0                	test   %eax,%eax
80103df3:	7e 0a                	jle    80103dff <strncpy+0x42>
    *s++ = 0;
80103df5:	c6 02 00             	movb   $0x0,(%edx)
  while(n-- > 0)
80103df8:	89 c8                	mov    %ecx,%eax
    *s++ = 0;
80103dfa:	8d 52 01             	lea    0x1(%edx),%edx
80103dfd:	eb ef                	jmp    80103dee <strncpy+0x31>
  return os;
}
80103dff:	89 f8                	mov    %edi,%eax
80103e01:	5b                   	pop    %ebx
80103e02:	5e                   	pop    %esi
80103e03:	5f                   	pop    %edi
80103e04:	5d                   	pop    %ebp
...
80103e0c:	8b 7d 08             	mov    0x8(%ebp),%edi
...
80103e17:	7e 23                	jle    80103e3c <safestrcpy+0x36>
80103e19:	89 fa                	mov    %edi,%edx
80103e1b:	eb 04                	jmp    80103e21 <safestrcpy+0x1b>
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
80103e1d:	89 f1                	mov    %esi,%ecx
80103e1f:	89 da                	mov    %ebx,%edx
80103e21:	83 e8 01             	sub    $0x1,%eax
80103e24:	85 c0                	test   %eax,%eax
80103e26:	7e 11                	jle    80103e39 <safestrcpy+0x33>
80103e28:	8d 71 01             	lea    0x1(%ecx),%esi
80103e2b:	8d 5a 01             	lea    0x1(%edx),%ebx
80103e2e:	0f b6 09             	movzbl (%ecx),%ecx
80103e31:	88 0a                	mov    %cl,(%edx)
80103e33:	84 c9                	test   %cl,%cl
80103e35:	75 e6                	jne    80103e1d <safestrcpy+0x17>
80103e37:	89 da                	mov    %ebx,%edx
    ;
  *s = 0;
80103e39:	c6 02 00             	movb   $0x0,(%edx)
  return os;
}
80103e3c:	89 f8                	mov    %edi,%eax
80103e3e:	5b                   	pop    %ebx
80103e3f:	5e                   	pop    %esi
80103e40:	5f                   	pop    %edi
80103e41:	5d                   	pop    %ebp
...
80103e4e:	eb 03                	jmp    80103e53 <strlen+0x10>
80103e50:	83 c0 01             	add    $0x1,%eax
80103e53:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
80103e57:	75 f7                	jne    80103e50 <strlen+0xd>
    ;
  return n;
}
80103e59:	5d                   	pop    %ebp
...
swtch:
  movl 4(%esp), %eax
80103e5b:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80103e5f:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80103e66:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80103e67:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
80103e69:	89 d4                	mov    %edx,%esp
...
80103e77:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80103e7a:	e8 36 f3 ff ff       	call   801031b5 <myproc>

  if(addr >= curproc->sz || addr+4 > curproc->sz)
80103e7f:	8b 00                	mov    (%eax),%eax
80103e81:	39 d8                	cmp    %ebx,%eax
80103e83:	76 18                	jbe    80103e9d <fetchint+0x2d>
80103e85:	8d 53 04             	lea    0x4(%ebx),%edx
80103e88:	39 d0                	cmp    %edx,%eax
80103e8a:	72 18                	jb     80103ea4 <fetchint+0x34>
    return -1;
  *ip = *(int*)(addr);
80103e8c:	8b 13                	mov    (%ebx),%edx
80103e8e:	8b 45 0c             	mov    0xc(%ebp),%eax
80103e91:	89 10                	mov    %edx,(%eax)
  return 0;
80103e93:	b8 00 00 00 00       	mov    $0x0,%eax
}
80103e98:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103e9b:	c9                   	leave  
80103e9c:	c3                   	ret    
    return -1;
80103e9d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ea2:	eb f4                	jmp    80103e98 <fetchint+0x28>
80103ea4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ea9:	eb ed                	jmp    80103e98 <fetchint+0x28>
...
80103eb2:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80103eb5:	e8 fb f2 ff ff       	call   801031b5 <myproc>

  if(addr >= curproc->sz)
80103eba:	39 18                	cmp    %ebx,(%eax)
80103ebc:	76 25                	jbe    80103ee3 <fetchstr+0x38>
    return -1;
  *pp = (char*)addr;
80103ebe:	8b 55 0c             	mov    0xc(%ebp),%edx
80103ec1:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80103ec3:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
80103ec5:	89 d8                	mov    %ebx,%eax
80103ec7:	eb 03                	jmp    80103ecc <fetchstr+0x21>
80103ec9:	83 c0 01             	add    $0x1,%eax
80103ecc:	39 d0                	cmp    %edx,%eax
80103ece:	73 09                	jae    80103ed9 <fetchstr+0x2e>
    if(*s == 0)
80103ed0:	80 38 00             	cmpb   $0x0,(%eax)
80103ed3:	75 f4                	jne    80103ec9 <fetchstr+0x1e>
      return s - *pp;
80103ed5:	29 d8                	sub    %ebx,%eax
80103ed7:	eb 05                	jmp    80103ede <fetchstr+0x33>
  }
  return -1;
80103ed9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80103ede:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80103ee1:	c9                   	leave  
80103ee2:	c3                   	ret    
    return -1;
80103ee3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103ee8:	eb f4                	jmp    80103ede <fetchstr+0x33>
...
80103ef0:	e8 c0 f2 ff ff       	call   801031b5 <myproc>
80103ef5:	8b 50 18             	mov    0x18(%eax),%edx
80103ef8:	8b 45 08             	mov    0x8(%ebp),%eax
80103efb:	c1 e0 02             	shl    $0x2,%eax
80103efe:	03 42 44             	add    0x44(%edx),%eax
80103f01:	83 ec 08             	sub    $0x8,%esp
80103f04:	ff 75 0c             	push   0xc(%ebp)
80103f07:	83 c0 04             	add    $0x4,%eax
80103f0a:	50                   	push   %eax
80103f0b:	e8 60 ff ff ff       	call   80103e70 <fetchint>
}
80103f10:	c9                   	leave  
80103f11:	c3                   	ret    
...
80103f1a:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80103f1d:	e8 93 f2 ff ff       	call   801031b5 <myproc>
80103f22:	89 c6                	mov    %eax,%esi
 
  if(argint(n, &i) < 0)
80103f24:	83 ec 08             	sub    $0x8,%esp
80103f27:	8d 45 f4             	lea    -0xc(%ebp),%eax
80103f2a:	50                   	push   %eax
80103f2b:	ff 75 08             	push   0x8(%ebp)
80103f2e:	e8 b7 ff ff ff       	call   80103eea <argint>
80103f33:	83 c4 10             	add    $0x10,%esp
80103f36:	85 c0                	test   %eax,%eax
80103f38:	78 24                	js     80103f5e <argptr+0x4c>
    return -1;
  if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
80103f3a:	85 db                	test   %ebx,%ebx
80103f3c:	78 27                	js     80103f65 <argptr+0x53>
80103f3e:	8b 16                	mov    (%esi),%edx
80103f40:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103f43:	39 c2                	cmp    %eax,%edx
80103f45:	76 25                	jbe    80103f6c <argptr+0x5a>
80103f47:	01 c3                	add    %eax,%ebx
80103f49:	39 da                	cmp    %ebx,%edx
80103f4b:	72 26                	jb     80103f73 <argptr+0x61>
    return -1;
  *pp = (char*)i;
...
80103f57:	8d 65 f8             	lea    -0x8(%ebp),%esp
80103f5a:	5b                   	pop    %ebx
80103f5b:	5e                   	pop    %esi
80103f5c:	5d                   	pop    %ebp
80103f5d:	c3                   	ret    
...
80103f63:	eb f2                	jmp    80103f57 <argptr+0x45>
    return -1;
80103f65:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103f6a:	eb eb                	jmp    80103f57 <argptr+0x45>
80103f6c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103f71:	eb e4                	jmp    80103f57 <argptr+0x45>
80103f73:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80103f78:	eb dd                	jmp    80103f57 <argptr+0x45>
...
80103f7d:	83 ec 20             	sub    $0x20,%esp
  int addr;
  if(argint(n, &addr) < 0)
80103f80:	8d 45 f4             	lea    -0xc(%ebp),%eax
80103f83:	50                   	push   %eax
80103f84:	ff 75 08             	push   0x8(%ebp)
80103f87:	e8 5e ff ff ff       	call   80103eea <argint>
80103f8c:	83 c4 10             	add    $0x10,%esp
80103f8f:	85 c0                	test   %eax,%eax
80103f91:	78 13                	js     80103fa6 <argstr+0x2c>
    return -1;
  return fetchstr(addr, pp);
80103f93:	83 ec 08             	sub    $0x8,%esp
80103f96:	ff 75 0c             	push   0xc(%ebp)
80103f99:	ff 75 f4             	push   -0xc(%ebp)
80103f9c:	e8 0a ff ff ff       	call   80103eab <fetchstr>
...
80103fab:	eb f7                	jmp    80103fa4 <argstr+0x2a>
...
80103fb1:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80103fb4:	e8 fc f1 ff ff       	call   801031b5 <myproc>
80103fb9:	89 c3                	mov    %eax,%ebx

  num = curproc->tf->eax;
80103fbb:	8b 40 18             	mov    0x18(%eax),%eax
80103fbe:	8b 40 1c             	mov    0x1c(%eax),%eax
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80103fc1:	8d 50 ff             	lea    -0x1(%eax),%edx
80103fc4:	83 fa 16             	cmp    $0x16,%edx
80103fc7:	77 17                	ja     80103fe0 <syscall+0x33>
80103fc9:	8b 14 85 e0 6c 10 80 	mov    -0x7fef9320(,%eax,4),%edx
80103fd0:	85 d2                	test   %edx,%edx
80103fd2:	74 0c                	je     80103fe0 <syscall+0x33>
    curproc->tf->eax = syscalls[num]();
80103fd4:	ff d2                	call   *%edx
80103fd6:	89 c2                	mov    %eax,%edx
80103fd8:	8b 43 18             	mov    0x18(%ebx),%eax
80103fdb:	89 50 1c             	mov    %edx,0x1c(%eax)
80103fde:	eb 1f                	jmp    80103fff <syscall+0x52>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            curproc->pid, curproc->name, num);
80103fe0:	8d 53 6c             	lea    0x6c(%ebx),%edx
    cprintf("%d %s: unknown sys call %d\n",
80103fe3:	50                   	push   %eax
80103fe4:	52                   	push   %edx
80103fe5:	ff 73 10             	push   0x10(%ebx)
80103fe8:	68 bd 6c 10 80       	push   $0x80106cbd
80103fed:	e8 15 c6 ff ff       	call   80100607 <cprintf>
    curproc->tf->eax = -1;
80103ff2:	8b 43 18             	mov    0x18(%ebx),%eax
80103ff5:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
...
8010400c:	89 d6                	mov    %edx,%esi
8010400e:	89 cb                	mov    %ecx,%ebx
  int fd;
  struct file *f;

  if(argint(n, &fd) < 0)
80104010:	8d 55 f4             	lea    -0xc(%ebp),%edx
80104013:	52                   	push   %edx
80104014:	50                   	push   %eax
80104015:	e8 d0 fe ff ff       	call   80103eea <argint>
8010401a:	83 c4 10             	add    $0x10,%esp
8010401d:	85 c0                	test   %eax,%eax
8010401f:	78 35                	js     80104056 <argfd+0x52>
    return -1;
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104021:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104025:	77 28                	ja     8010404f <argfd+0x4b>
80104027:	e8 89 f1 ff ff       	call   801031b5 <myproc>
8010402c:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010402f:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
80104033:	85 c0                	test   %eax,%eax
80104035:	74 18                	je     8010404f <argfd+0x4b>
    return -1;
  if(pfd)
80104037:	85 f6                	test   %esi,%esi
80104039:	74 02                	je     8010403d <argfd+0x39>
    *pfd = fd;
8010403b:	89 16                	mov    %edx,(%esi)
  if(pf)
8010403d:	85 db                	test   %ebx,%ebx
8010403f:	74 1c                	je     8010405d <argfd+0x59>
    *pf = f;
80104041:	89 03                	mov    %eax,(%ebx)
  return 0;
80104043:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
80104054:	eb f2                	jmp    80104048 <argfd+0x44>
    return -1;
80104056:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010405b:	eb eb                	jmp    80104048 <argfd+0x44>
  return 0;
8010405d:	b8 00 00 00 00       	mov    $0x0,%eax
80104062:	eb e4                	jmp    80104048 <argfd+0x44>
...
80104068:	83 ec 04             	sub    $0x4,%esp
8010406b:	89 c3                	mov    %eax,%ebx
  int fd;
  struct proc *curproc = myproc();
8010406d:	e8 43 f1 ff ff       	call   801031b5 <myproc>
80104072:	89 c2                	mov    %eax,%edx

  for(fd = 0; fd < NOFILE; fd++){
80104074:	b8 00 00 00 00       	mov    $0x0,%eax
80104079:	83 f8 0f             	cmp    $0xf,%eax
8010407c:	7f 12                	jg     80104090 <fdalloc+0x2c>
    if(curproc->ofile[fd] == 0){
8010407e:	83 7c 82 28 00       	cmpl   $0x0,0x28(%edx,%eax,4)
80104083:	74 05                	je     8010408a <fdalloc+0x26>
  for(fd = 0; fd < NOFILE; fd++){
80104085:	83 c0 01             	add    $0x1,%eax
80104088:	eb ef                	jmp    80104079 <fdalloc+0x15>
      curproc->ofile[fd] = f;
8010408a:	89 5c 82 28          	mov    %ebx,0x28(%edx,%eax,4)
      return fd;
8010408e:	eb 05                	jmp    80104095 <fdalloc+0x31>
    }
  }
  return -1;
...
8010409f:	83 ec 10             	sub    $0x10,%esp
801040a2:	89 c3                	mov    %eax,%ebx
  int off;
  struct dirent de;

  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
801040a4:	b8 20 00 00 00       	mov    $0x20,%eax
801040a9:	89 c6                	mov    %eax,%esi
801040ab:	39 43 58             	cmp    %eax,0x58(%ebx)
801040ae:	76 2e                	jbe    801040de <isdirempty+0x44>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
801040b0:	6a 10                	push   $0x10
801040b2:	50                   	push   %eax
801040b3:	8d 45 e8             	lea    -0x18(%ebp),%eax
801040b6:	50                   	push   %eax
801040b7:	53                   	push   %ebx
801040b8:	e8 a4 d6 ff ff       	call   80101761 <readi>
801040bd:	83 c4 10             	add    $0x10,%esp
801040c0:	83 f8 10             	cmp    $0x10,%eax
801040c3:	75 0c                	jne    801040d1 <isdirempty+0x37>
      panic("isdirempty: readi");
    if(de.inum != 0)
801040c5:	66 83 7d e8 00       	cmpw   $0x0,-0x18(%ebp)
801040ca:	75 1e                	jne    801040ea <isdirempty+0x50>
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
801040cc:	8d 46 10             	lea    0x10(%esi),%eax
801040cf:	eb d8                	jmp    801040a9 <isdirempty+0xf>
      panic("isdirempty: readi");
801040d1:	83 ec 0c             	sub    $0xc,%esp
801040d4:	68 40 6d 10 80       	push   $0x80106d40
801040d9:	e8 6a c2 ff ff       	call   80100348 <panic>
      return 0;
  }
  return 1;
801040de:	b8 01 00 00 00       	mov    $0x1,%eax
}
...
801040ef:	eb f2                	jmp    801040e3 <isdirempty+0x49>
...
801040f7:	83 ec 34             	sub    $0x34,%esp
801040fa:	89 55 d4             	mov    %edx,-0x2c(%ebp)
801040fd:	89 4d d0             	mov    %ecx,-0x30(%ebp)
80104100:	8b 7d 08             	mov    0x8(%ebp),%edi
  struct inode *ip, *dp;
  char name[DIRSIZ];

  if((dp = nameiparent(path, name)) == 0)
80104103:	8d 55 da             	lea    -0x26(%ebp),%edx
80104106:	52                   	push   %edx
80104107:	50                   	push   %eax
80104108:	e8 d8 da ff ff       	call   80101be5 <nameiparent>
8010410d:	89 c6                	mov    %eax,%esi
8010410f:	83 c4 10             	add    $0x10,%esp
80104112:	85 c0                	test   %eax,%eax
80104114:	0f 84 33 01 00 00    	je     8010424d <create+0x15c>
    return 0;
  ilock(dp);
8010411a:	83 ec 0c             	sub    $0xc,%esp
8010411d:	50                   	push   %eax
8010411e:	e8 4c d4 ff ff       	call   8010156f <ilock>

  if((ip = dirlookup(dp, name, 0)) != 0){
80104123:	83 c4 0c             	add    $0xc,%esp
80104126:	6a 00                	push   $0x0
80104128:	8d 45 da             	lea    -0x26(%ebp),%eax
8010412b:	50                   	push   %eax
8010412c:	56                   	push   %esi
8010412d:	e8 6d d8 ff ff       	call   8010199f <dirlookup>
80104132:	89 c3                	mov    %eax,%ebx
80104134:	83 c4 10             	add    $0x10,%esp
80104137:	85 c0                	test   %eax,%eax
80104139:	74 3d                	je     80104178 <create+0x87>
    iunlockput(dp);
8010413b:	83 ec 0c             	sub    $0xc,%esp
8010413e:	56                   	push   %esi
8010413f:	e8 d2 d5 ff ff       	call   80101716 <iunlockput>
    ilock(ip);
80104144:	89 1c 24             	mov    %ebx,(%esp)
80104147:	e8 23 d4 ff ff       	call   8010156f <ilock>
    if(type == T_FILE && ip->type == T_FILE)
8010414c:	83 c4 10             	add    $0x10,%esp
8010414f:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80104154:	75 07                	jne    8010415d <create+0x6c>
80104156:	66 83 7b 50 02       	cmpw   $0x2,0x50(%ebx)
8010415b:	74 11                	je     8010416e <create+0x7d>
      return ip;
    iunlockput(ip);
8010415d:	83 ec 0c             	sub    $0xc,%esp
80104160:	53                   	push   %ebx
80104161:	e8 b0 d5 ff ff       	call   80101716 <iunlockput>
    return 0;
80104166:	83 c4 10             	add    $0x10,%esp
80104169:	bb 00 00 00 00       	mov    $0x0,%ebx
...
8010417b:	0f bf 45 d4          	movswl -0x2c(%ebp),%eax
8010417f:	50                   	push   %eax
80104180:	ff 36                	push   (%esi)
80104182:	e8 e5 d1 ff ff       	call   8010136c <ialloc>
80104187:	89 c3                	mov    %eax,%ebx
80104189:	83 c4 10             	add    $0x10,%esp
8010418c:	85 c0                	test   %eax,%eax
8010418e:	74 52                	je     801041e2 <create+0xf1>
  ilock(ip);
80104190:	83 ec 0c             	sub    $0xc,%esp
80104193:	50                   	push   %eax
80104194:	e8 d6 d3 ff ff       	call   8010156f <ilock>
  ip->major = major;
80104199:	0f b7 45 d0          	movzwl -0x30(%ebp),%eax
8010419d:	66 89 43 52          	mov    %ax,0x52(%ebx)
  ip->minor = minor;
801041a1:	66 89 7b 54          	mov    %di,0x54(%ebx)
  ip->nlink = 1;
801041a5:	66 c7 43 56 01 00    	movw   $0x1,0x56(%ebx)
  iupdate(ip);
801041ab:	89 1c 24             	mov    %ebx,(%esp)
801041ae:	e8 5b d2 ff ff       	call   8010140e <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
801041b3:	83 c4 10             	add    $0x10,%esp
801041b6:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
801041bb:	74 32                	je     801041ef <create+0xfe>
  if(dirlink(dp, name, ip->inum) < 0)
801041bd:	83 ec 04             	sub    $0x4,%esp
801041c0:	ff 73 04             	push   0x4(%ebx)
801041c3:	8d 45 da             	lea    -0x26(%ebp),%eax
801041c6:	50                   	push   %eax
801041c7:	56                   	push   %esi
801041c8:	e8 4f d9 ff ff       	call   80101b1c <dirlink>
801041cd:	83 c4 10             	add    $0x10,%esp
801041d0:	85 c0                	test   %eax,%eax
801041d2:	78 6c                	js     80104240 <create+0x14f>
  iunlockput(dp);
801041d4:	83 ec 0c             	sub    $0xc,%esp
801041d7:	56                   	push   %esi
801041d8:	e8 39 d5 ff ff       	call   80101716 <iunlockput>
  return ip;
801041dd:	83 c4 10             	add    $0x10,%esp
801041e0:	eb 8c                	jmp    8010416e <create+0x7d>
    panic("create: ialloc");
801041e2:	83 ec 0c             	sub    $0xc,%esp
801041e5:	68 52 6d 10 80       	push   $0x80106d52
801041ea:	e8 59 c1 ff ff       	call   80100348 <panic>
    dp->nlink++;  // for ".."
801041ef:	0f b7 46 56          	movzwl 0x56(%esi),%eax
801041f3:	83 c0 01             	add    $0x1,%eax
801041f6:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
801041fa:	83 ec 0c             	sub    $0xc,%esp
801041fd:	56                   	push   %esi
801041fe:	e8 0b d2 ff ff       	call   8010140e <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104203:	83 c4 0c             	add    $0xc,%esp
80104206:	ff 73 04             	push   0x4(%ebx)
80104209:	68 62 6d 10 80       	push   $0x80106d62
8010420e:	53                   	push   %ebx
8010420f:	e8 08 d9 ff ff       	call   80101b1c <dirlink>
80104214:	83 c4 10             	add    $0x10,%esp
80104217:	85 c0                	test   %eax,%eax
80104219:	78 18                	js     80104233 <create+0x142>
8010421b:	83 ec 04             	sub    $0x4,%esp
8010421e:	ff 76 04             	push   0x4(%esi)
80104221:	68 61 6d 10 80       	push   $0x80106d61
80104226:	53                   	push   %ebx
80104227:	e8 f0 d8 ff ff       	call   80101b1c <dirlink>
8010422c:	83 c4 10             	add    $0x10,%esp
8010422f:	85 c0                	test   %eax,%eax
80104231:	79 8a                	jns    801041bd <create+0xcc>
      panic("create dots");
80104233:	83 ec 0c             	sub    $0xc,%esp
80104236:	68 64 6d 10 80       	push   $0x80106d64
8010423b:	e8 08 c1 ff ff       	call   80100348 <panic>
    panic("create: dirlink");
80104240:	83 ec 0c             	sub    $0xc,%esp
80104243:	68 70 6d 10 80       	push   $0x80106d70
80104248:	e8 fb c0 ff ff       	call   80100348 <panic>
    return 0;
8010424d:	89 c3                	mov    %eax,%ebx
8010424f:	e9 1a ff ff ff       	jmp    8010416e <create+0x7d>
...
80104258:	83 ec 14             	sub    $0x14,%esp
  if(argfd(0, 0, &f) < 0)
8010425b:	8d 4d f4             	lea    -0xc(%ebp),%ecx
8010425e:	ba 00 00 00 00       	mov    $0x0,%edx
80104263:	b8 00 00 00 00       	mov    $0x0,%eax
80104268:	e8 97 fd ff ff       	call   80104004 <argfd>
8010426d:	85 c0                	test   %eax,%eax
8010426f:	78 23                	js     80104294 <sys_dup+0x40>
  if((fd=fdalloc(f)) < 0)
80104271:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104274:	e8 eb fd ff ff       	call   80104064 <fdalloc>
80104279:	89 c3                	mov    %eax,%ebx
8010427b:	85 c0                	test   %eax,%eax
8010427d:	78 1c                	js     8010429b <sys_dup+0x47>
  filedup(f);
8010427f:	83 ec 0c             	sub    $0xc,%esp
80104282:	ff 75 f4             	push   -0xc(%ebp)
80104285:	e8 f4 c9 ff ff       	call   80100c7e <filedup>
  return fd;
8010428a:	83 c4 10             	add    $0x10,%esp
}
8010428d:	89 d8                	mov    %ebx,%eax
8010428f:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104292:	c9                   	leave  
80104293:	c3                   	ret    
    return -1;
80104294:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104299:	eb f2                	jmp    8010428d <sys_dup+0x39>
    return -1;
8010429b:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801042a0:	eb eb                	jmp    8010428d <sys_dup+0x39>
...
801042a8:	8d 4d f4             	lea    -0xc(%ebp),%ecx
801042ab:	ba 00 00 00 00       	mov    $0x0,%edx
801042b0:	b8 00 00 00 00       	mov    $0x0,%eax
801042b5:	e8 4a fd ff ff       	call   80104004 <argfd>
801042ba:	85 c0                	test   %eax,%eax
801042bc:	78 43                	js     80104301 <sys_read+0x5f>
801042be:	83 ec 08             	sub    $0x8,%esp
801042c1:	8d 45 f0             	lea    -0x10(%ebp),%eax
801042c4:	50                   	push   %eax
801042c5:	6a 02                	push   $0x2
801042c7:	e8 1e fc ff ff       	call   80103eea <argint>
801042cc:	83 c4 10             	add    $0x10,%esp
801042cf:	85 c0                	test   %eax,%eax
801042d1:	78 2e                	js     80104301 <sys_read+0x5f>
801042d3:	83 ec 04             	sub    $0x4,%esp
801042d6:	ff 75 f0             	push   -0x10(%ebp)
801042d9:	8d 45 ec             	lea    -0x14(%ebp),%eax
801042dc:	50                   	push   %eax
801042dd:	6a 01                	push   $0x1
801042df:	e8 2e fc ff ff       	call   80103f12 <argptr>
801042e4:	83 c4 10             	add    $0x10,%esp
801042e7:	85 c0                	test   %eax,%eax
801042e9:	78 16                	js     80104301 <sys_read+0x5f>
  return fileread(f, p, n);
801042eb:	83 ec 04             	sub    $0x4,%esp
801042ee:	ff 75 f0             	push   -0x10(%ebp)
801042f1:	ff 75 ec             	push   -0x14(%ebp)
801042f4:	ff 75 f4             	push   -0xc(%ebp)
801042f7:	e8 d4 ca ff ff       	call   80100dd0 <fileread>
801042fc:	83 c4 10             	add    $0x10,%esp
}
801042ff:	c9                   	leave  
80104300:	c3                   	ret    
    return -1;
80104301:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104306:	eb f7                	jmp    801042ff <sys_read+0x5d>
...
8010430e:	6a 00                	push   $0x0
80104310:	6a 00                	push   $0x0
80104312:	6a 00                	push   $0x0
80104314:	6a 00                	push   $0x0
80104316:	e8 10 f0 ff ff       	call   8010332b <clone>
}
8010431b:	c9                   	leave  
8010431c:	c3                   	ret    
...
80104320:	83 ec 14             	sub    $0x14,%esp
  return join(0);
80104323:	6a 00                	push   $0x0
80104325:	e8 97 f0 ff ff       	call   801033c1 <join>
}
8010432a:	c9                   	leave  
8010432b:	c3                   	ret    
...
80104369:	e8 a4 fb ff ff       	call   80103f12 <argptr>
8010436e:	83 c4 10             	add    $0x10,%esp
80104371:	85 c0                	test   %eax,%eax
80104373:	78 16                	js     8010438b <sys_write+0x5f>
  return filewrite(f, p, n);
80104375:	83 ec 04             	sub    $0x4,%esp
80104378:	ff 75 f0             	push   -0x10(%ebp)
8010437b:	ff 75 ec             	push   -0x14(%ebp)
8010437e:	ff 75 f4             	push   -0xc(%ebp)
80104381:	e8 cf ca ff ff       	call   80100e55 <filewrite>
...
80104390:	eb f7                	jmp    80104389 <sys_write+0x5d>

80104392 <sys_close>:
{
80104392:	55                   	push   %ebp
80104393:	89 e5                	mov    %esp,%ebp
80104395:	83 ec 18             	sub    $0x18,%esp
  if(argfd(0, &fd, &f) < 0)
80104398:	8d 4d f0             	lea    -0x10(%ebp),%ecx
8010439b:	8d 55 f4             	lea    -0xc(%ebp),%edx
8010439e:	b8 00 00 00 00       	mov    $0x0,%eax
801043a3:	e8 5c fc ff ff       	call   80104004 <argfd>
801043a8:	85 c0                	test   %eax,%eax
801043aa:	78 25                	js     801043d1 <sys_close+0x3f>
  myproc()->ofile[fd] = 0;
801043ac:	e8 04 ee ff ff       	call   801031b5 <myproc>
801043b1:	8b 55 f4             	mov    -0xc(%ebp),%edx
801043b4:	c7 44 90 28 00 00 00 	movl   $0x0,0x28(%eax,%edx,4)
801043bb:	00 
  fileclose(f);
801043bc:	83 ec 0c             	sub    $0xc,%esp
801043bf:	ff 75 f0             	push   -0x10(%ebp)
801043c2:	e8 fc c8 ff ff       	call   80100cc3 <fileclose>
  return 0;
...
801043d6:	eb f7                	jmp    801043cf <sys_close+0x3d>
...
801043eb:	e8 14 fc ff ff       	call   80104004 <argfd>
801043f0:	85 c0                	test   %eax,%eax
801043f2:	78 2a                	js     8010441e <sys_fstat+0x46>
801043f4:	83 ec 04             	sub    $0x4,%esp
801043f7:	6a 14                	push   $0x14
801043f9:	8d 45 f0             	lea    -0x10(%ebp),%eax
801043fc:	50                   	push   %eax
801043fd:	6a 01                	push   $0x1
801043ff:	e8 0e fb ff ff       	call   80103f12 <argptr>
80104404:	83 c4 10             	add    $0x10,%esp
80104407:	85 c0                	test   %eax,%eax
80104409:	78 13                	js     8010441e <sys_fstat+0x46>
  return filestat(f, st);
8010440b:	83 ec 08             	sub    $0x8,%esp
8010440e:	ff 75 f0             	push   -0x10(%ebp)
80104411:	ff 75 f4             	push   -0xc(%ebp)
80104414:	e8 70 c9 ff ff       	call   80100d89 <filestat>
...
80104423:	eb f7                	jmp    8010441c <sys_fstat+0x44>
...
8010442d:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104430:	50                   	push   %eax
80104431:	6a 00                	push   $0x0
80104433:	e8 42 fb ff ff       	call   80103f7a <argstr>
80104438:	83 c4 10             	add    $0x10,%esp
8010443b:	85 c0                	test   %eax,%eax
8010443d:	0f 88 d3 00 00 00    	js     80104516 <sys_link+0xf1>
80104443:	83 ec 08             	sub    $0x8,%esp
80104446:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104449:	50                   	push   %eax
8010444a:	6a 01                	push   $0x1
8010444c:	e8 29 fb ff ff       	call   80103f7a <argstr>
80104451:	83 c4 10             	add    $0x10,%esp
80104454:	85 c0                	test   %eax,%eax
80104456:	0f 88 ba 00 00 00    	js     80104516 <sys_link+0xf1>
  begin_op();
8010445c:	e8 1d e3 ff ff       	call   8010277e <begin_op>
  if((ip = namei(old)) == 0){
80104461:	83 ec 0c             	sub    $0xc,%esp
80104464:	ff 75 e0             	push   -0x20(%ebp)
80104467:	e8 61 d7 ff ff       	call   80101bcd <namei>
8010446c:	89 c3                	mov    %eax,%ebx
8010446e:	83 c4 10             	add    $0x10,%esp
80104471:	85 c0                	test   %eax,%eax
80104473:	0f 84 a4 00 00 00    	je     8010451d <sys_link+0xf8>
  ilock(ip);
80104479:	83 ec 0c             	sub    $0xc,%esp
8010447c:	50                   	push   %eax
8010447d:	e8 ed d0 ff ff       	call   8010156f <ilock>
  if(ip->type == T_DIR){
80104482:	83 c4 10             	add    $0x10,%esp
80104485:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010448a:	0f 84 99 00 00 00    	je     80104529 <sys_link+0x104>
  ip->nlink++;
80104490:	0f b7 43 56          	movzwl 0x56(%ebx),%eax
80104494:	83 c0 01             	add    $0x1,%eax
80104497:	66 89 43 56          	mov    %ax,0x56(%ebx)
  iupdate(ip);
8010449b:	83 ec 0c             	sub    $0xc,%esp
8010449e:	53                   	push   %ebx
8010449f:	e8 6a cf ff ff       	call   8010140e <iupdate>
  iunlock(ip);
801044a4:	89 1c 24             	mov    %ebx,(%esp)
801044a7:	e8 85 d1 ff ff       	call   80101631 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
801044ac:	83 c4 08             	add    $0x8,%esp
801044af:	8d 45 ea             	lea    -0x16(%ebp),%eax
801044b2:	50                   	push   %eax
801044b3:	ff 75 e4             	push   -0x1c(%ebp)
801044b6:	e8 2a d7 ff ff       	call   80101be5 <nameiparent>
801044bb:	89 c6                	mov    %eax,%esi
801044bd:	83 c4 10             	add    $0x10,%esp
801044c0:	85 c0                	test   %eax,%eax
801044c2:	0f 84 85 00 00 00    	je     8010454d <sys_link+0x128>
  ilock(dp);
801044c8:	83 ec 0c             	sub    $0xc,%esp
801044cb:	50                   	push   %eax
801044cc:	e8 9e d0 ff ff       	call   8010156f <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
801044d1:	83 c4 10             	add    $0x10,%esp
801044d4:	8b 03                	mov    (%ebx),%eax
801044d6:	39 06                	cmp    %eax,(%esi)
801044d8:	75 67                	jne    80104541 <sys_link+0x11c>
801044da:	83 ec 04             	sub    $0x4,%esp
801044dd:	ff 73 04             	push   0x4(%ebx)
801044e0:	8d 45 ea             	lea    -0x16(%ebp),%eax
801044e3:	50                   	push   %eax
801044e4:	56                   	push   %esi
801044e5:	e8 32 d6 ff ff       	call   80101b1c <dirlink>
801044ea:	83 c4 10             	add    $0x10,%esp
801044ed:	85 c0                	test   %eax,%eax
801044ef:	78 50                	js     80104541 <sys_link+0x11c>
  iunlockput(dp);
801044f1:	83 ec 0c             	sub    $0xc,%esp
801044f4:	56                   	push   %esi
801044f5:	e8 1c d2 ff ff       	call   80101716 <iunlockput>
  iput(ip);
801044fa:	89 1c 24             	mov    %ebx,(%esp)
801044fd:	e8 74 d1 ff ff       	call   80101676 <iput>
  end_op();
80104502:	e8 f1 e2 ff ff       	call   801027f8 <end_op>
  return 0;
...
8010451b:	eb f2                	jmp    8010450f <sys_link+0xea>
    end_op();
8010451d:	e8 d6 e2 ff ff       	call   801027f8 <end_op>
    return -1;
80104522:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104527:	eb e6                	jmp    8010450f <sys_link+0xea>
    iunlockput(ip);
80104529:	83 ec 0c             	sub    $0xc,%esp
8010452c:	53                   	push   %ebx
8010452d:	e8 e4 d1 ff ff       	call   80101716 <iunlockput>
    end_op();
80104532:	e8 c1 e2 ff ff       	call   801027f8 <end_op>
    return -1;
80104537:	83 c4 10             	add    $0x10,%esp
8010453a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010453f:	eb ce                	jmp    8010450f <sys_link+0xea>
    iunlockput(dp);
80104541:	83 ec 0c             	sub    $0xc,%esp
80104544:	56                   	push   %esi
80104545:	e8 cc d1 ff ff       	call   80101716 <iunlockput>
    goto bad;
8010454a:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
8010454d:	83 ec 0c             	sub    $0xc,%esp
80104550:	53                   	push   %ebx
80104551:	e8 19 d0 ff ff       	call   8010156f <ilock>
  ip->nlink--;
...
80104586:	83 ec 44             	sub    $0x44,%esp
  if(argstr(0, &path) < 0)
80104589:	8d 45 c4             	lea    -0x3c(%ebp),%eax
8010458c:	50                   	push   %eax
8010458d:	6a 00                	push   $0x0
8010458f:	e8 e6 f9 ff ff       	call   80103f7a <argstr>
80104594:	83 c4 10             	add    $0x10,%esp
80104597:	85 c0                	test   %eax,%eax
80104599:	0f 88 83 01 00 00    	js     80104722 <sys_unlink+0x1a2>
  begin_op();
8010459f:	e8 da e1 ff ff       	call   8010277e <begin_op>
  if((dp = nameiparent(path, name)) == 0){
801045a4:	83 ec 08             	sub    $0x8,%esp
801045a7:	8d 45 ca             	lea    -0x36(%ebp),%eax
801045aa:	50                   	push   %eax
801045ab:	ff 75 c4             	push   -0x3c(%ebp)
801045ae:	e8 32 d6 ff ff       	call   80101be5 <nameiparent>
801045b3:	89 c6                	mov    %eax,%esi
801045b5:	83 c4 10             	add    $0x10,%esp
801045b8:	85 c0                	test   %eax,%eax
801045ba:	0f 84 ed 00 00 00    	je     801046ad <sys_unlink+0x12d>
  ilock(dp);
801045c0:	83 ec 0c             	sub    $0xc,%esp
801045c3:	50                   	push   %eax
801045c4:	e8 a6 cf ff ff       	call   8010156f <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801045c9:	83 c4 08             	add    $0x8,%esp
801045cc:	68 62 6d 10 80       	push   $0x80106d62
801045d1:	8d 45 ca             	lea    -0x36(%ebp),%eax
801045d4:	50                   	push   %eax
801045d5:	e8 b0 d3 ff ff       	call   8010198a <namecmp>
801045da:	83 c4 10             	add    $0x10,%esp
801045dd:	85 c0                	test   %eax,%eax
801045df:	0f 84 fc 00 00 00    	je     801046e1 <sys_unlink+0x161>
801045e5:	83 ec 08             	sub    $0x8,%esp
801045e8:	68 61 6d 10 80       	push   $0x80106d61
801045ed:	8d 45 ca             	lea    -0x36(%ebp),%eax
801045f0:	50                   	push   %eax
801045f1:	e8 94 d3 ff ff       	call   8010198a <namecmp>
801045f6:	83 c4 10             	add    $0x10,%esp
801045f9:	85 c0                	test   %eax,%eax
801045fb:	0f 84 e0 00 00 00    	je     801046e1 <sys_unlink+0x161>
  if((ip = dirlookup(dp, name, &off)) == 0)
80104601:	83 ec 04             	sub    $0x4,%esp
80104604:	8d 45 c0             	lea    -0x40(%ebp),%eax
80104607:	50                   	push   %eax
80104608:	8d 45 ca             	lea    -0x36(%ebp),%eax
8010460b:	50                   	push   %eax
8010460c:	56                   	push   %esi
8010460d:	e8 8d d3 ff ff       	call   8010199f <dirlookup>
80104612:	89 c3                	mov    %eax,%ebx
80104614:	83 c4 10             	add    $0x10,%esp
80104617:	85 c0                	test   %eax,%eax
80104619:	0f 84 c2 00 00 00    	je     801046e1 <sys_unlink+0x161>
  ilock(ip);
8010461f:	83 ec 0c             	sub    $0xc,%esp
80104622:	50                   	push   %eax
80104623:	e8 47 cf ff ff       	call   8010156f <ilock>
  if(ip->nlink < 1)
80104628:	83 c4 10             	add    $0x10,%esp
8010462b:	66 83 7b 56 00       	cmpw   $0x0,0x56(%ebx)
80104630:	0f 8e 83 00 00 00    	jle    801046b9 <sys_unlink+0x139>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104636:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010463b:	0f 84 85 00 00 00    	je     801046c6 <sys_unlink+0x146>
  memset(&de, 0, sizeof(de));
80104641:	83 ec 04             	sub    $0x4,%esp
80104644:	6a 10                	push   $0x10
80104646:	6a 00                	push   $0x0
80104648:	8d 7d d8             	lea    -0x28(%ebp),%edi
8010464b:	57                   	push   %edi
8010464c:	e8 49 f6 ff ff       	call   80103c9a <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104651:	6a 10                	push   $0x10
80104653:	ff 75 c0             	push   -0x40(%ebp)
80104656:	57                   	push   %edi
80104657:	56                   	push   %esi
80104658:	e8 01 d2 ff ff       	call   8010185e <writei>
8010465d:	83 c4 20             	add    $0x20,%esp
80104660:	83 f8 10             	cmp    $0x10,%eax
80104663:	0f 85 90 00 00 00    	jne    801046f9 <sys_unlink+0x179>
  if(ip->type == T_DIR){
80104669:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
8010466e:	0f 84 92 00 00 00    	je     80104706 <sys_unlink+0x186>
  iunlockput(dp);
80104674:	83 ec 0c             	sub    $0xc,%esp
80104677:	56                   	push   %esi
80104678:	e8 99 d0 ff ff       	call   80101716 <iunlockput>
  ip->nlink--;
...
801046ac:	c3                   	ret    
    end_op();
801046ad:	e8 46 e1 ff ff       	call   801027f8 <end_op>
    return -1;
801046b2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046b7:	eb ec                	jmp    801046a5 <sys_unlink+0x125>
    panic("unlink: nlink < 1");
801046b9:	83 ec 0c             	sub    $0xc,%esp
801046bc:	68 80 6d 10 80       	push   $0x80106d80
801046c1:	e8 82 bc ff ff       	call   80100348 <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
801046c6:	89 d8                	mov    %ebx,%eax
801046c8:	e8 cd f9 ff ff       	call   8010409a <isdirempty>
801046cd:	85 c0                	test   %eax,%eax
801046cf:	0f 85 6c ff ff ff    	jne    80104641 <sys_unlink+0xc1>
    iunlockput(ip);
...
801046e5:	e8 2c d0 ff ff       	call   80101716 <iunlockput>
  end_op();
801046ea:	e8 09 e1 ff ff       	call   801027f8 <end_op>
  return -1;
801046ef:	83 c4 10             	add    $0x10,%esp
801046f2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801046f7:	eb ac                	jmp    801046a5 <sys_unlink+0x125>
    panic("unlink: writei");
801046f9:	83 ec 0c             	sub    $0xc,%esp
801046fc:	68 92 6d 10 80       	push   $0x80106d92
80104701:	e8 42 bc ff ff       	call   80100348 <panic>
    dp->nlink--;
80104706:	0f b7 46 56          	movzwl 0x56(%esi),%eax
8010470a:	83 e8 01             	sub    $0x1,%eax
8010470d:	66 89 46 56          	mov    %ax,0x56(%esi)
    iupdate(dp);
80104711:	83 ec 0c             	sub    $0xc,%esp
80104714:	56                   	push   %esi
80104715:	e8 f4 cc ff ff       	call   8010140e <iupdate>
8010471a:	83 c4 10             	add    $0x10,%esp
8010471d:	e9 52 ff ff ff       	jmp    80104674 <sys_unlink+0xf4>
    return -1;
80104722:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104727:	e9 79 ff ff ff       	jmp    801046a5 <sys_unlink+0x125>
...
80104732:	83 ec 24             	sub    $0x24,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80104735:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80104738:	50                   	push   %eax
80104739:	6a 00                	push   $0x0
8010473b:	e8 3a f8 ff ff       	call   80103f7a <argstr>
80104740:	83 c4 10             	add    $0x10,%esp
80104743:	85 c0                	test   %eax,%eax
80104745:	0f 88 a0 00 00 00    	js     801047eb <sys_open+0xbf>
8010474b:	83 ec 08             	sub    $0x8,%esp
8010474e:	8d 45 e0             	lea    -0x20(%ebp),%eax
80104751:	50                   	push   %eax
80104752:	6a 01                	push   $0x1
80104754:	e8 91 f7 ff ff       	call   80103eea <argint>
80104759:	83 c4 10             	add    $0x10,%esp
8010475c:	85 c0                	test   %eax,%eax
8010475e:	0f 88 87 00 00 00    	js     801047eb <sys_open+0xbf>
    return -1;

  begin_op();
80104764:	e8 15 e0 ff ff       	call   8010277e <begin_op>

  if(omode & O_CREATE){
80104769:	f6 45 e1 02          	testb  $0x2,-0x1f(%ebp)
8010476d:	0f 84 8b 00 00 00    	je     801047fe <sys_open+0xd2>
    ip = create(path, T_FILE, 0, 0);
80104773:	83 ec 0c             	sub    $0xc,%esp
80104776:	6a 00                	push   $0x0
80104778:	b9 00 00 00 00       	mov    $0x0,%ecx
8010477d:	ba 02 00 00 00       	mov    $0x2,%edx
80104782:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104785:	e8 67 f9 ff ff       	call   801040f1 <create>
8010478a:	89 c6                	mov    %eax,%esi
    if(ip == 0){
8010478c:	83 c4 10             	add    $0x10,%esp
8010478f:	85 c0                	test   %eax,%eax
80104791:	74 5f                	je     801047f2 <sys_open+0xc6>
      end_op();
      return -1;
    }
  }
...
80104793:	e8 85 c4 ff ff       	call   80100c1d <filealloc>
80104798:	89 c3                	mov    %eax,%ebx
8010479a:	85 c0                	test   %eax,%eax
8010479c:	0f 84 b5 00 00 00    	je     80104857 <sys_open+0x12b>
801047a2:	e8 bd f8 ff ff       	call   80104064 <fdalloc>
801047a7:	89 c7                	mov    %eax,%edi
801047a9:	85 c0                	test   %eax,%eax
801047ab:	0f 88 a6 00 00 00    	js     80104857 <sys_open+0x12b>
      fileclose(f);
    iunlockput(ip);
    end_op();
    return -1;
...
801047b5:	e8 77 ce ff ff       	call   80101631 <iunlock>
  end_op();
801047ba:	e8 39 e0 ff ff       	call   801027f8 <end_op>

  f->type = FD_INODE;
801047bf:	c7 03 02 00 00 00    	movl   $0x2,(%ebx)
  f->ip = ip;
801047c5:	89 73 10             	mov    %esi,0x10(%ebx)
  f->off = 0;
801047c8:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
  f->readable = !(omode & O_WRONLY);
801047cf:	8b 45 e0             	mov    -0x20(%ebp),%eax
801047d2:	83 c4 10             	add    $0x10,%esp
801047d5:	a8 01                	test   $0x1,%al
801047d7:	0f 94 43 08          	sete   0x8(%ebx)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
801047db:	a8 03                	test   $0x3,%al
801047dd:	0f 95 43 09          	setne  0x9(%ebx)
  return fd;
}
...
801047ea:	c3                   	ret    
    return -1;
801047eb:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801047f0:	eb ef                	jmp    801047e1 <sys_open+0xb5>
      end_op();
801047f2:	e8 01 e0 ff ff       	call   801027f8 <end_op>
      return -1;
801047f7:	bf ff ff ff ff       	mov    $0xffffffff,%edi
801047fc:	eb e3                	jmp    801047e1 <sys_open+0xb5>
    if((ip = namei(path)) == 0){
801047fe:	83 ec 0c             	sub    $0xc,%esp
80104801:	ff 75 e4             	push   -0x1c(%ebp)
80104804:	e8 c4 d3 ff ff       	call   80101bcd <namei>
80104809:	89 c6                	mov    %eax,%esi
8010480b:	83 c4 10             	add    $0x10,%esp
8010480e:	85 c0                	test   %eax,%eax
80104810:	74 39                	je     8010484b <sys_open+0x11f>
    ilock(ip);
80104812:	83 ec 0c             	sub    $0xc,%esp
80104815:	50                   	push   %eax
80104816:	e8 54 cd ff ff       	call   8010156f <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
8010481b:	83 c4 10             	add    $0x10,%esp
8010481e:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
80104823:	0f 85 6a ff ff ff    	jne    80104793 <sys_open+0x67>
80104829:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
8010482d:	0f 84 60 ff ff ff    	je     80104793 <sys_open+0x67>
      iunlockput(ip);
80104833:	83 ec 0c             	sub    $0xc,%esp
80104836:	56                   	push   %esi
80104837:	e8 da ce ff ff       	call   80101716 <iunlockput>
      end_op();
8010483c:	e8 b7 df ff ff       	call   801027f8 <end_op>
      return -1;
80104841:	83 c4 10             	add    $0x10,%esp
80104844:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104849:	eb 96                	jmp    801047e1 <sys_open+0xb5>
      end_op();
8010484b:	e8 a8 df ff ff       	call   801027f8 <end_op>
      return -1;
80104850:	bf ff ff ff ff       	mov    $0xffffffff,%edi
80104855:	eb 8a                	jmp    801047e1 <sys_open+0xb5>
    if(f)
80104857:	85 db                	test   %ebx,%ebx
80104859:	74 0c                	je     80104867 <sys_open+0x13b>
      fileclose(f);
8010485b:	83 ec 0c             	sub    $0xc,%esp
8010485e:	53                   	push   %ebx
8010485f:	e8 5f c4 ff ff       	call   80100cc3 <fileclose>
80104864:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
80104867:	83 ec 0c             	sub    $0xc,%esp
8010486a:	56                   	push   %esi
8010486b:	e8 a6 ce ff ff       	call   80101716 <iunlockput>
    end_op();
80104870:	e8 83 df ff ff       	call   801027f8 <end_op>
    return -1;
80104875:	83 c4 10             	add    $0x10,%esp
80104878:	bf ff ff ff ff       	mov    $0xffffffff,%edi
8010487d:	e9 5f ff ff ff       	jmp    801047e1 <sys_open+0xb5>
...
801048b4:	e8 38 f8 ff ff       	call   801040f1 <create>
...
801048f8:	e8 7d f6 ff ff       	call   80103f7a <argstr>
...
8010490d:	e8 d8 f5 ff ff       	call   80103eea <argint>
  if((argstr(0, &path)) < 0 ||
...
80104952:	e8 bf cd ff ff       	call   80101716 <iunlockput>
  end_op();
...
8010499e:	ff 75 f4             	push   -0xc(%ebp)
801049a1:	e8 27 d2 ff ff       	call   80101bcd <namei>
...
801049b3:	e8 b7 cb ff ff       	call   8010156f <ilock>
  if(ip->type != T_DIR){
...
801049c6:	e8 66 cc ff ff       	call   80101631 <iunlock>
  iput(curproc->cwd);
801049cb:	83 c4 04             	add    $0x4,%esp
801049ce:	ff 76 68             	push   0x68(%esi)
801049d1:	e8 a0 cc ff ff       	call   80101676 <iput>
  end_op();
801049d6:	e8 1d de ff ff       	call   801027f8 <end_op>
  curproc->cwd = ip;
...
801049ec:	c3                   	ret    
    end_op();
801049ed:	e8 06 de ff ff       	call   801027f8 <end_op>
    return -1;
...
801049fd:	e8 14 cd ff ff       	call   80101716 <iunlockput>
    end_op();
...
80104a21:	e8 54 f5 ff ff       	call   80103f7a <argstr>
80104a26:	83 c4 10             	add    $0x10,%esp
80104a29:	85 c0                	test   %eax,%eax
80104a2b:	78 38                	js     80104a65 <sys_exec+0x54>
80104a2d:	83 ec 08             	sub    $0x8,%esp
80104a30:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
80104a36:	50                   	push   %eax
80104a37:	6a 01                	push   $0x1
80104a39:	e8 ac f4 ff ff       	call   80103eea <argint>
80104a3e:	83 c4 10             	add    $0x10,%esp
80104a41:	85 c0                	test   %eax,%eax
80104a43:	78 20                	js     80104a65 <sys_exec+0x54>
    return -1;
  }
  memset(argv, 0, sizeof(argv));
80104a45:	83 ec 04             	sub    $0x4,%esp
80104a48:	68 80 00 00 00       	push   $0x80
80104a4d:	6a 00                	push   $0x0
80104a4f:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104a55:	50                   	push   %eax
80104a56:	e8 3f f2 ff ff       	call   80103c9a <memset>
80104a5b:	83 c4 10             	add    $0x10,%esp
  for(i=0;; i++){
80104a5e:	bb 00 00 00 00       	mov    $0x0,%ebx
80104a63:	eb 2c                	jmp    80104a91 <sys_exec+0x80>
    return -1;
80104a65:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104a6a:	eb 78                	jmp    80104ae4 <sys_exec+0xd3>
    if(i >= NELEM(argv))
      return -1;
    ...
    if(uarg == 0){
      argv[i] = 0;
80104a6c:	c7 84 9d 74 ff ff ff 	movl   $0x0,-0x8c(%ebp,%ebx,4)
80104a73:	00 00 00 00 
      break;
    }
...
80104a7a:	8d 85 74 ff ff ff    	lea    -0x8c(%ebp),%eax
80104a80:	50                   	push   %eax
80104a81:	ff 75 f4             	push   -0xc(%ebp)
80104a84:	e8 45 be ff ff       	call   801008ce <exec>
80104a89:	83 c4 10             	add    $0x10,%esp
80104a8c:	eb 56                	jmp    80104ae4 <sys_exec+0xd3>
  for(i=0;; i++){
80104a8e:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
80104a91:	83 fb 1f             	cmp    $0x1f,%ebx
80104a94:	77 49                	ja     80104adf <sys_exec+0xce>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80104a96:	83 ec 08             	sub    $0x8,%esp
80104a99:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
80104a9f:	50                   	push   %eax
80104aa0:	8b 85 70 ff ff ff    	mov    -0x90(%ebp),%eax
80104aa6:	8d 04 98             	lea    (%eax,%ebx,4),%eax
80104aa9:	50                   	push   %eax
80104aaa:	e8 c1 f3 ff ff       	call   80103e70 <fetchint>
80104aaf:	83 c4 10             	add    $0x10,%esp
80104ab2:	85 c0                	test   %eax,%eax
80104ab4:	78 33                	js     80104ae9 <sys_exec+0xd8>
    if(uarg == 0){
80104ab6:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
80104abc:	85 c0                	test   %eax,%eax
80104abe:	74 ac                	je     80104a6c <sys_exec+0x5b>
    if(fetchstr(uarg, &argv[i]) < 0)
80104ac0:	83 ec 08             	sub    $0x8,%esp
80104ac3:	8d 94 9d 74 ff ff ff 	lea    -0x8c(%ebp,%ebx,4),%edx
80104aca:	52                   	push   %edx
80104acb:	50                   	push   %eax
80104acc:	e8 da f3 ff ff       	call   80103eab <fetchstr>
80104ad1:	83 c4 10             	add    $0x10,%esp
80104ad4:	85 c0                	test   %eax,%eax
80104ad6:	79 b6                	jns    80104a8e <sys_exec+0x7d>
      return -1;
80104ad8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104add:	eb 05                	jmp    80104ae4 <sys_exec+0xd3>
      return -1;
80104adf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80104ae4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104ae7:	c9                   	leave  
80104ae8:	c3                   	ret    
      return -1;
80104ae9:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104aee:	eb f4                	jmp    80104ae4 <sys_exec+0xd3>
...
80104af4:	83 ec 18             	sub    $0x18,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80104af7:	6a 08                	push   $0x8
80104af9:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104afc:	50                   	push   %eax
80104afd:	6a 00                	push   $0x0
80104aff:	e8 0e f4 ff ff       	call   80103f12 <argptr>
80104b04:	83 c4 10             	add    $0x10,%esp
80104b07:	85 c0                	test   %eax,%eax
80104b09:	78 79                	js     80104b84 <sys_pipe+0x94>
    return -1;
  if(pipealloc(&rf, &wf) < 0)
80104b0b:	83 ec 08             	sub    $0x8,%esp
80104b0e:	8d 45 ec             	lea    -0x14(%ebp),%eax
80104b11:	50                   	push   %eax
80104b12:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104b15:	50                   	push   %eax
80104b16:	e8 ec e1 ff ff       	call   80102d07 <pipealloc>
80104b1b:	83 c4 10             	add    $0x10,%esp
80104b1e:	85 c0                	test   %eax,%eax
80104b20:	78 69                	js     80104b8b <sys_pipe+0x9b>
    return -1;
  fd0 = -1;
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
80104b22:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104b25:	e8 3a f5 ff ff       	call   80104064 <fdalloc>
80104b2a:	89 c3                	mov    %eax,%ebx
80104b2c:	85 c0                	test   %eax,%eax
80104b2e:	78 21                	js     80104b51 <sys_pipe+0x61>
80104b30:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104b33:	e8 2c f5 ff ff       	call   80104064 <fdalloc>
80104b38:	85 c0                	test   %eax,%eax
80104b3a:	78 15                	js     80104b51 <sys_pipe+0x61>
      myproc()->ofile[fd0] = 0;
    fileclose(rf);
    fileclose(wf);
    return -1;
  ...
  fd[0] = fd0;
80104b3c:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104b3f:	89 1a                	mov    %ebx,(%edx)
  fd[1] = fd1;
80104b41:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104b44:	89 42 04             	mov    %eax,0x4(%edx)
  return 0;
80104b47:	b8 00 00 00 00       	mov    $0x0,%eax
}
80104b4c:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104b4f:	c9                   	leave  
80104b50:	c3                   	ret    
    if(fd0 >= 0)
80104b51:	85 db                	test   %ebx,%ebx
80104b53:	79 20                	jns    80104b75 <sys_pipe+0x85>
    fileclose(rf);
80104b55:	83 ec 0c             	sub    $0xc,%esp
80104b58:	ff 75 f0             	push   -0x10(%ebp)
80104b5b:	e8 63 c1 ff ff       	call   80100cc3 <fileclose>
    fileclose(wf);
80104b60:	83 c4 04             	add    $0x4,%esp
80104b63:	ff 75 ec             	push   -0x14(%ebp)
80104b66:	e8 58 c1 ff ff       	call   80100cc3 <fileclose>
    return -1;
80104b6b:	83 c4 10             	add    $0x10,%esp
80104b6e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b73:	eb d7                	jmp    80104b4c <sys_pipe+0x5c>
      myproc()->ofile[fd0] = 0;
80104b75:	e8 3b e6 ff ff       	call   801031b5 <myproc>
80104b7a:	c7 44 98 28 00 00 00 	movl   $0x0,0x28(%eax,%ebx,4)
80104b81:	00 
80104b82:	eb d1                	jmp    80104b55 <sys_pipe+0x65>
    return -1;
80104b84:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b89:	eb c1                	jmp    80104b4c <sys_pipe+0x5c>
    return -1;
80104b8b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104b90:	eb ba                	jmp    80104b4c <sys_pipe+0x5c>
...
80104b95:	83 ec 08             	sub    $0x8,%esp
  return fork();
80104b98:	e8 2a e8 ff ff       	call   801033c7 <fork>
}
80104b9d:	c9                   	leave  
80104b9e:	c3                   	ret    
...
80104ba2:	83 ec 08             	sub    $0x8,%esp
  exit();
80104ba5:	e8 51 ea ff ff       	call   801035fb <exit>
...
80104bb4:	83 ec 08             	sub    $0x8,%esp
  return wait();
80104bb7:	e8 c8 eb ff ff       	call   80103784 <wait>
}
80104bbc:	c9                   	leave  
80104bbd:	c3                   	ret    
...
80104bc1:	83 ec 20             	sub    $0x20,%esp
  int pid;
...
80104bca:	e8 1b f3 ff ff       	call   80103eea <argint>
80104bcf:	83 c4 10             	add    $0x10,%esp
80104bd2:	85 c0                	test   %eax,%eax
80104bd4:	78 10                	js     80104be6 <sys_kill+0x28>
    return -1;
  return kill(pid);
80104bd6:	83 ec 0c             	sub    $0xc,%esp
80104bd9:	ff 75 f4             	push   -0xc(%ebp)
80104bdc:	e8 a0 ec ff ff       	call   80103881 <kill>
...
80104beb:	eb f7                	jmp    80104be4 <sys_kill+0x26>
...
80104bf0:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80104bf3:	e8 bd e5 ff ff       	call   801031b5 <myproc>
80104bf8:	8b 40 10             	mov    0x10(%eax),%eax
}
80104bfb:	c9                   	leave  
80104bfc:	c3                   	ret    
...
80104c01:	83 ec 1c             	sub    $0x1c,%esp
  int addr;
  int n;
...
80104c0a:	e8 db f2 ff ff       	call   80103eea <argint>
80104c0f:	83 c4 10             	add    $0x10,%esp
80104c12:	85 c0                	test   %eax,%eax
80104c14:	78 20                	js     80104c36 <sys_sbrk+0x39>
    return -1;
  addr = myproc()->sz;
80104c16:	e8 9a e5 ff ff       	call   801031b5 <myproc>
80104c1b:	8b 18                	mov    (%eax),%ebx
  if(growproc(n) < 0)
80104c1d:	83 ec 0c             	sub    $0xc,%esp
80104c20:	ff 75 f4             	push   -0xc(%ebp)
80104c23:	e8 98 e6 ff ff       	call   801032c0 <growproc>
80104c28:	83 c4 10             	add    $0x10,%esp
80104c2b:	85 c0                	test   %eax,%eax
80104c2d:	78 0e                	js     80104c3d <sys_sbrk+0x40>
    return -1;
  return addr;
}
80104c2f:	89 d8                	mov    %ebx,%eax
80104c31:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104c34:	c9                   	leave  
80104c35:	c3                   	ret    
    return -1;
80104c36:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104c3b:	eb f2                	jmp    80104c2f <sys_sbrk+0x32>
    return -1;
80104c3d:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104c42:	eb eb                	jmp    80104c2f <sys_sbrk+0x32>
...
80104c51:	e8 94 f2 ff ff       	call   80103eea <argint>
80104c56:	83 c4 10             	add    $0x10,%esp
80104c59:	85 c0                	test   %eax,%eax
80104c5b:	78 75                	js     80104cd2 <sys_sleep+0x8e>
    return -1;
  acquire(&tickslock);
80104c5d:	83 ec 0c             	sub    $0xc,%esp
80104c60:	68 80 2c 11 80       	push   $0x80112c80
80104c65:	e8 84 ef ff ff       	call   80103bee <acquire>
  ticks0 = ticks;
80104c6a:	8b 1d 60 2c 11 80    	mov    0x80112c60,%ebx
  while(ticks - ticks0 < n){
80104c70:	83 c4 10             	add    $0x10,%esp
80104c73:	a1 60 2c 11 80       	mov    0x80112c60,%eax
80104c78:	29 d8                	sub    %ebx,%eax
80104c7a:	3b 45 f4             	cmp    -0xc(%ebp),%eax
80104c7d:	73 39                	jae    80104cb8 <sys_sleep+0x74>
    if(myproc()->killed){
80104c7f:	e8 31 e5 ff ff       	call   801031b5 <myproc>
80104c84:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104c88:	75 17                	jne    80104ca1 <sys_sleep+0x5d>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
80104c8a:	83 ec 08             	sub    $0x8,%esp
80104c8d:	68 80 2c 11 80       	push   $0x80112c80
80104c92:	68 60 2c 11 80       	push   $0x80112c60
80104c97:	e8 57 ea ff ff       	call   801036f3 <sleep>
80104c9c:	83 c4 10             	add    $0x10,%esp
80104c9f:	eb d2                	jmp    80104c73 <sys_sleep+0x2f>
      release(&tickslock);
80104ca1:	83 ec 0c             	sub    $0xc,%esp
80104ca4:	68 80 2c 11 80       	push   $0x80112c80
80104ca9:	e8 a5 ef ff ff       	call   80103c53 <release>
      return -1;
80104cae:	83 c4 10             	add    $0x10,%esp
80104cb1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104cb6:	eb 15                	jmp    80104ccd <sys_sleep+0x89>
  }
  release(&tickslock);
80104cb8:	83 ec 0c             	sub    $0xc,%esp
80104cbb:	68 80 2c 11 80       	push   $0x80112c80
80104cc0:	e8 8e ef ff ff       	call   80103c53 <release>
  return 0;
80104cc5:	83 c4 10             	add    $0x10,%esp
80104cc8:	b8 00 00 00 00       	mov    $0x0,%eax
}
...
80104cd7:	eb f4                	jmp    80104ccd <sys_sleep+0x89>
...
80104cdd:	83 ec 10             	sub    $0x10,%esp
  uint xticks;

  acquire(&tickslock);
80104ce0:	68 80 2c 11 80       	push   $0x80112c80
80104ce5:	e8 04 ef ff ff       	call   80103bee <acquire>
  xticks = ticks;
80104cea:	8b 1d 60 2c 11 80    	mov    0x80112c60,%ebx
  release(&tickslock);
80104cf0:	c7 04 24 80 2c 11 80 	movl   $0x80112c80,(%esp)
80104cf7:	e8 57 ef ff ff       	call   80103c53 <release>
  return xticks;
}
80104cfc:	89 d8                	mov    %ebx,%eax
...
80104d04:	06                   	push   %es
  pushl %fs
80104d05:	0f a0                	push   %fs
  pushl %gs
80104d07:	0f a8                	push   %gs
  pushal
80104d09:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80104d0a:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80104d0e:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80104d10:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80104d12:	54                   	push   %esp
  call trap
80104d13:	e8 37 01 00 00       	call   80104e4f <trap>
  addl $4, %esp
...
80104d1b:	61                   	popa   
  popl %gs
80104d1c:	0f a9                	pop    %gs
  popl %fs
80104d1e:	0f a1                	pop    %fs
  popl %es
80104d20:	07                   	pop    %es
  popl %ds
80104d21:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80104d22:	83 c4 08             	add    $0x8,%esp
  iret
80104d25:	cf                   	iret   
...
80104d32:	eb 76                	jmp    80104daa <tvinit+0x84>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
80104d34:	8b 0c 85 08 90 10 80 	mov    -0x7fef6ff8(,%eax,4),%ecx
80104d3b:	66 89 0c c5 c0 2c 11 	mov    %cx,-0x7feed340(,%eax,8)
80104d42:	80 
80104d43:	66 c7 04 c5 c2 2c 11 	movw   $0x8,-0x7feed33e(,%eax,8)
80104d4a:	80 08 00 
80104d4d:	0f b6 14 c5 c4 2c 11 	movzbl -0x7feed33c(,%eax,8),%edx
80104d54:	80 
80104d55:	83 e2 e0             	and    $0xffffffe0,%edx
80104d58:	88 14 c5 c4 2c 11 80 	mov    %dl,-0x7feed33c(,%eax,8)
80104d5f:	c6 04 c5 c4 2c 11 80 	movb   $0x0,-0x7feed33c(,%eax,8)
80104d66:	00 
80104d67:	0f b6 14 c5 c5 2c 11 	movzbl -0x7feed33b(,%eax,8),%edx
80104d6e:	80 
80104d6f:	83 e2 f0             	and    $0xfffffff0,%edx
80104d72:	83 ca 0e             	or     $0xe,%edx
80104d75:	88 14 c5 c5 2c 11 80 	mov    %dl,-0x7feed33b(,%eax,8)
80104d7c:	89 d3                	mov    %edx,%ebx
80104d7e:	83 e3 ef             	and    $0xffffffef,%ebx
80104d81:	88 1c c5 c5 2c 11 80 	mov    %bl,-0x7feed33b(,%eax,8)
80104d88:	83 e2 8f             	and    $0xffffff8f,%edx
80104d8b:	88 14 c5 c5 2c 11 80 	mov    %dl,-0x7feed33b(,%eax,8)
80104d92:	83 ca 80             	or     $0xffffff80,%edx
80104d95:	88 14 c5 c5 2c 11 80 	mov    %dl,-0x7feed33b(,%eax,8)
80104d9c:	c1 e9 10             	shr    $0x10,%ecx
80104d9f:	66 89 0c c5 c6 2c 11 	mov    %cx,-0x7feed33a(,%eax,8)
80104da6:	80 
  for(i = 0; i < 256; i++)
80104da7:	83 c0 01             	add    $0x1,%eax
80104daa:	3d ff 00 00 00       	cmp    $0xff,%eax
80104daf:	7e 83                	jle    80104d34 <tvinit+0xe>
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80104db1:	8b 15 08 91 10 80    	mov    0x80109108,%edx
80104db7:	66 89 15 c0 2e 11 80 	mov    %dx,0x80112ec0
80104dbe:	66 c7 05 c2 2e 11 80 	movw   $0x8,0x80112ec2
80104dc5:	08 00 
80104dc7:	0f b6 05 c4 2e 11 80 	movzbl 0x80112ec4,%eax
80104dce:	83 e0 e0             	and    $0xffffffe0,%eax
80104dd1:	a2 c4 2e 11 80       	mov    %al,0x80112ec4
80104dd6:	c6 05 c4 2e 11 80 00 	movb   $0x0,0x80112ec4
80104ddd:	0f b6 05 c5 2e 11 80 	movzbl 0x80112ec5,%eax
80104de4:	83 c8 0f             	or     $0xf,%eax
80104de7:	a2 c5 2e 11 80       	mov    %al,0x80112ec5
80104dec:	83 e0 ef             	and    $0xffffffef,%eax
80104def:	a2 c5 2e 11 80       	mov    %al,0x80112ec5
80104df4:	89 c1                	mov    %eax,%ecx
80104df6:	83 c9 60             	or     $0x60,%ecx
80104df9:	88 0d c5 2e 11 80    	mov    %cl,0x80112ec5
80104dff:	83 c8 e0             	or     $0xffffffe0,%eax
80104e02:	a2 c5 2e 11 80       	mov    %al,0x80112ec5
80104e07:	c1 ea 10             	shr    $0x10,%edx
80104e0a:	66 89 15 c6 2e 11 80 	mov    %dx,0x80112ec6

  initlock(&tickslock, "time");
80104e11:	83 ec 08             	sub    $0x8,%esp
80104e14:	68 a1 6d 10 80       	push   $0x80106da1
80104e19:	68 80 2c 11 80       	push   $0x80112c80
80104e1e:	e8 8f ec ff ff       	call   80103ab2 <initlock>
}
...
80104e2e:	83 ec 10             	sub    $0x10,%esp
  pd[0] = size-1;
80104e31:	66 c7 45 fa ff 07    	movw   $0x7ff,-0x6(%ebp)
  pd[1] = (uint)p;
80104e37:	b8 c0 2c 11 80       	mov    $0x80112cc0,%eax
80104e3c:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80104e40:	c1 e8 10             	shr    $0x10,%eax
80104e43:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80104e47:	8d 45 fa             	lea    -0x6(%ebp),%eax
80104e4a:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80104e4d:	c9                   	leave  
80104e4e:	c3                   	ret    
...
80104e55:	83 ec 1c             	sub    $0x1c,%esp
80104e58:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80104e5b:	8b 43 30             	mov    0x30(%ebx),%eax
80104e5e:	83 f8 40             	cmp    $0x40,%eax
80104e61:	74 13                	je     80104e76 <trap+0x27>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80104e63:	83 e8 20             	sub    $0x20,%eax
80104e66:	83 f8 1f             	cmp    $0x1f,%eax
80104e69:	0f 87 3a 01 00 00    	ja     80104fa9 <trap+0x15a>
80104e6f:	ff 24 85 48 6e 10 80 	jmp    *-0x7fef91b8(,%eax,4)
    if(myproc()->killed)
80104e76:	e8 3a e3 ff ff       	call   801031b5 <myproc>
80104e7b:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104e7f:	75 1f                	jne    80104ea0 <trap+0x51>
    myproc()->tf = tf;
80104e81:	e8 2f e3 ff ff       	call   801031b5 <myproc>
80104e86:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80104e89:	e8 1f f1 ff ff       	call   80103fad <syscall>
    if(myproc()->killed)
80104e8e:	e8 22 e3 ff ff       	call   801031b5 <myproc>
80104e93:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104e97:	74 7e                	je     80104f17 <trap+0xc8>
      exit();
80104e99:	e8 5d e7 ff ff       	call   801035fb <exit>
    return;
80104e9e:	eb 77                	jmp    80104f17 <trap+0xc8>
      exit();
80104ea0:	e8 56 e7 ff ff       	call   801035fb <exit>
80104ea5:	eb da                	jmp    80104e81 <trap+0x32>
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
80104ea7:	e8 ee e2 ff ff       	call   8010319a <cpuid>
80104eac:	85 c0                	test   %eax,%eax
80104eae:	74 6f                	je     80104f1f <trap+0xd0>
      acquire(&tickslock);
      ticks++;
      wakeup(&ticks);
      release(&tickslock);
    ...
    lapiceoi();
80104eb0:	e8 c1 d4 ff ff       	call   80102376 <lapiceoi>
  }
...
80104eb5:	e8 fb e2 ff ff       	call   801031b5 <myproc>
80104eba:	85 c0                	test   %eax,%eax
80104ebc:	74 1c                	je     80104eda <trap+0x8b>
80104ebe:	e8 f2 e2 ff ff       	call   801031b5 <myproc>
80104ec3:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104ec7:	74 11                	je     80104eda <trap+0x8b>
80104ec9:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104ecd:	83 e0 03             	and    $0x3,%eax
80104ed0:	66 83 f8 03          	cmp    $0x3,%ax
80104ed4:	0f 84 62 01 00 00    	je     8010503c <trap+0x1ed>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80104eda:	e8 d6 e2 ff ff       	call   801031b5 <myproc>
80104edf:	85 c0                	test   %eax,%eax
80104ee1:	74 0f                	je     80104ef2 <trap+0xa3>
80104ee3:	e8 cd e2 ff ff       	call   801031b5 <myproc>
80104ee8:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80104eec:	0f 84 54 01 00 00    	je     80105046 <trap+0x1f7>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80104ef2:	e8 be e2 ff ff       	call   801031b5 <myproc>
80104ef7:	85 c0                	test   %eax,%eax
80104ef9:	74 1c                	je     80104f17 <trap+0xc8>
80104efb:	e8 b5 e2 ff ff       	call   801031b5 <myproc>
80104f00:	83 78 24 00          	cmpl   $0x0,0x24(%eax)
80104f04:	74 11                	je     80104f17 <trap+0xc8>
80104f06:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80104f0a:	83 e0 03             	and    $0x3,%eax
80104f0d:	66 83 f8 03          	cmp    $0x3,%ax
80104f11:	0f 84 43 01 00 00    	je     8010505a <trap+0x20b>
    exit();
}
80104f17:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104f1a:	5b                   	pop    %ebx
80104f1b:	5e                   	pop    %esi
80104f1c:	5f                   	pop    %edi
80104f1d:	5d                   	pop    %ebp
...
80104f22:	68 80 2c 11 80       	push   $0x80112c80
80104f27:	e8 c2 ec ff ff       	call   80103bee <acquire>
      ticks++;
80104f2c:	83 05 60 2c 11 80 01 	addl   $0x1,0x80112c60
      wakeup(&ticks);
80104f33:	c7 04 24 60 2c 11 80 	movl   $0x80112c60,(%esp)
80104f3a:	e8 19 e9 ff ff       	call   80103858 <wakeup>
      release(&tickslock);
80104f3f:	c7 04 24 80 2c 11 80 	movl   $0x80112c80,(%esp)
80104f46:	e8 08 ed ff ff       	call   80103c53 <release>
80104f4b:	83 c4 10             	add    $0x10,%esp
80104f4e:	e9 5d ff ff ff       	jmp    80104eb0 <trap+0x61>
    ideintr();
80104f53:	e8 04 ce ff ff       	call   80101d5c <ideintr>
    lapiceoi();
80104f58:	e8 19 d4 ff ff       	call   80102376 <lapiceoi>
    break;
80104f5d:	e9 53 ff ff ff       	jmp    80104eb5 <trap+0x66>
    kbdintr();
80104f62:	e8 59 d2 ff ff       	call   801021c0 <kbdintr>
    lapiceoi();
80104f67:	e8 0a d4 ff ff       	call   80102376 <lapiceoi>
    break;
80104f6c:	e9 44 ff ff ff       	jmp    80104eb5 <trap+0x66>
    uartintr();
80104f71:	e8 fe 01 00 00       	call   80105174 <uartintr>
    lapiceoi();
80104f76:	e8 fb d3 ff ff       	call   80102376 <lapiceoi>
    break;
80104f7b:	e9 35 ff ff ff       	jmp    80104eb5 <trap+0x66>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80104f80:	8b 7b 38             	mov    0x38(%ebx),%edi
            cpuid(), tf->cs, tf->eip);
80104f83:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80104f87:	e8 0e e2 ff ff       	call   8010319a <cpuid>
80104f8c:	57                   	push   %edi
80104f8d:	0f b7 f6             	movzwl %si,%esi
80104f90:	56                   	push   %esi
80104f91:	50                   	push   %eax
80104f92:	68 ac 6d 10 80       	push   $0x80106dac
80104f97:	e8 6b b6 ff ff       	call   80100607 <cprintf>
    lapiceoi();
80104f9c:	e8 d5 d3 ff ff       	call   80102376 <lapiceoi>
    break;
80104fa1:	83 c4 10             	add    $0x10,%esp
80104fa4:	e9 0c ff ff ff       	jmp    80104eb5 <trap+0x66>
    if(myproc() == 0 || (tf->cs&3) == 0){
80104fa9:	e8 07 e2 ff ff       	call   801031b5 <myproc>
80104fae:	85 c0                	test   %eax,%eax
80104fb0:	74 5f                	je     80105011 <trap+0x1c2>
80104fb2:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80104fb6:	74 59                	je     80105011 <trap+0x1c2>
...
80104fb8:	0f 20 d7             	mov    %cr2,%edi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80104fbb:	8b 43 38             	mov    0x38(%ebx),%eax
80104fbe:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80104fc1:	e8 d4 e1 ff ff       	call   8010319a <cpuid>
80104fc6:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104fc9:	8b 53 34             	mov    0x34(%ebx),%edx
80104fcc:	89 55 dc             	mov    %edx,-0x24(%ebp)
80104fcf:	8b 73 30             	mov    0x30(%ebx),%esi
            myproc()->pid, myproc()->name, tf->trapno,
80104fd2:	e8 de e1 ff ff       	call   801031b5 <myproc>
80104fd7:	8d 48 6c             	lea    0x6c(%eax),%ecx
80104fda:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80104fdd:	e8 d3 e1 ff ff       	call   801031b5 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80104fe2:	57                   	push   %edi
80104fe3:	ff 75 e4             	push   -0x1c(%ebp)
80104fe6:	ff 75 e0             	push   -0x20(%ebp)
80104fe9:	ff 75 dc             	push   -0x24(%ebp)
80104fec:	56                   	push   %esi
80104fed:	ff 75 d8             	push   -0x28(%ebp)
80104ff0:	ff 70 10             	push   0x10(%eax)
80104ff3:	68 04 6e 10 80       	push   $0x80106e04
80104ff8:	e8 0a b6 ff ff       	call   80100607 <cprintf>
    myproc()->killed = 1;
80104ffd:	83 c4 20             	add    $0x20,%esp
80105000:	e8 b0 e1 ff ff       	call   801031b5 <myproc>
80105005:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
8010500c:	e9 a4 fe ff ff       	jmp    80104eb5 <trap+0x66>
80105011:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105014:	8b 73 38             	mov    0x38(%ebx),%esi
80105017:	e8 7e e1 ff ff       	call   8010319a <cpuid>
8010501c:	83 ec 0c             	sub    $0xc,%esp
8010501f:	57                   	push   %edi
80105020:	56                   	push   %esi
80105021:	50                   	push   %eax
80105022:	ff 73 30             	push   0x30(%ebx)
80105025:	68 d0 6d 10 80       	push   $0x80106dd0
8010502a:	e8 d8 b5 ff ff       	call   80100607 <cprintf>
      panic("trap");
8010502f:	83 c4 14             	add    $0x14,%esp
80105032:	68 a6 6d 10 80       	push   $0x80106da6
80105037:	e8 0c b3 ff ff       	call   80100348 <panic>
    exit();
8010503c:	e8 ba e5 ff ff       	call   801035fb <exit>
80105041:	e9 94 fe ff ff       	jmp    80104eda <trap+0x8b>
  if(myproc() && myproc()->state == RUNNING &&
80105046:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
8010504a:	0f 85 a2 fe ff ff    	jne    80104ef2 <trap+0xa3>
    yield();
80105050:	e8 6c e6 ff ff       	call   801036c1 <yield>
80105055:	e9 98 fe ff ff       	jmp    80104ef2 <trap+0xa3>
    exit();
8010505a:	e8 9c e5 ff ff       	call   801035fb <exit>
8010505f:	e9 b3 fe ff ff       	jmp    80104f17 <trap+0xc8>
...
{
  if(!uart)
80105064:	83 3d c0 34 11 80 00 	cmpl   $0x0,0x801134c0
8010506b:	74 14                	je     80105081 <uartgetc+0x1d>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010506d:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105072:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
80105073:	a8 01                	test   $0x1,%al
80105075:	74 10                	je     80105087 <uartgetc+0x23>
80105077:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010507c:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
8010507d:	0f b6 c0             	movzbl %al,%eax
80105080:	c3                   	ret    
    return -1;
...
8010508d <uartputc>:
  if(!uart)
8010508d:	83 3d c0 34 11 80 00 	cmpl   $0x0,0x801134c0
80105094:	74 3b                	je     801050d1 <uartputc+0x44>
{
...
8010509d:	bb 00 00 00 00       	mov    $0x0,%ebx
801050a2:	eb 10                	jmp    801050b4 <uartputc+0x27>
    microdelay(10);
801050a4:	83 ec 0c             	sub    $0xc,%esp
801050a7:	6a 0a                	push   $0xa
801050a9:	e8 e9 d2 ff ff       	call   80102397 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
801050ae:	83 c3 01             	add    $0x1,%ebx
801050b1:	83 c4 10             	add    $0x10,%esp
801050b4:	83 fb 7f             	cmp    $0x7f,%ebx
801050b7:	7f 0a                	jg     801050c3 <uartputc+0x36>
801050b9:	ba fd 03 00 00       	mov    $0x3fd,%edx
801050be:	ec                   	in     (%dx),%al
801050bf:	a8 20                	test   $0x20,%al
801050c1:	74 e1                	je     801050a4 <uartputc+0x17>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801050c3:	8b 45 08             	mov    0x8(%ebp),%eax
801050c6:	ba f8 03 00 00       	mov    $0x3f8,%edx
801050cb:	ee                   	out    %al,(%dx)
}
801050cc:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801050cf:	c9                   	leave  
801050d0:	c3                   	ret    
801050d1:	c3                   	ret    
...
801050d7:	b9 00 00 00 00       	mov    $0x0,%ecx
801050dc:	ba fa 03 00 00       	mov    $0x3fa,%edx
801050e1:	89 c8                	mov    %ecx,%eax
801050e3:	ee                   	out    %al,(%dx)
801050e4:	be fb 03 00 00       	mov    $0x3fb,%esi
801050e9:	b8 80 ff ff ff       	mov    $0xffffff80,%eax
801050ee:	89 f2                	mov    %esi,%edx
801050f0:	ee                   	out    %al,(%dx)
801050f1:	b8 0c 00 00 00       	mov    $0xc,%eax
801050f6:	ba f8 03 00 00       	mov    $0x3f8,%edx
801050fb:	ee                   	out    %al,(%dx)
801050fc:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80105101:	89 c8                	mov    %ecx,%eax
80105103:	89 da                	mov    %ebx,%edx
80105105:	ee                   	out    %al,(%dx)
80105106:	b8 03 00 00 00       	mov    $0x3,%eax
8010510b:	89 f2                	mov    %esi,%edx
8010510d:	ee                   	out    %al,(%dx)
8010510e:	ba fc 03 00 00       	mov    $0x3fc,%edx
80105113:	89 c8                	mov    %ecx,%eax
80105115:	ee                   	out    %al,(%dx)
80105116:	b8 01 00 00 00       	mov    $0x1,%eax
8010511b:	89 da                	mov    %ebx,%edx
8010511d:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
8010511e:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105123:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105124:	3c ff                	cmp    $0xff,%al
80105126:	74 45                	je     8010516d <uartinit+0x9b>
  uart = 1;
80105128:	c7 05 c0 34 11 80 01 	movl   $0x1,0x801134c0
8010512f:	00 00 00 
80105132:	ba fa 03 00 00       	mov    $0x3fa,%edx
80105137:	ec                   	in     (%dx),%al
80105138:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010513d:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
8010513e:	83 ec 08             	sub    $0x8,%esp
80105141:	6a 00                	push   $0x0
80105143:	6a 04                	push   $0x4
80105145:	e8 17 ce ff ff       	call   80101f61 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
8010514a:	83 c4 10             	add    $0x10,%esp
8010514d:	bb c8 6e 10 80       	mov    $0x80106ec8,%ebx
80105152:	eb 12                	jmp    80105166 <uartinit+0x94>
    uartputc(*p);
80105154:	83 ec 0c             	sub    $0xc,%esp
80105157:	0f be c0             	movsbl %al,%eax
8010515a:	50                   	push   %eax
8010515b:	e8 2d ff ff ff       	call   8010508d <uartputc>
  for(p="xv6...\n"; *p; p++)
80105160:	83 c3 01             	add    $0x1,%ebx
80105163:	83 c4 10             	add    $0x10,%esp
80105166:	0f b6 03             	movzbl (%ebx),%eax
80105169:	84 c0                	test   %al,%al
8010516b:	75 e7                	jne    80105154 <uartinit+0x82>
}
...
80105177:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
8010517a:	68 64 50 10 80       	push   $0x80105064
8010517f:	e8 af b5 ff ff       	call   80100733 <consoleintr>
}
...
8010518b:	6a 00                	push   $0x0
  jmp alltraps
8010518d:	e9 71 fb ff ff       	jmp    80104d03 <alltraps>
...
80105194:	6a 01                	push   $0x1
  jmp alltraps
80105196:	e9 68 fb ff ff       	jmp    80104d03 <alltraps>
...
8010519b:	6a 00                	push   $0x0
  pushl $2
8010519d:	6a 02                	push   $0x2
  jmp alltraps
8010519f:	e9 5f fb ff ff       	jmp    80104d03 <alltraps>
...
801051a4:	6a 00                	push   $0x0
  pushl $3
801051a6:	6a 03                	push   $0x3
  jmp alltraps
801051a8:	e9 56 fb ff ff       	jmp    80104d03 <alltraps>
...
801051ad:	6a 00                	push   $0x0
  pushl $4
801051af:	6a 04                	push   $0x4
  jmp alltraps
801051b1:	e9 4d fb ff ff       	jmp    80104d03 <alltraps>
...
801051b6:	6a 00                	push   $0x0
  pushl $5
801051b8:	6a 05                	push   $0x5
  jmp alltraps
801051ba:	e9 44 fb ff ff       	jmp    80104d03 <alltraps>
...
801051bf:	6a 00                	push   $0x0
  pushl $6
801051c1:	6a 06                	push   $0x6
  jmp alltraps
801051c3:	e9 3b fb ff ff       	jmp    80104d03 <alltraps>
...
801051c8:	6a 00                	push   $0x0
  pushl $7
801051ca:	6a 07                	push   $0x7
  jmp alltraps
801051cc:	e9 32 fb ff ff       	jmp    80104d03 <alltraps>

801051d1 <vector8>:
.globl vector8
vector8:
  pushl $8
801051d1:	6a 08                	push   $0x8
  jmp alltraps
801051d3:	e9 2b fb ff ff       	jmp    80104d03 <alltraps>
...
801051d8:	6a 00                	push   $0x0
  pushl $9
801051da:	6a 09                	push   $0x9
  jmp alltraps
801051dc:	e9 22 fb ff ff       	jmp    80104d03 <alltraps>

801051e1 <vector10>:
.globl vector10
vector10:
  pushl $10
801051e1:	6a 0a                	push   $0xa
  jmp alltraps
801051e3:	e9 1b fb ff ff       	jmp    80104d03 <alltraps>

801051e8 <vector11>:
.globl vector11
vector11:
  pushl $11
801051e8:	6a 0b                	push   $0xb
  jmp alltraps
801051ea:	e9 14 fb ff ff       	jmp    80104d03 <alltraps>

801051ef <vector12>:
.globl vector12
vector12:
  pushl $12
801051ef:	6a 0c                	push   $0xc
  jmp alltraps
801051f1:	e9 0d fb ff ff       	jmp    80104d03 <alltraps>

801051f6 <vector13>:
.globl vector13
vector13:
  pushl $13
801051f6:	6a 0d                	push   $0xd
  jmp alltraps
801051f8:	e9 06 fb ff ff       	jmp    80104d03 <alltraps>

801051fd <vector14>:
.globl vector14
vector14:
  pushl $14
801051fd:	6a 0e                	push   $0xe
  jmp alltraps
801051ff:	e9 ff fa ff ff       	jmp    80104d03 <alltraps>
...
80105204:	6a 00                	push   $0x0
  pushl $15
80105206:	6a 0f                	push   $0xf
  jmp alltraps
80105208:	e9 f6 fa ff ff       	jmp    80104d03 <alltraps>
...
8010520f:	6a 10                	push   $0x10
  jmp alltraps
80105211:	e9 ed fa ff ff       	jmp    80104d03 <alltraps>

80105216 <vector17>:
.globl vector17
vector17:
  pushl $17
80105216:	6a 11                	push   $0x11
  jmp alltraps
80105218:	e9 e6 fa ff ff       	jmp    80104d03 <alltraps>
...
8010521d:	6a 00                	push   $0x0
  pushl $18
8010521f:	6a 12                	push   $0x12
  jmp alltraps
80105221:	e9 dd fa ff ff       	jmp    80104d03 <alltraps>
...
80105226:	6a 00                	push   $0x0
  pushl $19
80105228:	6a 13                	push   $0x13
  jmp alltraps
8010522a:	e9 d4 fa ff ff       	jmp    80104d03 <alltraps>
...
8010522f:	6a 00                	push   $0x0
  pushl $20
80105231:	6a 14                	push   $0x14
  jmp alltraps
80105233:	e9 cb fa ff ff       	jmp    80104d03 <alltraps>
...
80105238:	6a 00                	push   $0x0
  pushl $21
8010523a:	6a 15                	push   $0x15
  jmp alltraps
8010523c:	e9 c2 fa ff ff       	jmp    80104d03 <alltraps>
...
80105241:	6a 00                	push   $0x0
  pushl $22
80105243:	6a 16                	push   $0x16
  jmp alltraps
80105245:	e9 b9 fa ff ff       	jmp    80104d03 <alltraps>
...
8010524a:	6a 00                	push   $0x0
  pushl $23
8010524c:	6a 17                	push   $0x17
  jmp alltraps
8010524e:	e9 b0 fa ff ff       	jmp    80104d03 <alltraps>
...
80105253:	6a 00                	push   $0x0
  pushl $24
80105255:	6a 18                	push   $0x18
  jmp alltraps
80105257:	e9 a7 fa ff ff       	jmp    80104d03 <alltraps>
...
8010525c:	6a 00                	push   $0x0
  pushl $25
8010525e:	6a 19                	push   $0x19
  jmp alltraps
80105260:	e9 9e fa ff ff       	jmp    80104d03 <alltraps>
...
80105265:	6a 00                	push   $0x0
  pushl $26
80105267:	6a 1a                	push   $0x1a
  jmp alltraps
80105269:	e9 95 fa ff ff       	jmp    80104d03 <alltraps>
...
8010526e:	6a 00                	push   $0x0
  pushl $27
80105270:	6a 1b                	push   $0x1b
  jmp alltraps
80105272:	e9 8c fa ff ff       	jmp    80104d03 <alltraps>
...
80105277:	6a 00                	push   $0x0
  pushl $28
80105279:	6a 1c                	push   $0x1c
  jmp alltraps
8010527b:	e9 83 fa ff ff       	jmp    80104d03 <alltraps>
...
80105280:	6a 00                	push   $0x0
  pushl $29
80105282:	6a 1d                	push   $0x1d
  jmp alltraps
80105284:	e9 7a fa ff ff       	jmp    80104d03 <alltraps>
...
80105289:	6a 00                	push   $0x0
  pushl $30
8010528b:	6a 1e                	push   $0x1e
  jmp alltraps
8010528d:	e9 71 fa ff ff       	jmp    80104d03 <alltraps>
...
80105292:	6a 00                	push   $0x0
  pushl $31
80105294:	6a 1f                	push   $0x1f
  jmp alltraps
80105296:	e9 68 fa ff ff       	jmp    80104d03 <alltraps>
...
8010529b:	6a 00                	push   $0x0
  pushl $32
8010529d:	6a 20                	push   $0x20
  jmp alltraps
8010529f:	e9 5f fa ff ff       	jmp    80104d03 <alltraps>
...
801052a4:	6a 00                	push   $0x0
  pushl $33
801052a6:	6a 21                	push   $0x21
  jmp alltraps
801052a8:	e9 56 fa ff ff       	jmp    80104d03 <alltraps>
...
801052ad:	6a 00                	push   $0x0
  pushl $34
801052af:	6a 22                	push   $0x22
  jmp alltraps
801052b1:	e9 4d fa ff ff       	jmp    80104d03 <alltraps>
...
801052b6:	6a 00                	push   $0x0
  pushl $35
801052b8:	6a 23                	push   $0x23
  jmp alltraps
801052ba:	e9 44 fa ff ff       	jmp    80104d03 <alltraps>
...
801052bf:	6a 00                	push   $0x0
  pushl $36
801052c1:	6a 24                	push   $0x24
  jmp alltraps
801052c3:	e9 3b fa ff ff       	jmp    80104d03 <alltraps>
...
801052c8:	6a 00                	push   $0x0
  pushl $37
801052ca:	6a 25                	push   $0x25
  jmp alltraps
801052cc:	e9 32 fa ff ff       	jmp    80104d03 <alltraps>
...
801052d1:	6a 00                	push   $0x0
  pushl $38
801052d3:	6a 26                	push   $0x26
  jmp alltraps
801052d5:	e9 29 fa ff ff       	jmp    80104d03 <alltraps>
...
801052da:	6a 00                	push   $0x0
  pushl $39
801052dc:	6a 27                	push   $0x27
  jmp alltraps
801052de:	e9 20 fa ff ff       	jmp    80104d03 <alltraps>
...
801052e3:	6a 00                	push   $0x0
  pushl $40
801052e5:	6a 28                	push   $0x28
  jmp alltraps
801052e7:	e9 17 fa ff ff       	jmp    80104d03 <alltraps>
...
801052ec:	6a 00                	push   $0x0
  pushl $41
801052ee:	6a 29                	push   $0x29
  jmp alltraps
801052f0:	e9 0e fa ff ff       	jmp    80104d03 <alltraps>
...
801052f5:	6a 00                	push   $0x0
  pushl $42
801052f7:	6a 2a                	push   $0x2a
  jmp alltraps
801052f9:	e9 05 fa ff ff       	jmp    80104d03 <alltraps>
...
801052fe:	6a 00                	push   $0x0
  pushl $43
80105300:	6a 2b                	push   $0x2b
  jmp alltraps
80105302:	e9 fc f9 ff ff       	jmp    80104d03 <alltraps>
...
80105307:	6a 00                	push   $0x0
  pushl $44
80105309:	6a 2c                	push   $0x2c
  jmp alltraps
8010530b:	e9 f3 f9 ff ff       	jmp    80104d03 <alltraps>
...
80105310:	6a 00                	push   $0x0
  pushl $45
80105312:	6a 2d                	push   $0x2d
  jmp alltraps
80105314:	e9 ea f9 ff ff       	jmp    80104d03 <alltraps>
...
80105319:	6a 00                	push   $0x0
  pushl $46
8010531b:	6a 2e                	push   $0x2e
  jmp alltraps
8010531d:	e9 e1 f9 ff ff       	jmp    80104d03 <alltraps>
...
80105322:	6a 00                	push   $0x0
  pushl $47
80105324:	6a 2f                	push   $0x2f
  jmp alltraps
80105326:	e9 d8 f9 ff ff       	jmp    80104d03 <alltraps>
...
8010532b:	6a 00                	push   $0x0
  pushl $48
8010532d:	6a 30                	push   $0x30
  jmp alltraps
8010532f:	e9 cf f9 ff ff       	jmp    80104d03 <alltraps>
...
80105334:	6a 00                	push   $0x0
  pushl $49
80105336:	6a 31                	push   $0x31
  jmp alltraps
80105338:	e9 c6 f9 ff ff       	jmp    80104d03 <alltraps>
...
8010533d:	6a 00                	push   $0x0
  pushl $50
8010533f:	6a 32                	push   $0x32
  jmp alltraps
80105341:	e9 bd f9 ff ff       	jmp    80104d03 <alltraps>
...
80105346:	6a 00                	push   $0x0
  pushl $51
80105348:	6a 33                	push   $0x33
  jmp alltraps
8010534a:	e9 b4 f9 ff ff       	jmp    80104d03 <alltraps>
...
8010534f:	6a 00                	push   $0x0
  pushl $52
80105351:	6a 34                	push   $0x34
  jmp alltraps
80105353:	e9 ab f9 ff ff       	jmp    80104d03 <alltraps>
...
80105358:	6a 00                	push   $0x0
  pushl $53
8010535a:	6a 35                	push   $0x35
  jmp alltraps
8010535c:	e9 a2 f9 ff ff       	jmp    80104d03 <alltraps>
...
80105361:	6a 00                	push   $0x0
  pushl $54
80105363:	6a 36                	push   $0x36
  jmp alltraps
80105365:	e9 99 f9 ff ff       	jmp    80104d03 <alltraps>
...
8010536a:	6a 00                	push   $0x0
  pushl $55
8010536c:	6a 37                	push   $0x37
  jmp alltraps
8010536e:	e9 90 f9 ff ff       	jmp    80104d03 <alltraps>
...
80105373:	6a 00                	push   $0x0
  pushl $56
80105375:	6a 38                	push   $0x38
  jmp alltraps
80105377:	e9 87 f9 ff ff       	jmp    80104d03 <alltraps>
...
8010537c:	6a 00                	push   $0x0
  pushl $57
8010537e:	6a 39                	push   $0x39
  jmp alltraps
80105380:	e9 7e f9 ff ff       	jmp    80104d03 <alltraps>
...
80105385:	6a 00                	push   $0x0
  pushl $58
80105387:	6a 3a                	push   $0x3a
  jmp alltraps
80105389:	e9 75 f9 ff ff       	jmp    80104d03 <alltraps>
...
8010538e:	6a 00                	push   $0x0
  pushl $59
80105390:	6a 3b                	push   $0x3b
  jmp alltraps
80105392:	e9 6c f9 ff ff       	jmp    80104d03 <alltraps>
...
80105397:	6a 00                	push   $0x0
  pushl $60
80105399:	6a 3c                	push   $0x3c
  jmp alltraps
8010539b:	e9 63 f9 ff ff       	jmp    80104d03 <alltraps>
...
801053a0:	6a 00                	push   $0x0
  pushl $61
801053a2:	6a 3d                	push   $0x3d
  jmp alltraps
801053a4:	e9 5a f9 ff ff       	jmp    80104d03 <alltraps>
...
801053a9:	6a 00                	push   $0x0
  pushl $62
801053ab:	6a 3e                	push   $0x3e
  jmp alltraps
801053ad:	e9 51 f9 ff ff       	jmp    80104d03 <alltraps>
...
801053b2:	6a 00                	push   $0x0
  pushl $63
801053b4:	6a 3f                	push   $0x3f
  jmp alltraps
801053b6:	e9 48 f9 ff ff       	jmp    80104d03 <alltraps>
...
801053bb:	6a 00                	push   $0x0
  pushl $64
801053bd:	6a 40                	push   $0x40
  jmp alltraps
801053bf:	e9 3f f9 ff ff       	jmp    80104d03 <alltraps>
...
801053c4:	6a 00                	push   $0x0
  pushl $65
801053c6:	6a 41                	push   $0x41
  jmp alltraps
801053c8:	e9 36 f9 ff ff       	jmp    80104d03 <alltraps>
...
801053cd:	6a 00                	push   $0x0
  pushl $66
801053cf:	6a 42                	push   $0x42
  jmp alltraps
801053d1:	e9 2d f9 ff ff       	jmp    80104d03 <alltraps>
...
801053d6:	6a 00                	push   $0x0
  pushl $67
801053d8:	6a 43                	push   $0x43
  jmp alltraps
801053da:	e9 24 f9 ff ff       	jmp    80104d03 <alltraps>
...
801053df:	6a 00                	push   $0x0
  pushl $68
801053e1:	6a 44                	push   $0x44
  jmp alltraps
801053e3:	e9 1b f9 ff ff       	jmp    80104d03 <alltraps>
...
801053e8:	6a 00                	push   $0x0
  pushl $69
801053ea:	6a 45                	push   $0x45
  jmp alltraps
801053ec:	e9 12 f9 ff ff       	jmp    80104d03 <alltraps>
...
801053f1:	6a 00                	push   $0x0
  pushl $70
801053f3:	6a 46                	push   $0x46
  jmp alltraps
801053f5:	e9 09 f9 ff ff       	jmp    80104d03 <alltraps>
...
801053fa:	6a 00                	push   $0x0
  pushl $71
801053fc:	6a 47                	push   $0x47
  jmp alltraps
801053fe:	e9 00 f9 ff ff       	jmp    80104d03 <alltraps>
...
80105403:	6a 00                	push   $0x0
  pushl $72
80105405:	6a 48                	push   $0x48
  jmp alltraps
80105407:	e9 f7 f8 ff ff       	jmp    80104d03 <alltraps>
...
8010540c:	6a 00                	push   $0x0
  pushl $73
8010540e:	6a 49                	push   $0x49
  jmp alltraps
80105410:	e9 ee f8 ff ff       	jmp    80104d03 <alltraps>
...
80105415:	6a 00                	push   $0x0
  pushl $74
80105417:	6a 4a                	push   $0x4a
  jmp alltraps
80105419:	e9 e5 f8 ff ff       	jmp    80104d03 <alltraps>
...
8010541e:	6a 00                	push   $0x0
  pushl $75
80105420:	6a 4b                	push   $0x4b
  jmp alltraps
80105422:	e9 dc f8 ff ff       	jmp    80104d03 <alltraps>
...
80105427:	6a 00                	push   $0x0
  pushl $76
80105429:	6a 4c                	push   $0x4c
  jmp alltraps
8010542b:	e9 d3 f8 ff ff       	jmp    80104d03 <alltraps>
...
80105430:	6a 00                	push   $0x0
  pushl $77
80105432:	6a 4d                	push   $0x4d
  jmp alltraps
80105434:	e9 ca f8 ff ff       	jmp    80104d03 <alltraps>
...
80105439:	6a 00                	push   $0x0
  pushl $78
8010543b:	6a 4e                	push   $0x4e
  jmp alltraps
8010543d:	e9 c1 f8 ff ff       	jmp    80104d03 <alltraps>
...
80105442:	6a 00                	push   $0x0
  pushl $79
80105444:	6a 4f                	push   $0x4f
  jmp alltraps
80105446:	e9 b8 f8 ff ff       	jmp    80104d03 <alltraps>
...
8010544b:	6a 00                	push   $0x0
  pushl $80
8010544d:	6a 50                	push   $0x50
  jmp alltraps
8010544f:	e9 af f8 ff ff       	jmp    80104d03 <alltraps>
...
80105454:	6a 00                	push   $0x0
  pushl $81
80105456:	6a 51                	push   $0x51
  jmp alltraps
80105458:	e9 a6 f8 ff ff       	jmp    80104d03 <alltraps>
...
8010545d:	6a 00                	push   $0x0
  pushl $82
8010545f:	6a 52                	push   $0x52
  jmp alltraps
80105461:	e9 9d f8 ff ff       	jmp    80104d03 <alltraps>
...
80105466:	6a 00                	push   $0x0
  pushl $83
80105468:	6a 53                	push   $0x53
  jmp alltraps
8010546a:	e9 94 f8 ff ff       	jmp    80104d03 <alltraps>
...
8010546f:	6a 00                	push   $0x0
  pushl $84
80105471:	6a 54                	push   $0x54
  jmp alltraps
80105473:	e9 8b f8 ff ff       	jmp    80104d03 <alltraps>
...
80105478:	6a 00                	push   $0x0
  pushl $85
8010547a:	6a 55                	push   $0x55
  jmp alltraps
8010547c:	e9 82 f8 ff ff       	jmp    80104d03 <alltraps>
...
80105481:	6a 00                	push   $0x0
  pushl $86
80105483:	6a 56                	push   $0x56
  jmp alltraps
80105485:	e9 79 f8 ff ff       	jmp    80104d03 <alltraps>
...
8010548a:	6a 00                	push   $0x0
  pushl $87
8010548c:	6a 57                	push   $0x57
  jmp alltraps
8010548e:	e9 70 f8 ff ff       	jmp    80104d03 <alltraps>
...
80105493:	6a 00                	push   $0x0
  pushl $88
80105495:	6a 58                	push   $0x58
  jmp alltraps
80105497:	e9 67 f8 ff ff       	jmp    80104d03 <alltraps>
...
8010549c:	6a 00                	push   $0x0
  pushl $89
8010549e:	6a 59                	push   $0x59
  jmp alltraps
801054a0:	e9 5e f8 ff ff       	jmp    80104d03 <alltraps>
...
801054a5:	6a 00                	push   $0x0
  pushl $90
801054a7:	6a 5a                	push   $0x5a
  jmp alltraps
801054a9:	e9 55 f8 ff ff       	jmp    80104d03 <alltraps>
...
801054ae:	6a 00                	push   $0x0
  pushl $91
801054b0:	6a 5b                	push   $0x5b
  jmp alltraps
801054b2:	e9 4c f8 ff ff       	jmp    80104d03 <alltraps>
...
801054b7:	6a 00                	push   $0x0
  pushl $92
801054b9:	6a 5c                	push   $0x5c
  jmp alltraps
801054bb:	e9 43 f8 ff ff       	jmp    80104d03 <alltraps>
...
801054c0:	6a 00                	push   $0x0
  pushl $93
801054c2:	6a 5d                	push   $0x5d
  jmp alltraps
801054c4:	e9 3a f8 ff ff       	jmp    80104d03 <alltraps>
...
801054c9:	6a 00                	push   $0x0
  pushl $94
801054cb:	6a 5e                	push   $0x5e
  jmp alltraps
801054cd:	e9 31 f8 ff ff       	jmp    80104d03 <alltraps>
...
801054d2:	6a 00                	push   $0x0
  pushl $95
801054d4:	6a 5f                	push   $0x5f
  jmp alltraps
801054d6:	e9 28 f8 ff ff       	jmp    80104d03 <alltraps>
...
801054db:	6a 00                	push   $0x0
  pushl $96
801054dd:	6a 60                	push   $0x60
  jmp alltraps
801054df:	e9 1f f8 ff ff       	jmp    80104d03 <alltraps>
...
801054e4:	6a 00                	push   $0x0
  pushl $97
801054e6:	6a 61                	push   $0x61
  jmp alltraps
801054e8:	e9 16 f8 ff ff       	jmp    80104d03 <alltraps>
...
801054ed:	6a 00                	push   $0x0
  pushl $98
801054ef:	6a 62                	push   $0x62
  jmp alltraps
801054f1:	e9 0d f8 ff ff       	jmp    80104d03 <alltraps>
...
801054f6:	6a 00                	push   $0x0
  pushl $99
801054f8:	6a 63                	push   $0x63
  jmp alltraps
801054fa:	e9 04 f8 ff ff       	jmp    80104d03 <alltraps>
...
801054ff:	6a 00                	push   $0x0
  pushl $100
80105501:	6a 64                	push   $0x64
  jmp alltraps
80105503:	e9 fb f7 ff ff       	jmp    80104d03 <alltraps>
...
80105508:	6a 00                	push   $0x0
  pushl $101
8010550a:	6a 65                	push   $0x65
  jmp alltraps
8010550c:	e9 f2 f7 ff ff       	jmp    80104d03 <alltraps>
...
80105511:	6a 00                	push   $0x0
  pushl $102
80105513:	6a 66                	push   $0x66
  jmp alltraps
80105515:	e9 e9 f7 ff ff       	jmp    80104d03 <alltraps>
...
8010551a:	6a 00                	push   $0x0
  pushl $103
8010551c:	6a 67                	push   $0x67
  jmp alltraps
8010551e:	e9 e0 f7 ff ff       	jmp    80104d03 <alltraps>
...
80105523:	6a 00                	push   $0x0
  pushl $104
80105525:	6a 68                	push   $0x68
  jmp alltraps
80105527:	e9 d7 f7 ff ff       	jmp    80104d03 <alltraps>
...
8010552c:	6a 00                	push   $0x0
  pushl $105
8010552e:	6a 69                	push   $0x69
  jmp alltraps
80105530:	e9 ce f7 ff ff       	jmp    80104d03 <alltraps>
...
80105535:	6a 00                	push   $0x0
  pushl $106
80105537:	6a 6a                	push   $0x6a
  jmp alltraps
80105539:	e9 c5 f7 ff ff       	jmp    80104d03 <alltraps>
...
8010553e:	6a 00                	push   $0x0
  pushl $107
80105540:	6a 6b                	push   $0x6b
  jmp alltraps
80105542:	e9 bc f7 ff ff       	jmp    80104d03 <alltraps>
...
80105547:	6a 00                	push   $0x0
  pushl $108
80105549:	6a 6c                	push   $0x6c
  jmp alltraps
8010554b:	e9 b3 f7 ff ff       	jmp    80104d03 <alltraps>
...
80105550:	6a 00                	push   $0x0
  pushl $109
80105552:	6a 6d                	push   $0x6d
  jmp alltraps
80105554:	e9 aa f7 ff ff       	jmp    80104d03 <alltraps>
...
80105559:	6a 00                	push   $0x0
  pushl $110
8010555b:	6a 6e                	push   $0x6e
  jmp alltraps
8010555d:	e9 a1 f7 ff ff       	jmp    80104d03 <alltraps>
...
80105562:	6a 00                	push   $0x0
  pushl $111
80105564:	6a 6f                	push   $0x6f
  jmp alltraps
80105566:	e9 98 f7 ff ff       	jmp    80104d03 <alltraps>
...
8010556b:	6a 00                	push   $0x0
  pushl $112
8010556d:	6a 70                	push   $0x70
  jmp alltraps
8010556f:	e9 8f f7 ff ff       	jmp    80104d03 <alltraps>
...
80105574:	6a 00                	push   $0x0
  pushl $113
80105576:	6a 71                	push   $0x71
  jmp alltraps
80105578:	e9 86 f7 ff ff       	jmp    80104d03 <alltraps>
...
8010557d:	6a 00                	push   $0x0
  pushl $114
8010557f:	6a 72                	push   $0x72
  jmp alltraps
80105581:	e9 7d f7 ff ff       	jmp    80104d03 <alltraps>
...
80105586:	6a 00                	push   $0x0
  pushl $115
80105588:	6a 73                	push   $0x73
  jmp alltraps
8010558a:	e9 74 f7 ff ff       	jmp    80104d03 <alltraps>
...
8010558f:	6a 00                	push   $0x0
  pushl $116
80105591:	6a 74                	push   $0x74
  jmp alltraps
80105593:	e9 6b f7 ff ff       	jmp    80104d03 <alltraps>
...
80105598:	6a 00                	push   $0x0
  pushl $117
8010559a:	6a 75                	push   $0x75
  jmp alltraps
8010559c:	e9 62 f7 ff ff       	jmp    80104d03 <alltraps>
...
801055a1:	6a 00                	push   $0x0
  pushl $118
801055a3:	6a 76                	push   $0x76
  jmp alltraps
801055a5:	e9 59 f7 ff ff       	jmp    80104d03 <alltraps>
...
801055aa:	6a 00                	push   $0x0
  pushl $119
801055ac:	6a 77                	push   $0x77
  jmp alltraps
801055ae:	e9 50 f7 ff ff       	jmp    80104d03 <alltraps>
...
801055b3:	6a 00                	push   $0x0
  pushl $120
801055b5:	6a 78                	push   $0x78
  jmp alltraps
801055b7:	e9 47 f7 ff ff       	jmp    80104d03 <alltraps>
...
801055bc:	6a 00                	push   $0x0
  pushl $121
801055be:	6a 79                	push   $0x79
  jmp alltraps
801055c0:	e9 3e f7 ff ff       	jmp    80104d03 <alltraps>
...
801055c5:	6a 00                	push   $0x0
  pushl $122
801055c7:	6a 7a                	push   $0x7a
  jmp alltraps
801055c9:	e9 35 f7 ff ff       	jmp    80104d03 <alltraps>
...
801055ce:	6a 00                	push   $0x0
  pushl $123
801055d0:	6a 7b                	push   $0x7b
  jmp alltraps
801055d2:	e9 2c f7 ff ff       	jmp    80104d03 <alltraps>
...
801055d7:	6a 00                	push   $0x0
  pushl $124
801055d9:	6a 7c                	push   $0x7c
  jmp alltraps
801055db:	e9 23 f7 ff ff       	jmp    80104d03 <alltraps>
...
801055e0:	6a 00                	push   $0x0
  pushl $125
801055e2:	6a 7d                	push   $0x7d
  jmp alltraps
801055e4:	e9 1a f7 ff ff       	jmp    80104d03 <alltraps>
...
801055e9:	6a 00                	push   $0x0
  pushl $126
801055eb:	6a 7e                	push   $0x7e
  jmp alltraps
801055ed:	e9 11 f7 ff ff       	jmp    80104d03 <alltraps>
...
801055f2:	6a 00                	push   $0x0
  pushl $127
801055f4:	6a 7f                	push   $0x7f
  jmp alltraps
801055f6:	e9 08 f7 ff ff       	jmp    80104d03 <alltraps>
...
801055fb:	6a 00                	push   $0x0
  pushl $128
801055fd:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80105602:	e9 fc f6 ff ff       	jmp    80104d03 <alltraps>
...
80105607:	6a 00                	push   $0x0
  pushl $129
80105609:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010560e:	e9 f0 f6 ff ff       	jmp    80104d03 <alltraps>
...
80105613:	6a 00                	push   $0x0
  pushl $130
80105615:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010561a:	e9 e4 f6 ff ff       	jmp    80104d03 <alltraps>
...
8010561f:	6a 00                	push   $0x0
  pushl $131
80105621:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80105626:	e9 d8 f6 ff ff       	jmp    80104d03 <alltraps>
...
8010562b:	6a 00                	push   $0x0
  pushl $132
8010562d:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80105632:	e9 cc f6 ff ff       	jmp    80104d03 <alltraps>
...
80105637:	6a 00                	push   $0x0
  pushl $133
80105639:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010563e:	e9 c0 f6 ff ff       	jmp    80104d03 <alltraps>
...
80105643:	6a 00                	push   $0x0
  pushl $134
80105645:	68 86 00 00 00       	push   $0x86
  jmp alltraps
8010564a:	e9 b4 f6 ff ff       	jmp    80104d03 <alltraps>
...
8010564f:	6a 00                	push   $0x0
  pushl $135
80105651:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80105656:	e9 a8 f6 ff ff       	jmp    80104d03 <alltraps>
...
8010565b:	6a 00                	push   $0x0
  pushl $136
8010565d:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80105662:	e9 9c f6 ff ff       	jmp    80104d03 <alltraps>
...
80105667:	6a 00                	push   $0x0
  pushl $137
80105669:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010566e:	e9 90 f6 ff ff       	jmp    80104d03 <alltraps>
...
80105673:	6a 00                	push   $0x0
  pushl $138
80105675:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
8010567a:	e9 84 f6 ff ff       	jmp    80104d03 <alltraps>
...
8010567f:	6a 00                	push   $0x0
  pushl $139
80105681:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80105686:	e9 78 f6 ff ff       	jmp    80104d03 <alltraps>
...
8010568b:	6a 00                	push   $0x0
  pushl $140
8010568d:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80105692:	e9 6c f6 ff ff       	jmp    80104d03 <alltraps>
...
80105697:	6a 00                	push   $0x0
  pushl $141
80105699:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010569e:	e9 60 f6 ff ff       	jmp    80104d03 <alltraps>
...
801056a3:	6a 00                	push   $0x0
  pushl $142
801056a5:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801056aa:	e9 54 f6 ff ff       	jmp    80104d03 <alltraps>
...
801056af:	6a 00                	push   $0x0
  pushl $143
801056b1:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801056b6:	e9 48 f6 ff ff       	jmp    80104d03 <alltraps>
...
801056bb:	6a 00                	push   $0x0
  pushl $144
801056bd:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801056c2:	e9 3c f6 ff ff       	jmp    80104d03 <alltraps>
...
801056c7:	6a 00                	push   $0x0
  pushl $145
801056c9:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801056ce:	e9 30 f6 ff ff       	jmp    80104d03 <alltraps>
...
801056d3:	6a 00                	push   $0x0
  pushl $146
801056d5:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801056da:	e9 24 f6 ff ff       	jmp    80104d03 <alltraps>
...
801056df:	6a 00                	push   $0x0
  pushl $147
801056e1:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801056e6:	e9 18 f6 ff ff       	jmp    80104d03 <alltraps>
...
801056eb:	6a 00                	push   $0x0
  pushl $148
801056ed:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801056f2:	e9 0c f6 ff ff       	jmp    80104d03 <alltraps>
...
801056f7:	6a 00                	push   $0x0
  pushl $149
801056f9:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801056fe:	e9 00 f6 ff ff       	jmp    80104d03 <alltraps>
...
80105703:	6a 00                	push   $0x0
  pushl $150
80105705:	68 96 00 00 00       	push   $0x96
  jmp alltraps
8010570a:	e9 f4 f5 ff ff       	jmp    80104d03 <alltraps>
...
8010570f:	6a 00                	push   $0x0
  pushl $151
80105711:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80105716:	e9 e8 f5 ff ff       	jmp    80104d03 <alltraps>
...
8010571b:	6a 00                	push   $0x0
  pushl $152
8010571d:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80105722:	e9 dc f5 ff ff       	jmp    80104d03 <alltraps>
...
80105727:	6a 00                	push   $0x0
  pushl $153
80105729:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010572e:	e9 d0 f5 ff ff       	jmp    80104d03 <alltraps>
...
80105733:	6a 00                	push   $0x0
  pushl $154
80105735:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
8010573a:	e9 c4 f5 ff ff       	jmp    80104d03 <alltraps>
...
8010573f:	6a 00                	push   $0x0
  pushl $155
80105741:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80105746:	e9 b8 f5 ff ff       	jmp    80104d03 <alltraps>
...
8010574b:	6a 00                	push   $0x0
  pushl $156
8010574d:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
80105752:	e9 ac f5 ff ff       	jmp    80104d03 <alltraps>
...
80105757:	6a 00                	push   $0x0
  pushl $157
80105759:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010575e:	e9 a0 f5 ff ff       	jmp    80104d03 <alltraps>
...
80105763:	6a 00                	push   $0x0
  pushl $158
80105765:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
8010576a:	e9 94 f5 ff ff       	jmp    80104d03 <alltraps>
...
8010576f:	6a 00                	push   $0x0
  pushl $159
80105771:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80105776:	e9 88 f5 ff ff       	jmp    80104d03 <alltraps>
...
8010577b:	6a 00                	push   $0x0
  pushl $160
8010577d:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
80105782:	e9 7c f5 ff ff       	jmp    80104d03 <alltraps>
...
80105787:	6a 00                	push   $0x0
  pushl $161
80105789:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010578e:	e9 70 f5 ff ff       	jmp    80104d03 <alltraps>
...
80105793:	6a 00                	push   $0x0
  pushl $162
80105795:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
8010579a:	e9 64 f5 ff ff       	jmp    80104d03 <alltraps>
...
8010579f:	6a 00                	push   $0x0
  pushl $163
801057a1:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801057a6:	e9 58 f5 ff ff       	jmp    80104d03 <alltraps>
...
801057ab:	6a 00                	push   $0x0
  pushl $164
801057ad:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801057b2:	e9 4c f5 ff ff       	jmp    80104d03 <alltraps>
...
801057b7:	6a 00                	push   $0x0
  pushl $165
801057b9:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801057be:	e9 40 f5 ff ff       	jmp    80104d03 <alltraps>
...
801057c3:	6a 00                	push   $0x0
  pushl $166
801057c5:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801057ca:	e9 34 f5 ff ff       	jmp    80104d03 <alltraps>
...
801057cf:	6a 00                	push   $0x0
  pushl $167
801057d1:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801057d6:	e9 28 f5 ff ff       	jmp    80104d03 <alltraps>
...
801057db:	6a 00                	push   $0x0
  pushl $168
801057dd:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801057e2:	e9 1c f5 ff ff       	jmp    80104d03 <alltraps>
...
801057e7:	6a 00                	push   $0x0
  pushl $169
801057e9:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801057ee:	e9 10 f5 ff ff       	jmp    80104d03 <alltraps>
...
801057f3:	6a 00                	push   $0x0
  pushl $170
801057f5:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801057fa:	e9 04 f5 ff ff       	jmp    80104d03 <alltraps>
...
801057ff:	6a 00                	push   $0x0
  pushl $171
80105801:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80105806:	e9 f8 f4 ff ff       	jmp    80104d03 <alltraps>
...
8010580b:	6a 00                	push   $0x0
  pushl $172
8010580d:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80105812:	e9 ec f4 ff ff       	jmp    80104d03 <alltraps>
...
80105817:	6a 00                	push   $0x0
  pushl $173
80105819:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010581e:	e9 e0 f4 ff ff       	jmp    80104d03 <alltraps>
...
80105823:	6a 00                	push   $0x0
  pushl $174
80105825:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
8010582a:	e9 d4 f4 ff ff       	jmp    80104d03 <alltraps>
...
8010582f:	6a 00                	push   $0x0
  pushl $175
80105831:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80105836:	e9 c8 f4 ff ff       	jmp    80104d03 <alltraps>
...
8010583b:	6a 00                	push   $0x0
  pushl $176
8010583d:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80105842:	e9 bc f4 ff ff       	jmp    80104d03 <alltraps>
...
80105847:	6a 00                	push   $0x0
  pushl $177
80105849:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010584e:	e9 b0 f4 ff ff       	jmp    80104d03 <alltraps>
...
80105853:	6a 00                	push   $0x0
  pushl $178
80105855:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
8010585a:	e9 a4 f4 ff ff       	jmp    80104d03 <alltraps>
...
8010585f:	6a 00                	push   $0x0
  pushl $179
80105861:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80105866:	e9 98 f4 ff ff       	jmp    80104d03 <alltraps>
...
8010586b:	6a 00                	push   $0x0
  pushl $180
8010586d:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
80105872:	e9 8c f4 ff ff       	jmp    80104d03 <alltraps>
...
80105877:	6a 00                	push   $0x0
  pushl $181
80105879:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010587e:	e9 80 f4 ff ff       	jmp    80104d03 <alltraps>
...
80105883:	6a 00                	push   $0x0
  pushl $182
80105885:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
8010588a:	e9 74 f4 ff ff       	jmp    80104d03 <alltraps>
...
8010588f:	6a 00                	push   $0x0
  pushl $183
80105891:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80105896:	e9 68 f4 ff ff       	jmp    80104d03 <alltraps>
...
8010589b:	6a 00                	push   $0x0
  pushl $184
8010589d:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801058a2:	e9 5c f4 ff ff       	jmp    80104d03 <alltraps>
...
801058a7:	6a 00                	push   $0x0
  pushl $185
801058a9:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801058ae:	e9 50 f4 ff ff       	jmp    80104d03 <alltraps>
...
801058b3:	6a 00                	push   $0x0
  pushl $186
801058b5:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801058ba:	e9 44 f4 ff ff       	jmp    80104d03 <alltraps>
...
801058bf:	6a 00                	push   $0x0
  pushl $187
801058c1:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801058c6:	e9 38 f4 ff ff       	jmp    80104d03 <alltraps>
...
801058cb:	6a 00                	push   $0x0
  pushl $188
801058cd:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801058d2:	e9 2c f4 ff ff       	jmp    80104d03 <alltraps>
...
801058d7:	6a 00                	push   $0x0
  pushl $189
801058d9:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801058de:	e9 20 f4 ff ff       	jmp    80104d03 <alltraps>
...
801058e3:	6a 00                	push   $0x0
  pushl $190
801058e5:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801058ea:	e9 14 f4 ff ff       	jmp    80104d03 <alltraps>
...
801058ef:	6a 00                	push   $0x0
  pushl $191
801058f1:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801058f6:	e9 08 f4 ff ff       	jmp    80104d03 <alltraps>
...
801058fb:	6a 00                	push   $0x0
  pushl $192
801058fd:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80105902:	e9 fc f3 ff ff       	jmp    80104d03 <alltraps>
...
80105907:	6a 00                	push   $0x0
  pushl $193
80105909:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010590e:	e9 f0 f3 ff ff       	jmp    80104d03 <alltraps>
...
80105913:	6a 00                	push   $0x0
  pushl $194
80105915:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
8010591a:	e9 e4 f3 ff ff       	jmp    80104d03 <alltraps>
...
8010591f:	6a 00                	push   $0x0
  pushl $195
80105921:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80105926:	e9 d8 f3 ff ff       	jmp    80104d03 <alltraps>
...
8010592b:	6a 00                	push   $0x0
  pushl $196
8010592d:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80105932:	e9 cc f3 ff ff       	jmp    80104d03 <alltraps>
...
80105937:	6a 00                	push   $0x0
  pushl $197
80105939:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010593e:	e9 c0 f3 ff ff       	jmp    80104d03 <alltraps>
...
80105943:	6a 00                	push   $0x0
  pushl $198
80105945:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
8010594a:	e9 b4 f3 ff ff       	jmp    80104d03 <alltraps>
...
8010594f:	6a 00                	push   $0x0
  pushl $199
80105951:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80105956:	e9 a8 f3 ff ff       	jmp    80104d03 <alltraps>
...
8010595b:	6a 00                	push   $0x0
  pushl $200
8010595d:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
80105962:	e9 9c f3 ff ff       	jmp    80104d03 <alltraps>
...
80105967:	6a 00                	push   $0x0
  pushl $201
80105969:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010596e:	e9 90 f3 ff ff       	jmp    80104d03 <alltraps>
...
80105973:	6a 00                	push   $0x0
  pushl $202
80105975:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
8010597a:	e9 84 f3 ff ff       	jmp    80104d03 <alltraps>
...
8010597f:	6a 00                	push   $0x0
  pushl $203
80105981:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80105986:	e9 78 f3 ff ff       	jmp    80104d03 <alltraps>
...
8010598b:	6a 00                	push   $0x0
  pushl $204
8010598d:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
80105992:	e9 6c f3 ff ff       	jmp    80104d03 <alltraps>
...
80105997:	6a 00                	push   $0x0
  pushl $205
80105999:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010599e:	e9 60 f3 ff ff       	jmp    80104d03 <alltraps>
...
801059a3:	6a 00                	push   $0x0
  pushl $206
801059a5:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801059aa:	e9 54 f3 ff ff       	jmp    80104d03 <alltraps>
...
801059af:	6a 00                	push   $0x0
  pushl $207
801059b1:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801059b6:	e9 48 f3 ff ff       	jmp    80104d03 <alltraps>
...
801059bb:	6a 00                	push   $0x0
  pushl $208
801059bd:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801059c2:	e9 3c f3 ff ff       	jmp    80104d03 <alltraps>
...
801059c7:	6a 00                	push   $0x0
  pushl $209
801059c9:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801059ce:	e9 30 f3 ff ff       	jmp    80104d03 <alltraps>
...
801059d3:	6a 00                	push   $0x0
  pushl $210
801059d5:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801059da:	e9 24 f3 ff ff       	jmp    80104d03 <alltraps>
...
801059df:	6a 00                	push   $0x0
  pushl $211
801059e1:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801059e6:	e9 18 f3 ff ff       	jmp    80104d03 <alltraps>
...
801059eb:	6a 00                	push   $0x0
  pushl $212
801059ed:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801059f2:	e9 0c f3 ff ff       	jmp    80104d03 <alltraps>
...
801059f7:	6a 00                	push   $0x0
  pushl $213
801059f9:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801059fe:	e9 00 f3 ff ff       	jmp    80104d03 <alltraps>
...
80105a03:	6a 00                	push   $0x0
  pushl $214
80105a05:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80105a0a:	e9 f4 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105a0f:	6a 00                	push   $0x0
  pushl $215
80105a11:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80105a16:	e9 e8 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105a1b:	6a 00                	push   $0x0
  pushl $216
80105a1d:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80105a22:	e9 dc f2 ff ff       	jmp    80104d03 <alltraps>
...
80105a27:	6a 00                	push   $0x0
  pushl $217
80105a29:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80105a2e:	e9 d0 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105a33:	6a 00                	push   $0x0
  pushl $218
80105a35:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80105a3a:	e9 c4 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105a3f:	6a 00                	push   $0x0
  pushl $219
80105a41:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80105a46:	e9 b8 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105a4b:	6a 00                	push   $0x0
  pushl $220
80105a4d:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
80105a52:	e9 ac f2 ff ff       	jmp    80104d03 <alltraps>
...
80105a57:	6a 00                	push   $0x0
  pushl $221
80105a59:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
80105a5e:	e9 a0 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105a63:	6a 00                	push   $0x0
  pushl $222
80105a65:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80105a6a:	e9 94 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105a6f:	6a 00                	push   $0x0
  pushl $223
80105a71:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80105a76:	e9 88 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105a7b:	6a 00                	push   $0x0
  pushl $224
80105a7d:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
80105a82:	e9 7c f2 ff ff       	jmp    80104d03 <alltraps>
...
80105a87:	6a 00                	push   $0x0
  pushl $225
80105a89:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
80105a8e:	e9 70 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105a93:	6a 00                	push   $0x0
  pushl $226
80105a95:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80105a9a:	e9 64 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105a9f:	6a 00                	push   $0x0
  pushl $227
80105aa1:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80105aa6:	e9 58 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105aab:	6a 00                	push   $0x0
  pushl $228
80105aad:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80105ab2:	e9 4c f2 ff ff       	jmp    80104d03 <alltraps>
...
80105ab7:	6a 00                	push   $0x0
  pushl $229
80105ab9:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80105abe:	e9 40 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105ac3:	6a 00                	push   $0x0
  pushl $230
80105ac5:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80105aca:	e9 34 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105acf:	6a 00                	push   $0x0
  pushl $231
80105ad1:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80105ad6:	e9 28 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105adb:	6a 00                	push   $0x0
  pushl $232
80105add:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80105ae2:	e9 1c f2 ff ff       	jmp    80104d03 <alltraps>
...
80105ae7:	6a 00                	push   $0x0
  pushl $233
80105ae9:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80105aee:	e9 10 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105af3:	6a 00                	push   $0x0
  pushl $234
80105af5:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80105afa:	e9 04 f2 ff ff       	jmp    80104d03 <alltraps>
...
80105aff:	6a 00                	push   $0x0
  pushl $235
80105b01:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80105b06:	e9 f8 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105b0b:	6a 00                	push   $0x0
  pushl $236
80105b0d:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80105b12:	e9 ec f1 ff ff       	jmp    80104d03 <alltraps>
...
80105b17:	6a 00                	push   $0x0
  pushl $237
80105b19:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80105b1e:	e9 e0 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105b23:	6a 00                	push   $0x0
  pushl $238
80105b25:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80105b2a:	e9 d4 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105b2f:	6a 00                	push   $0x0
  pushl $239
80105b31:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80105b36:	e9 c8 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105b3b:	6a 00                	push   $0x0
  pushl $240
80105b3d:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80105b42:	e9 bc f1 ff ff       	jmp    80104d03 <alltraps>
...
80105b47:	6a 00                	push   $0x0
  pushl $241
80105b49:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80105b4e:	e9 b0 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105b53:	6a 00                	push   $0x0
  pushl $242
80105b55:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80105b5a:	e9 a4 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105b5f:	6a 00                	push   $0x0
  pushl $243
80105b61:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80105b66:	e9 98 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105b6b:	6a 00                	push   $0x0
  pushl $244
80105b6d:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80105b72:	e9 8c f1 ff ff       	jmp    80104d03 <alltraps>
...
80105b77:	6a 00                	push   $0x0
  pushl $245
80105b79:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80105b7e:	e9 80 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105b83:	6a 00                	push   $0x0
  pushl $246
80105b85:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80105b8a:	e9 74 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105b8f:	6a 00                	push   $0x0
  pushl $247
80105b91:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80105b96:	e9 68 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105b9b:	6a 00                	push   $0x0
  pushl $248
80105b9d:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80105ba2:	e9 5c f1 ff ff       	jmp    80104d03 <alltraps>
...
80105ba7:	6a 00                	push   $0x0
  pushl $249
80105ba9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80105bae:	e9 50 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105bb3:	6a 00                	push   $0x0
  pushl $250
80105bb5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80105bba:	e9 44 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105bbf:	6a 00                	push   $0x0
  pushl $251
80105bc1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80105bc6:	e9 38 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105bcb:	6a 00                	push   $0x0
  pushl $252
80105bcd:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80105bd2:	e9 2c f1 ff ff       	jmp    80104d03 <alltraps>
...
80105bd7:	6a 00                	push   $0x0
  pushl $253
80105bd9:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80105bde:	e9 20 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105be3:	6a 00                	push   $0x0
  pushl $254
80105be5:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80105bea:	e9 14 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105bef:	6a 00                	push   $0x0
  pushl $255
80105bf1:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80105bf6:	e9 08 f1 ff ff       	jmp    80104d03 <alltraps>
...
80105c04:	89 d3                	mov    %edx,%ebx
  pde_t *pde;
  pte_t *pgtab;

  pde = &pgdir[PDX(va)];
80105c06:	c1 ea 16             	shr    $0x16,%edx
80105c09:	8d 3c 90             	lea    (%eax,%edx,4),%edi
  if(*pde & PTE_P){
80105c0c:	8b 37                	mov    (%edi),%esi
80105c0e:	f7 c6 01 00 00 00    	test   $0x1,%esi
80105c14:	74 20                	je     80105c36 <walkpgdir+0x3b>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80105c16:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80105c1c:	81 c6 00 00 00 80    	add    $0x80000000,%esi
  ...
  return &pgtab[PTX(va)];
80105c22:	c1 eb 0c             	shr    $0xc,%ebx
80105c25:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
80105c2b:	8d 04 9e             	lea    (%esi,%ebx,4),%eax
}
...
80105c36:	85 c9                	test   %ecx,%ecx
80105c38:	74 2b                	je     80105c65 <walkpgdir+0x6a>
80105c3a:	e8 64 c4 ff ff       	call   801020a3 <kalloc>
80105c3f:	89 c6                	mov    %eax,%esi
80105c41:	85 c0                	test   %eax,%eax
80105c43:	74 20                	je     80105c65 <walkpgdir+0x6a>
    memset(pgtab, 0, PGSIZE);
80105c45:	83 ec 04             	sub    $0x4,%esp
80105c48:	68 00 10 00 00       	push   $0x1000
80105c4d:	6a 00                	push   $0x0
80105c4f:	50                   	push   %eax
80105c50:	e8 45 e0 ff ff       	call   80103c9a <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80105c55:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80105c5b:	83 c8 07             	or     $0x7,%eax
80105c5e:	89 07                	mov    %eax,(%edi)
80105c60:	83 c4 10             	add    $0x10,%esp
80105c63:	eb bd                	jmp    80105c22 <walkpgdir+0x27>
      return 0;
80105c65:	b8 00 00 00 00       	mov    $0x0,%eax
80105c6a:	eb c2                	jmp    80105c2e <walkpgdir+0x33>
...
80105c75:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105c78:	8b 75 08             	mov    0x8(%ebp),%esi
  char *a, *last;
  pte_t *pte;

  a = (char*)PGROUNDDOWN((uint)va);
80105c7b:	89 d3                	mov    %edx,%ebx
80105c7d:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80105c83:	8d 7c 0a ff          	lea    -0x1(%edx,%ecx,1),%edi
80105c87:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105c8d:	b9 01 00 00 00       	mov    $0x1,%ecx
80105c92:	89 da                	mov    %ebx,%edx
80105c94:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105c97:	e8 5f ff ff ff       	call   80105bfb <walkpgdir>
80105c9c:	85 c0                	test   %eax,%eax
80105c9e:	74 2e                	je     80105cce <mappages+0x62>
      return -1;
    if(*pte & PTE_P)
80105ca0:	f6 00 01             	testb  $0x1,(%eax)
80105ca3:	75 1c                	jne    80105cc1 <mappages+0x55>
      panic("remap");
    *pte = pa | perm | PTE_P;
80105ca5:	89 f2                	mov    %esi,%edx
80105ca7:	0b 55 0c             	or     0xc(%ebp),%edx
80105caa:	83 ca 01             	or     $0x1,%edx
80105cad:	89 10                	mov    %edx,(%eax)
    if(a == last)
80105caf:	39 fb                	cmp    %edi,%ebx
80105cb1:	74 28                	je     80105cdb <mappages+0x6f>
      break;
    a += PGSIZE;
80105cb3:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    pa += PGSIZE;
80105cb9:	81 c6 00 10 00 00    	add    $0x1000,%esi
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80105cbf:	eb cc                	jmp    80105c8d <mappages+0x21>
      panic("remap");
80105cc1:	83 ec 0c             	sub    $0xc,%esp
80105cc4:	68 d0 6e 10 80       	push   $0x80106ed0
80105cc9:	e8 7a a6 ff ff       	call   80100348 <panic>
      return -1;
...
80105cda:	c3                   	ret    
  return 0;
80105cdb:	b8 00 00 00 00       	mov    $0x0,%eax
80105ce0:	eb f1                	jmp    80105cd3 <mappages+0x67>

80105ce2 <seginit>:
{
80105ce2:	55                   	push   %ebp
80105ce3:	89 e5                	mov    %esp,%ebp
80105ce5:	57                   	push   %edi
80105ce6:	56                   	push   %esi
80105ce7:	53                   	push   %ebx
80105ce8:	83 ec 1c             	sub    $0x1c,%esp
  c = &cpus[cpuid()];
80105ceb:	e8 aa d4 ff ff       	call   8010319a <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80105cf0:	69 f8 b0 00 00 00    	imul   $0xb0,%eax,%edi
80105cf6:	66 c7 87 18 08 11 80 	movw   $0xffff,-0x7feef7e8(%edi)
80105cfd:	ff ff 
80105cff:	66 c7 87 1a 08 11 80 	movw   $0x0,-0x7feef7e6(%edi)
80105d06:	00 00 
80105d08:	c6 87 1c 08 11 80 00 	movb   $0x0,-0x7feef7e4(%edi)
80105d0f:	0f b6 8f 1d 08 11 80 	movzbl -0x7feef7e3(%edi),%ecx
80105d16:	83 e1 f0             	and    $0xfffffff0,%ecx
80105d19:	89 ce                	mov    %ecx,%esi
80105d1b:	83 ce 0a             	or     $0xa,%esi
80105d1e:	89 f2                	mov    %esi,%edx
80105d20:	88 97 1d 08 11 80    	mov    %dl,-0x7feef7e3(%edi)
80105d26:	83 c9 1a             	or     $0x1a,%ecx
80105d29:	88 8f 1d 08 11 80    	mov    %cl,-0x7feef7e3(%edi)
80105d2f:	83 e1 9f             	and    $0xffffff9f,%ecx
80105d32:	88 8f 1d 08 11 80    	mov    %cl,-0x7feef7e3(%edi)
80105d38:	83 c9 80             	or     $0xffffff80,%ecx
80105d3b:	88 8f 1d 08 11 80    	mov    %cl,-0x7feef7e3(%edi)
80105d41:	0f b6 8f 1e 08 11 80 	movzbl -0x7feef7e2(%edi),%ecx
80105d48:	83 c9 0f             	or     $0xf,%ecx
80105d4b:	88 8f 1e 08 11 80    	mov    %cl,-0x7feef7e2(%edi)
80105d51:	89 ce                	mov    %ecx,%esi
80105d53:	83 e6 ef             	and    $0xffffffef,%esi
80105d56:	89 f2                	mov    %esi,%edx
80105d58:	88 97 1e 08 11 80    	mov    %dl,-0x7feef7e2(%edi)
80105d5e:	83 e1 cf             	and    $0xffffffcf,%ecx
80105d61:	88 8f 1e 08 11 80    	mov    %cl,-0x7feef7e2(%edi)
80105d67:	89 ce                	mov    %ecx,%esi
80105d69:	83 ce 40             	or     $0x40,%esi
80105d6c:	89 f2                	mov    %esi,%edx
80105d6e:	88 97 1e 08 11 80    	mov    %dl,-0x7feef7e2(%edi)
80105d74:	83 c9 c0             	or     $0xffffffc0,%ecx
80105d77:	88 8f 1e 08 11 80    	mov    %cl,-0x7feef7e2(%edi)
80105d7d:	c6 87 1f 08 11 80 00 	movb   $0x0,-0x7feef7e1(%edi)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80105d84:	66 c7 87 20 08 11 80 	movw   $0xffff,-0x7feef7e0(%edi)
80105d8b:	ff ff 
80105d8d:	66 c7 87 22 08 11 80 	movw   $0x0,-0x7feef7de(%edi)
80105d94:	00 00 
80105d96:	c6 87 24 08 11 80 00 	movb   $0x0,-0x7feef7dc(%edi)
80105d9d:	0f b6 8f 25 08 11 80 	movzbl -0x7feef7db(%edi),%ecx
80105da4:	83 e1 f0             	and    $0xfffffff0,%ecx
80105da7:	89 ce                	mov    %ecx,%esi
80105da9:	83 ce 02             	or     $0x2,%esi
80105dac:	89 f2                	mov    %esi,%edx
80105dae:	88 97 25 08 11 80    	mov    %dl,-0x7feef7db(%edi)
80105db4:	83 c9 12             	or     $0x12,%ecx
80105db7:	88 8f 25 08 11 80    	mov    %cl,-0x7feef7db(%edi)
80105dbd:	83 e1 9f             	and    $0xffffff9f,%ecx
80105dc0:	88 8f 25 08 11 80    	mov    %cl,-0x7feef7db(%edi)
80105dc6:	83 c9 80             	or     $0xffffff80,%ecx
80105dc9:	88 8f 25 08 11 80    	mov    %cl,-0x7feef7db(%edi)
80105dcf:	0f b6 8f 26 08 11 80 	movzbl -0x7feef7da(%edi),%ecx
80105dd6:	83 c9 0f             	or     $0xf,%ecx
80105dd9:	88 8f 26 08 11 80    	mov    %cl,-0x7feef7da(%edi)
80105ddf:	89 ce                	mov    %ecx,%esi
80105de1:	83 e6 ef             	and    $0xffffffef,%esi
80105de4:	89 f2                	mov    %esi,%edx
80105de6:	88 97 26 08 11 80    	mov    %dl,-0x7feef7da(%edi)
80105dec:	83 e1 cf             	and    $0xffffffcf,%ecx
80105def:	88 8f 26 08 11 80    	mov    %cl,-0x7feef7da(%edi)
80105df5:	89 ce                	mov    %ecx,%esi
80105df7:	83 ce 40             	or     $0x40,%esi
80105dfa:	89 f2                	mov    %esi,%edx
80105dfc:	88 97 26 08 11 80    	mov    %dl,-0x7feef7da(%edi)
80105e02:	83 c9 c0             	or     $0xffffffc0,%ecx
80105e05:	88 8f 26 08 11 80    	mov    %cl,-0x7feef7da(%edi)
80105e0b:	c6 87 27 08 11 80 00 	movb   $0x0,-0x7feef7d9(%edi)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80105e12:	66 c7 87 28 08 11 80 	movw   $0xffff,-0x7feef7d8(%edi)
80105e19:	ff ff 
80105e1b:	66 c7 87 2a 08 11 80 	movw   $0x0,-0x7feef7d6(%edi)
80105e22:	00 00 
80105e24:	c6 87 2c 08 11 80 00 	movb   $0x0,-0x7feef7d4(%edi)
80105e2b:	0f b6 9f 2d 08 11 80 	movzbl -0x7feef7d3(%edi),%ebx
80105e32:	83 e3 f0             	and    $0xfffffff0,%ebx
80105e35:	89 de                	mov    %ebx,%esi
80105e37:	83 ce 0a             	or     $0xa,%esi
80105e3a:	89 f2                	mov    %esi,%edx
80105e3c:	88 97 2d 08 11 80    	mov    %dl,-0x7feef7d3(%edi)
80105e42:	89 de                	mov    %ebx,%esi
80105e44:	83 ce 1a             	or     $0x1a,%esi
80105e47:	89 f2                	mov    %esi,%edx
80105e49:	88 97 2d 08 11 80    	mov    %dl,-0x7feef7d3(%edi)
80105e4f:	83 cb 7a             	or     $0x7a,%ebx
80105e52:	88 9f 2d 08 11 80    	mov    %bl,-0x7feef7d3(%edi)
80105e58:	c6 87 2d 08 11 80 fa 	movb   $0xfa,-0x7feef7d3(%edi)
80105e5f:	0f b6 9f 2e 08 11 80 	movzbl -0x7feef7d2(%edi),%ebx
80105e66:	83 cb 0f             	or     $0xf,%ebx
80105e69:	88 9f 2e 08 11 80    	mov    %bl,-0x7feef7d2(%edi)
80105e6f:	89 de                	mov    %ebx,%esi
80105e71:	83 e6 ef             	and    $0xffffffef,%esi
80105e74:	89 f2                	mov    %esi,%edx
80105e76:	88 97 2e 08 11 80    	mov    %dl,-0x7feef7d2(%edi)
80105e7c:	83 e3 cf             	and    $0xffffffcf,%ebx
80105e7f:	88 9f 2e 08 11 80    	mov    %bl,-0x7feef7d2(%edi)
80105e85:	89 de                	mov    %ebx,%esi
80105e87:	83 ce 40             	or     $0x40,%esi
80105e8a:	89 f2                	mov    %esi,%edx
80105e8c:	88 97 2e 08 11 80    	mov    %dl,-0x7feef7d2(%edi)
80105e92:	83 cb c0             	or     $0xffffffc0,%ebx
80105e95:	88 9f 2e 08 11 80    	mov    %bl,-0x7feef7d2(%edi)
80105e9b:	c6 87 2f 08 11 80 00 	movb   $0x0,-0x7feef7d1(%edi)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80105ea2:	66 c7 87 30 08 11 80 	movw   $0xffff,-0x7feef7d0(%edi)
80105ea9:	ff ff 
80105eab:	66 c7 87 32 08 11 80 	movw   $0x0,-0x7feef7ce(%edi)
80105eb2:	00 00 
80105eb4:	c6 87 34 08 11 80 00 	movb   $0x0,-0x7feef7cc(%edi)
80105ebb:	0f b6 9f 35 08 11 80 	movzbl -0x7feef7cb(%edi),%ebx
80105ec2:	83 e3 f0             	and    $0xfffffff0,%ebx
80105ec5:	89 de                	mov    %ebx,%esi
80105ec7:	83 ce 02             	or     $0x2,%esi
80105eca:	89 f2                	mov    %esi,%edx
80105ecc:	88 97 35 08 11 80    	mov    %dl,-0x7feef7cb(%edi)
80105ed2:	89 de                	mov    %ebx,%esi
80105ed4:	83 ce 12             	or     $0x12,%esi
80105ed7:	89 f2                	mov    %esi,%edx
80105ed9:	88 97 35 08 11 80    	mov    %dl,-0x7feef7cb(%edi)
80105edf:	83 cb 72             	or     $0x72,%ebx
80105ee2:	88 9f 35 08 11 80    	mov    %bl,-0x7feef7cb(%edi)
80105ee8:	c6 87 35 08 11 80 f2 	movb   $0xf2,-0x7feef7cb(%edi)
80105eef:	0f b6 9f 36 08 11 80 	movzbl -0x7feef7ca(%edi),%ebx
80105ef6:	83 cb 0f             	or     $0xf,%ebx
80105ef9:	88 9f 36 08 11 80    	mov    %bl,-0x7feef7ca(%edi)
80105eff:	89 de                	mov    %ebx,%esi
80105f01:	83 e6 ef             	and    $0xffffffef,%esi
80105f04:	89 f2                	mov    %esi,%edx
80105f06:	88 97 36 08 11 80    	mov    %dl,-0x7feef7ca(%edi)
80105f0c:	83 e3 cf             	and    $0xffffffcf,%ebx
80105f0f:	88 9f 36 08 11 80    	mov    %bl,-0x7feef7ca(%edi)
80105f15:	89 de                	mov    %ebx,%esi
80105f17:	83 ce 40             	or     $0x40,%esi
80105f1a:	89 f2                	mov    %esi,%edx
80105f1c:	88 97 36 08 11 80    	mov    %dl,-0x7feef7ca(%edi)
80105f22:	83 cb c0             	or     $0xffffffc0,%ebx
80105f25:	88 9f 36 08 11 80    	mov    %bl,-0x7feef7ca(%edi)
80105f2b:	c6 87 37 08 11 80 00 	movb   $0x0,-0x7feef7c9(%edi)
  lgdt(c->gdt, sizeof(c->gdt));
80105f32:	8d 97 10 08 11 80    	lea    -0x7feef7f0(%edi),%edx
  pd[0] = size-1;
80105f38:	66 c7 45 e2 2f 00    	movw   $0x2f,-0x1e(%ebp)
  pd[1] = (uint)p;
80105f3e:	66 89 55 e4          	mov    %dx,-0x1c(%ebp)
  pd[2] = (uint)p >> 16;
80105f42:	c1 ea 10             	shr    $0x10,%edx
80105f45:	66 89 55 e6          	mov    %dx,-0x1a(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
80105f49:	8d 45 e2             	lea    -0x1e(%ebp),%eax
80105f4c:	0f 01 10             	lgdtl  (%eax)
}
80105f4f:	83 c4 1c             	add    $0x1c,%esp
80105f52:	5b                   	pop    %ebx
80105f53:	5e                   	pop    %esi
80105f54:	5f                   	pop    %edi
80105f55:	5d                   	pop    %ebp
...
80105f57:	a1 c4 34 11 80       	mov    0x801134c4,%eax
...
80105f73:	0f 84 25 01 00 00    	je     8010609e <switchuvm+0x139>
    panic("switchuvm: no process");
  if(p->kstack == 0)
80105f79:	83 7e 08 00          	cmpl   $0x0,0x8(%esi)
80105f7d:	0f 84 28 01 00 00    	je     801060ab <switchuvm+0x146>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
80105f83:	83 7e 04 00          	cmpl   $0x0,0x4(%esi)
80105f87:	0f 84 2b 01 00 00    	je     801060b8 <switchuvm+0x153>
    panic("switchuvm: no pgdir");

  pushcli();
80105f8d:	e8 81 db ff ff       	call   80103b13 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80105f92:	e8 a7 d1 ff ff       	call   8010313e <mycpu>
80105f97:	89 c3                	mov    %eax,%ebx
80105f99:	e8 a0 d1 ff ff       	call   8010313e <mycpu>
80105f9e:	8d 78 08             	lea    0x8(%eax),%edi
80105fa1:	e8 98 d1 ff ff       	call   8010313e <mycpu>
80105fa6:	83 c0 08             	add    $0x8,%eax
80105fa9:	c1 e8 10             	shr    $0x10,%eax
80105fac:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80105faf:	e8 8a d1 ff ff       	call   8010313e <mycpu>
...
80105fde:	89 d1                	mov    %edx,%ecx
80105fe0:	83 c9 09             	or     $0x9,%ecx
80105fe3:	88 8b 9d 00 00 00    	mov    %cl,0x9d(%ebx)
80105fe9:	83 ca 19             	or     $0x19,%edx
80105fec:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80105ff2:	83 e2 9f             	and    $0xffffff9f,%edx
80105ff5:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80105ffb:	83 ca 80             	or     $0xffffff80,%edx
80105ffe:	88 93 9d 00 00 00    	mov    %dl,0x9d(%ebx)
80106004:	0f b6 93 9e 00 00 00 	movzbl 0x9e(%ebx),%edx
8010600b:	89 d1                	mov    %edx,%ecx
8010600d:	83 e1 f0             	and    $0xfffffff0,%ecx
80106010:	88 8b 9e 00 00 00    	mov    %cl,0x9e(%ebx)
80106016:	89 d1                	mov    %edx,%ecx
80106018:	83 e1 e0             	and    $0xffffffe0,%ecx
8010601b:	88 8b 9e 00 00 00    	mov    %cl,0x9e(%ebx)
80106021:	83 e2 c0             	and    $0xffffffc0,%edx
80106024:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
8010602a:	83 ca 40             	or     $0x40,%edx
8010602d:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
80106033:	83 e2 7f             	and    $0x7f,%edx
80106036:	88 93 9e 00 00 00    	mov    %dl,0x9e(%ebx)
8010603c:	88 83 9f 00 00 00    	mov    %al,0x9f(%ebx)
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
80106042:	e8 f7 d0 ff ff       	call   8010313e <mycpu>
80106047:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
8010604e:	83 e2 ef             	and    $0xffffffef,%edx
80106051:	88 90 9d 00 00 00    	mov    %dl,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106057:	e8 e2 d0 ff ff       	call   8010313e <mycpu>
8010605c:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
80106062:	8b 5e 08             	mov    0x8(%esi),%ebx
80106065:	e8 d4 d0 ff ff       	call   8010313e <mycpu>
8010606a:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106070:	89 58 0c             	mov    %ebx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106073:	e8 c6 d0 ff ff       	call   8010313e <mycpu>
80106078:	66 c7 40 6e ff ff    	movw   $0xffff,0x6e(%eax)
  asm volatile("ltr %0" : : "r" (sel));
8010607e:	b8 28 00 00 00       	mov    $0x28,%eax
80106083:	0f 00 d8             	ltr    %ax
  ltr(SEG_TSS << 3);
  lcr3(V2P(p->pgdir));  // switch to process's address space
80106086:	8b 46 04             	mov    0x4(%esi),%eax
80106089:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
8010608e:	0f 22 d8             	mov    %eax,%cr3
  popcli();
80106091:	e8 b9 da ff ff       	call   80103b4f <popcli>
}
...
801060d3:	77 4c                	ja     80106121 <inituvm+0x5c>
    panic("inituvm: more than a page");
  mem = kalloc();
801060d5:	e8 c9 bf ff ff       	call   801020a3 <kalloc>
...
801060e7:	e8 ae db ff ff       	call   80103c9a <memset>
...
80106105:	e8 62 fb ff ff       	call   80105c6c <mappages>
  memmove(mem, init, sz);
8010610a:	83 c4 0c             	add    $0xc,%esp
8010610d:	56                   	push   %esi
8010610e:	ff 75 0c             	push   0xc(%ebp)
80106111:	53                   	push   %ebx
80106112:	e8 fb db ff ff       	call   80103d12 <memmove>
}
...
80106124:	68 15 6f 10 80       	push   $0x80106f15
80106129:	e8 1a a2 ff ff       	call   80100348 <panic>
...
80106137:	8b 7d 18             	mov    0x18(%ebp),%edi
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
8010613a:	8b 5d 0c             	mov    0xc(%ebp),%ebx
8010613d:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
80106143:	74 3c                	je     80106181 <loaduvm+0x53>
    panic("loaduvm: addr must be page aligned");
80106145:	83 ec 0c             	sub    $0xc,%esp
80106148:	68 d0 6f 10 80       	push   $0x80106fd0
8010614d:	e8 f6 a1 ff ff       	call   80100348 <panic>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106152:	83 ec 0c             	sub    $0xc,%esp
80106155:	68 2f 6f 10 80       	push   $0x80106f2f
...
8010616c:	ff 75 10             	push   0x10(%ebp)
8010616f:	e8 ed b5 ff ff       	call   80101761 <readi>
80106174:	83 c4 10             	add    $0x10,%esp
80106177:	39 f0                	cmp    %esi,%eax
80106179:	75 47                	jne    801061c2 <loaduvm+0x94>
  for(i = 0; i < sz; i += PGSIZE){
8010617b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106181:	39 fb                	cmp    %edi,%ebx
80106183:	73 30                	jae    801061b5 <loaduvm+0x87>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
...
80106192:	e8 64 fa ff ff       	call   80105bfb <walkpgdir>
80106197:	85 c0                	test   %eax,%eax
80106199:	74 b7                	je     80106152 <loaduvm+0x24>
    pa = PTE_ADDR(*pte);
...
801061ac:	76 b1                	jbe    8010615f <loaduvm+0x31>
      n = PGSIZE;
801061ae:	be 00 10 00 00       	mov    $0x1000,%esi
801061b3:	eb aa                	jmp    8010615f <loaduvm+0x31>
      return -1;
  }
  return 0;
...
801061c7:	eb f1                	jmp    801061ba <loaduvm+0x8c>
...
80106212:	e8 e4 f9 ff ff       	call   80105bfb <walkpgdir>
...
80106233:	e8 54 bd ff ff       	call   80101f8c <kfree>
      *pte = 0;
...
80106246:	68 86 68 10 80       	push   $0x80106886
...
8010626c:	0f 88 c1 00 00 00    	js     80106333 <allocuvm+0xd8>
  if(newsz < oldsz)
80106272:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106275:	72 5c                	jb     801062d3 <allocuvm+0x78>
  a = PGROUNDUP(oldsz);
80106277:	8b 45 0c             	mov    0xc(%ebp),%eax
8010627a:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106280:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106286:	39 fe                	cmp    %edi,%esi
80106288:	0f 83 ac 00 00 00    	jae    8010633a <allocuvm+0xdf>
    mem = kalloc();
8010628e:	e8 10 be ff ff       	call   801020a3 <kalloc>
80106293:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80106295:	85 c0                	test   %eax,%eax
80106297:	74 42                	je     801062db <allocuvm+0x80>
    memset(mem, 0, PGSIZE);
80106299:	83 ec 04             	sub    $0x4,%esp
8010629c:	68 00 10 00 00       	push   $0x1000
801062a1:	6a 00                	push   $0x0
801062a3:	50                   	push   %eax
801062a4:	e8 f1 d9 ff ff       	call   80103c9a <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
801062a9:	83 c4 08             	add    $0x8,%esp
801062ac:	6a 06                	push   $0x6
801062ae:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801062b4:	50                   	push   %eax
801062b5:	b9 00 10 00 00       	mov    $0x1000,%ecx
801062ba:	89 f2                	mov    %esi,%edx
801062bc:	8b 45 08             	mov    0x8(%ebp),%eax
801062bf:	e8 a8 f9 ff ff       	call   80105c6c <mappages>
801062c4:	83 c4 10             	add    $0x10,%esp
801062c7:	85 c0                	test   %eax,%eax
801062c9:	78 38                	js     80106303 <allocuvm+0xa8>
  for(; a < newsz; a += PGSIZE){
801062cb:	81 c6 00 10 00 00    	add    $0x1000,%esi
801062d1:	eb b3                	jmp    80106286 <allocuvm+0x2b>
    return oldsz;
801062d3:	8b 45 0c             	mov    0xc(%ebp),%eax
801062d6:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801062d9:	eb 5f                	jmp    8010633a <allocuvm+0xdf>
      cprintf("allocuvm out of memory\n");
801062db:	83 ec 0c             	sub    $0xc,%esp
801062de:	68 4d 6f 10 80       	push   $0x80106f4d
801062e3:	e8 1f a3 ff ff       	call   80100607 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
801062e8:	83 c4 0c             	add    $0xc,%esp
801062eb:	ff 75 0c             	push   0xc(%ebp)
801062ee:	57                   	push   %edi
801062ef:	ff 75 08             	push   0x8(%ebp)
801062f2:	e8 d2 fe ff ff       	call   801061c9 <deallocuvm>
      return 0;
801062f7:	83 c4 10             	add    $0x10,%esp
801062fa:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80106301:	eb 37                	jmp    8010633a <allocuvm+0xdf>
      cprintf("allocuvm out of memory (2)\n");
80106303:	83 ec 0c             	sub    $0xc,%esp
80106306:	68 65 6f 10 80       	push   $0x80106f65
8010630b:	e8 f7 a2 ff ff       	call   80100607 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80106310:	83 c4 0c             	add    $0xc,%esp
80106313:	ff 75 0c             	push   0xc(%ebp)
80106316:	57                   	push   %edi
80106317:	ff 75 08             	push   0x8(%ebp)
8010631a:	e8 aa fe ff ff       	call   801061c9 <deallocuvm>
      kfree(mem);
8010631f:	89 1c 24             	mov    %ebx,(%esp)
80106322:	e8 65 bc ff ff       	call   80101f8c <kfree>
      return 0;
80106327:	83 c4 10             	add    $0x10,%esp
8010632a:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80106331:	eb 07                	jmp    8010633a <allocuvm+0xdf>
    return 0;
80106333:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
...
8010634a:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
8010634d:	85 f6                	test   %esi,%esi
8010634f:	74 1a                	je     8010636b <freevm+0x26>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
80106351:	83 ec 04             	sub    $0x4,%esp
80106354:	6a 00                	push   $0x0
80106356:	68 00 00 00 80       	push   $0x80000000
8010635b:	56                   	push   %esi
8010635c:	e8 68 fe ff ff       	call   801061c9 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80106361:	83 c4 10             	add    $0x10,%esp
80106364:	bb 00 00 00 00       	mov    $0x0,%ebx
80106369:	eb 10                	jmp    8010637b <freevm+0x36>
    panic("freevm: no pgdir");
8010636b:	83 ec 0c             	sub    $0xc,%esp
8010636e:	68 81 6f 10 80       	push   $0x80106f81
80106373:	e8 d0 9f ff ff       	call   80100348 <panic>
  for(i = 0; i < NPDENTRIES; i++){
80106378:	83 c3 01             	add    $0x1,%ebx
8010637b:	81 fb ff 03 00 00    	cmp    $0x3ff,%ebx
80106381:	77 1f                	ja     801063a2 <freevm+0x5d>
    if(pgdir[i] & PTE_P){
80106383:	8b 04 9e             	mov    (%esi,%ebx,4),%eax
80106386:	a8 01                	test   $0x1,%al
80106388:	74 ee                	je     80106378 <freevm+0x33>
      char * v = P2V(PTE_ADDR(pgdir[i]));
8010638a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010638f:	05 00 00 00 80       	add    $0x80000000,%eax
      kfree(v);
80106394:	83 ec 0c             	sub    $0xc,%esp
80106397:	50                   	push   %eax
80106398:	e8 ef bb ff ff       	call   80101f8c <kfree>
8010639d:	83 c4 10             	add    $0x10,%esp
801063a0:	eb d6                	jmp    80106378 <freevm+0x33>
    }
  }
  kfree((char*)pgdir);
801063a2:	83 ec 0c             	sub    $0xc,%esp
801063a5:	56                   	push   %esi
801063a6:	e8 e1 bb ff ff       	call   80101f8c <kfree>
}
...
801063ba:	e8 e4 bc ff ff       	call   801020a3 <kalloc>
801063bf:	89 c6                	mov    %eax,%esi
801063c1:	85 c0                	test   %eax,%eax
801063c3:	74 55                	je     8010641a <setupkvm+0x65>
  memset(pgdir, 0, PGSIZE);
801063c5:	83 ec 04             	sub    $0x4,%esp
801063c8:	68 00 10 00 00       	push   $0x1000
801063cd:	6a 00                	push   $0x0
801063cf:	50                   	push   %eax
801063d0:	e8 c5 d8 ff ff       	call   80103c9a <memset>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801063d5:	83 c4 10             	add    $0x10,%esp
801063d8:	bb 20 94 10 80       	mov    $0x80109420,%ebx
801063dd:	81 fb 60 94 10 80    	cmp    $0x80109460,%ebx
801063e3:	73 35                	jae    8010641a <setupkvm+0x65>
                (uint)k->phys_start, k->perm) < 0) {
801063e5:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
801063e8:	8b 4b 08             	mov    0x8(%ebx),%ecx
801063eb:	29 c1                	sub    %eax,%ecx
801063ed:	83 ec 08             	sub    $0x8,%esp
801063f0:	ff 73 0c             	push   0xc(%ebx)
801063f3:	50                   	push   %eax
801063f4:	8b 13                	mov    (%ebx),%edx
801063f6:	89 f0                	mov    %esi,%eax
801063f8:	e8 6f f8 ff ff       	call   80105c6c <mappages>
801063fd:	83 c4 10             	add    $0x10,%esp
80106400:	85 c0                	test   %eax,%eax
80106402:	78 05                	js     80106409 <setupkvm+0x54>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106404:	83 c3 10             	add    $0x10,%ebx
80106407:	eb d4                	jmp    801063dd <setupkvm+0x28>
      freevm(pgdir);
80106409:	83 ec 0c             	sub    $0xc,%esp
8010640c:	56                   	push   %esi
8010640d:	e8 33 ff ff ff       	call   80106345 <freevm>
      return 0;
80106412:	83 c4 10             	add    $0x10,%esp
80106415:	be 00 00 00 00       	mov    $0x0,%esi
}
8010641a:	89 f0                	mov    %esi,%eax
8010641c:	8d 65 f8             	lea    -0x8(%ebp),%esp
8010641f:	5b                   	pop    %ebx
80106420:	5e                   	pop    %esi
80106421:	5d                   	pop    %ebp
80106422:	c3                   	ret    
...
80106426:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106429:	e8 87 ff ff ff       	call   801063b5 <setupkvm>
8010642e:	a3 c4 34 11 80       	mov    %eax,0x801134c4
  switchkvm();
80106433:	e8 1f fb ff ff       	call   80105f57 <switchkvm>
}
80106438:	c9                   	leave  
80106439:	c3                   	ret    
...
8010644b:	e8 ab f7 ff ff       	call   80105bfb <walkpgdir>
  if(pte == 0)
80106450:	85 c0                	test   %eax,%eax
80106452:	74 05                	je     80106459 <clearpteu+0x1f>
    panic("clearpteu");
  *pte &= ~PTE_U;
80106454:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
80106457:	c9                   	leave  
80106458:	c3                   	ret    
    panic("clearpteu");
80106459:	83 ec 0c             	sub    $0xc,%esp
8010645c:	68 92 6f 10 80       	push   $0x80106f92
80106461:	e8 e2 9e ff ff       	call   80100348 <panic>
...
8010646c:	83 ec 1c             	sub    $0x1c,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
8010646f:	e8 41 ff ff ff       	call   801063b5 <setupkvm>
80106474:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106477:	85 c0                	test   %eax,%eax
80106479:	0f 84 c4 00 00 00    	je     80106543 <copyuvm+0xdd>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
8010647f:	bf 00 00 00 00       	mov    $0x0,%edi
80106484:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106487:	0f 83 b6 00 00 00    	jae    80106543 <copyuvm+0xdd>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
8010648d:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106490:	b9 00 00 00 00       	mov    $0x0,%ecx
80106495:	89 fa                	mov    %edi,%edx
80106497:	8b 45 08             	mov    0x8(%ebp),%eax
8010649a:	e8 5c f7 ff ff       	call   80105bfb <walkpgdir>
8010649f:	85 c0                	test   %eax,%eax
801064a1:	74 65                	je     80106508 <copyuvm+0xa2>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
801064a3:	8b 00                	mov    (%eax),%eax
801064a5:	a8 01                	test   $0x1,%al
801064a7:	74 6c                	je     80106515 <copyuvm+0xaf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
801064a9:	89 c6                	mov    %eax,%esi
801064ab:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    flags = PTE_FLAGS(*pte);
801064b1:	25 ff 0f 00 00       	and    $0xfff,%eax
801064b6:	89 45 e0             	mov    %eax,-0x20(%ebp)
    if((mem = kalloc()) == 0)
801064b9:	e8 e5 bb ff ff       	call   801020a3 <kalloc>
801064be:	89 c3                	mov    %eax,%ebx
801064c0:	85 c0                	test   %eax,%eax
801064c2:	74 6a                	je     8010652e <copyuvm+0xc8>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
801064c4:	81 c6 00 00 00 80    	add    $0x80000000,%esi
801064ca:	83 ec 04             	sub    $0x4,%esp
801064cd:	68 00 10 00 00       	push   $0x1000
801064d2:	56                   	push   %esi
801064d3:	50                   	push   %eax
801064d4:	e8 39 d8 ff ff       	call   80103d12 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
801064d9:	83 c4 08             	add    $0x8,%esp
801064dc:	ff 75 e0             	push   -0x20(%ebp)
801064df:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801064e5:	50                   	push   %eax
801064e6:	b9 00 10 00 00       	mov    $0x1000,%ecx
801064eb:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801064ee:	8b 45 dc             	mov    -0x24(%ebp),%eax
801064f1:	e8 76 f7 ff ff       	call   80105c6c <mappages>
801064f6:	83 c4 10             	add    $0x10,%esp
801064f9:	85 c0                	test   %eax,%eax
801064fb:	78 25                	js     80106522 <copyuvm+0xbc>
  for(i = 0; i < sz; i += PGSIZE){
801064fd:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106503:	e9 7c ff ff ff       	jmp    80106484 <copyuvm+0x1e>
      panic("copyuvm: pte should exist");
80106508:	83 ec 0c             	sub    $0xc,%esp
8010650b:	68 9c 6f 10 80       	push   $0x80106f9c
80106510:	e8 33 9e ff ff       	call   80100348 <panic>
      panic("copyuvm: page not present");
80106515:	83 ec 0c             	sub    $0xc,%esp
80106518:	68 b6 6f 10 80       	push   $0x80106fb6
8010651d:	e8 26 9e ff ff       	call   80100348 <panic>
      kfree(mem);
80106522:	83 ec 0c             	sub    $0xc,%esp
80106525:	53                   	push   %ebx
80106526:	e8 61 ba ff ff       	call   80101f8c <kfree>
      goto bad;
...
80106531:	ff 75 dc             	push   -0x24(%ebp)
80106534:	e8 0c fe ff ff       	call   80106345 <freevm>
  return 0;
80106539:	83 c4 10             	add    $0x10,%esp
8010653c:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%ebp)
}
80106543:	8b 45 dc             	mov    -0x24(%ebp),%eax
...
8010655f:	e8 97 f6 ff ff       	call   80105bfb <walkpgdir>
  if((*pte & PTE_P) == 0)
80106564:	8b 00                	mov    (%eax),%eax
80106566:	a8 01                	test   $0x1,%al
80106568:	74 10                	je     8010657a <uva2ka+0x2c>
    return 0;
  if((*pte & PTE_U) == 0)
8010656a:	a8 04                	test   $0x4,%al
8010656c:	74 13                	je     80106581 <uva2ka+0x33>
    return 0;
...
8010657f:	eb f7                	jmp    80106578 <uva2ka+0x2a>
    return 0;
80106581:	b8 00 00 00 00       	mov    $0x0,%eax
80106586:	eb f0                	jmp    80106578 <uva2ka+0x2a>
...
8010658b:	57                   	push   %edi
8010658c:	56                   	push   %esi
8010658d:	53                   	push   %ebx
8010658e:	83 ec 0c             	sub    $0xc,%esp
80106591:	8b 7d 14             	mov    0x14(%ebp),%edi
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80106594:	eb 25                	jmp    801065bb <copyout+0x33>
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
    if(n > len)
...
80106596:	8b 55 0c             	mov    0xc(%ebp),%edx
80106599:	29 f2                	sub    %esi,%edx
8010659b:	01 d0                	add    %edx,%eax
8010659d:	83 ec 04             	sub    $0x4,%esp
801065a0:	53                   	push   %ebx
801065a1:	ff 75 10             	push   0x10(%ebp)
801065a4:	50                   	push   %eax
801065a5:	e8 68 d7 ff ff       	call   80103d12 <memmove>
    len -= n;
801065aa:	29 df                	sub    %ebx,%edi
    buf += n;
801065ac:	01 5d 10             	add    %ebx,0x10(%ebp)
    va = va0 + PGSIZE;
801065af:	8d 86 00 10 00 00    	lea    0x1000(%esi),%eax
801065b5:	89 45 0c             	mov    %eax,0xc(%ebp)
801065b8:	83 c4 10             	add    $0x10,%esp
  while(len > 0){
801065bb:	85 ff                	test   %edi,%edi
801065bd:	74 2f                	je     801065ee <copyout+0x66>
    va0 = (uint)PGROUNDDOWN(va);
801065bf:	8b 75 0c             	mov    0xc(%ebp),%esi
801065c2:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
801065c8:	83 ec 08             	sub    $0x8,%esp
801065cb:	56                   	push   %esi
801065cc:	ff 75 08             	push   0x8(%ebp)
801065cf:	e8 7a ff ff ff       	call   8010654e <uva2ka>
    if(pa0 == 0)
801065d4:	83 c4 10             	add    $0x10,%esp
801065d7:	85 c0                	test   %eax,%eax
801065d9:	74 20                	je     801065fb <copyout+0x73>
    n = PGSIZE - (va - va0);
801065db:	89 f3                	mov    %esi,%ebx
801065dd:	2b 5d 0c             	sub    0xc(%ebp),%ebx
801065e0:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
801065e6:	39 df                	cmp    %ebx,%edi
801065e8:	73 ac                	jae    80106596 <copyout+0xe>
      n = len;
801065ea:	89 fb                	mov    %edi,%ebx
801065ec:	eb a8                	jmp    80106596 <copyout+0xe>
  }
  return 0;
...
80106600:	eb f1                	jmp    801065f3 <copyout+0x6b>
