...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  12:	e8 fc 04 00 00       	call   513 <getpid>
  ...
  1a:	c7 45 f0 23 00 00 00 	movl   $0x23,-0x10(%ebp)
   ppid = getpid();
  21:	a3 98 0d 00 00       	mov    %eax,0xd98
   int thread_pid = thread_create(worker, &arg1, &arg2);
  ...
  33:	c7 45 f4 2a 00 00 00 	movl   $0x2a,-0xc(%ebp)
   int thread_pid = thread_create(worker, &arg1, &arg2);
  3a:	e8 a1 01 00 00       	call   1e0 <thread_create>
   assert(thread_pid > 0);
  ...
  48:	e8 a3 01 00 00       	call   1f0 <thread_join>
   assert(join_pid == thread_pid);
  4d:	39 c3                	cmp    %eax,%ebx
  4f:	75 2a                	jne    7b <main+0x7b>
   assert(global == 2);
  51:	83 3d 94 0d 00 00 02 	cmpl   $0x2,0xd94
  ...
  91:	68 94 09 00 00       	push   $0x994
  96:	68 49 09 00 00       	push   $0x949
  9b:	6a 01                	push   $0x1
  9d:	e8 5e 05 00 00       	call   600 <printf>
  a2:	5a                   	pop    %edx
  a3:	59                   	pop    %ecx
  a4:	68 5d 09 00 00       	push   $0x95d
  a9:	6a 01                	push   $0x1
  ab:	e8 50 05 00 00       	call   600 <printf>
  b0:	5b                   	pop    %ebx
  b1:	ff 35 98 0d 00 00    	push   0xd98
  b7:	e8 07 04 00 00       	call   4c3 <kill>
  bc:	e8 d2 03 00 00       	call   493 <exit>
   assert(thread_pid > 0);
  c1:	6a 1f                	push   $0x1f
  ...
  d7:	68 85 09 00 00       	push   $0x985
  dc:	eb b8                	jmp    96 <main+0x96>

   printf(1, "TEST PASSED\n");
  de:	50                   	push   %eax
  df:	50                   	push   %eax
  e0:	68 b7 09 00 00       	push   $0x9b7
  e5:	6a 01                	push   $0x1
  e7:	e8 14 05 00 00       	call   600 <printf>
   exit();
  ec:	e8 a2 03 00 00       	call   493 <exit>
  f1:	66 90                	xchg   %ax,%ax
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
...
worker(void *arg1, void *arg2) {
 ...
 116:	75 2a                	jne    142 <worker+0x42>
   assert(global == 1);
 118:	83 3d 94 0d 00 00 01 	cmpl   $0x1,0xd94
 11f:	0f 84 80 00 00 00    	je     1a5 <worker+0xa5>
 125:	6a 2f                	push   $0x2f
 127:	68 28 09 00 00       	push   $0x928
 12c:	68 32 09 00 00       	push   $0x932
 131:	6a 01                	push   $0x1
 133:	e8 c8 04 00 00       	call   600 <printf>
 138:	83 c4 0c             	add    $0xc,%esp
 13b:	68 79 09 00 00       	push   $0x979
 140:	eb 1b                	jmp    15d <worker+0x5d>
   assert(arg2_int == 42);
 142:	6a 2e                	push   $0x2e
 144:	68 28 09 00 00       	push   $0x928
 149:	68 32 09 00 00       	push   $0x932
 14e:	6a 01                	push   $0x1
 150:	e8 ab 04 00 00       	call   600 <printf>
 155:	83 c4 0c             	add    $0xc,%esp
 158:	68 6a 09 00 00       	push   $0x96a
 15d:	68 49 09 00 00       	push   $0x949
 162:	6a 01                	push   $0x1
 164:	e8 97 04 00 00       	call   600 <printf>
 169:	58                   	pop    %eax
 16a:	5a                   	pop    %edx
 16b:	68 5d 09 00 00       	push   $0x95d
 170:	6a 01                	push   $0x1
 172:	e8 89 04 00 00       	call   600 <printf>
 177:	59                   	pop    %ecx
 178:	ff 35 98 0d 00 00    	push   0xd98
 17e:	e8 40 03 00 00       	call   4c3 <kill>
 183:	e8 0b 03 00 00       	call   493 <exit>
   assert(arg1_int == 35);
 188:	6a 2d                	push   $0x2d
 18a:	68 28 09 00 00       	push   $0x928
 18f:	68 32 09 00 00       	push   $0x932
 194:	6a 01                	push   $0x1
 196:	e8 65 04 00 00       	call   600 <printf>
 19b:	83 c4 0c             	add    $0xc,%esp
 19e:	68 3a 09 00 00       	push   $0x93a
 1a3:	eb b8                	jmp    15d <worker+0x5d>
   global++;
 1a5:	c7 05 94 0d 00 00 02 	movl   $0x2,0xd94
 1ac:	00 00 00 
   exit();
 1af:	e8 df 02 00 00       	call   493 <exit>
...
int test_and_set(int *old_ptr, int new_ptr) {
 ...
 1c6:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  int old = *old_ptr;
 1c9:	8b 10                	mov    (%eax),%edx
  *old_ptr = new_ptr;
 1cb:	89 08                	mov    %ecx,(%eax)
  return old;
}
 1cd:	5d                   	pop    %ebp
...
void lock_acquire(lock_t *lock){
 ...
 206:	83 38 01             	cmpl   $0x1,(%eax)
 209:	75 05                	jne    210 <lock_acquire+0x10>
 20b:	eb fe                	jmp    20b <lock_acquire+0xb>
 20d:	8d 76 00             	lea    0x0(%esi),%esi
 210:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
 216:	5d                   	pop    %ebp
 217:	c3                   	ret    
 ...
 55c:	89 d1                	mov    %edx,%ecx
{
 ...
 589:	0f b6 92 24 0a 00 00 	movzbl 0xa24(%edx),%edx
 ...
 609:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 679:	ff 24 85 cc 09 00 00 	jmp    *0x9cc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 787:	90                   	nop
          s = "(null)";
 788:	ba c4 09 00 00       	mov    $0x9c4,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 7a1:	a1 9c 0d 00 00       	mov    0xd9c,%eax
{
 ...
 7e1:	5b                   	pop    %ebx
  freep = p;
 7e2:	89 15 9c 0d 00 00    	mov    %edx,0xd9c
}
 7e8:	5e                   	pop    %esi
 7e9:	5f                   	pop    %edi
 7ea:	5d                   	pop    %ebp
 ...
 819:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 81c:	89 15 9c 0d 00 00    	mov    %edx,0xd9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 839:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 83c:	8b 3d 9c 0d 00 00    	mov    0xd9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 87f:	73 4f                	jae    8d0 <malloc+0xa0>
    ...
    if(p == freep)
 881:	8b 3d 9c 0d 00 00    	mov    0xd9c,%edi
 ...
 8aa:	e8 f1 fe ff ff       	call   7a0 <free>
  return freep;
 8af:	8b 15 9c 0d 00 00    	mov    0xd9c,%edx
 ...
 8dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8df:	89 15 9c 0d 00 00    	mov    %edx,0xd9c
}
 ...
 8ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8f0:	c7 05 9c 0d 00 00 a0 	movl   $0xda0,0xd9c
 8f7:	0d 00 00 
    base.s.size = 0;
 8fa:	bf a0 0d 00 00       	mov    $0xda0,%edi
    base.s.ptr = freep = prevp = &base;
 8ff:	c7 05 a0 0d 00 00 a0 	movl   $0xda0,0xda0
 906:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 909:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 90b:	c7 05 a4 0d 00 00 00 	movl   $0x0,0xda4
 912:	00 00 00 
    if(p->s.size >= nunits){
