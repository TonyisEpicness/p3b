...
main(int argc, char *argv[])
{
  ...
  55:	e8 f1 05 00 00       	call   64b <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	push   (%ebx)
  69:	e8 f5 05 00 00       	call   663 <open>
  ...
  81:	e8 fa 06 00 00       	call   780 <printf>
      exit();
  86:	e8 98 05 00 00       	call   623 <exit>
  }
  exit();
  ...
  99:	e8 e2 06 00 00       	call   780 <printf>
    exit();
  9e:	e8 80 05 00 00       	call   623 <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 23 01 00 00       	call   1d0 <grep>
    exit();
  ad:	e8 71 05 00 00       	call   623 <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
...
000001d0 <grep>:
{
 ...
 208:	e8 2e 04 00 00       	call   63b <read>
 ...
 238:	e8 73 02 00 00       	call   4b0 <strchr>
 ...
 289:	52                   	push   %edx
 28a:	6a 01                	push   $0x1
 28c:	e8 b2 03 00 00       	call   643 <write>
 ...
 2e1:	89 4d dc             	mov    %ecx,-0x24(%ebp)
      memmove(buf, p, m);
 2e4:	e8 07 03 00 00       	call   5f0 <memmove>
...
void lock_acquire(lock_t *lock){
 ...
 396:	83 38 01             	cmpl   $0x1,(%eax)
 399:	75 05                	jne    3a0 <lock_acquire+0x10>
 39b:	eb fe                	jmp    39b <lock_acquire+0xb>
 39d:	8d 76 00             	lea    0x0(%esi),%esi
 3a0:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
 3a6:	5d                   	pop    %ebp
 3a7:	c3                   	ret    
 ...
 3d1:	31 c0                	xor    %eax,%eax
{
 ...
 3dc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  while((*s++ = *t++) != 0)
 3e0:	0f b6 14 03          	movzbl (%ebx,%eax,1),%edx
 3e4:	88 14 01             	mov    %dl,(%ecx,%eax,1)
...
strcmp(const char *p, const char *q)
{
 ...
 40f:	75 17                	jne    428 <strcmp+0x28>
 411:	eb 3a                	jmp    44d <strcmp+0x4d>
 413:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 417:	90                   	nop
 418:	0f b6 42 01          	movzbl 0x1(%edx),%eax
    p++, q++;
 41c:	83 c2 01             	add    $0x1,%edx
 41f:	8d 59 01             	lea    0x1(%ecx),%ebx
  while(*p && *p == *q)
 422:	84 c0                	test   %al,%al
 424:	74 1a                	je     440 <strcmp+0x40>
    p++, q++;
 426:	89 d9                	mov    %ebx,%ecx
  while(*p && *p == *q)
 428:	0f b6 19             	movzbl (%ecx),%ebx
 42b:	38 c3                	cmp    %al,%bl
 42d:	74 e9                	je     418 <strcmp+0x18>
  return (uchar)*p - (uchar)*q;
 42f:	29 d8                	sub    %ebx,%eax
}
...
strchr(const char *s, char c)
{
 ...
 4bf:	75 12                	jne    4d3 <strchr+0x23>
 4c1:	eb 1d                	jmp    4e0 <strchr+0x30>
 4c3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
 4c7:	90                   	nop
 4c8:	0f b6 50 01          	movzbl 0x1(%eax),%edx
 4cc:	83 c0 01             	add    $0x1,%eax
 4cf:	84 d2                	test   %dl,%dl
 4d1:	74 0d                	je     4e0 <strchr+0x30>
    if(*s == c)
 4d3:	38 d1                	cmp    %dl,%cl
 4d5:	75 f1                	jne    4c8 <strchr+0x18>
      return (char*)s;
  return 0;
}
 4d7:	5d                   	pop    %ebp
 ...
 4f9:	31 db                	xor    %ebx,%ebx
{
 ...
 505:	57                   	push   %edi
 506:	6a 00                	push   $0x0
 508:	e8 2e 01 00 00       	call   63b <read>
    if(cc < 1)
 ...
 521:	74 1d                	je     540 <gets+0x50>
 523:	3c 0d                	cmp    $0xd,%al
 525:	74 19                	je     540 <gets+0x50>
  for(i=0; i+1 < max; ){
 527:	89 de                	mov    %ebx,%esi
...
stat(const char *n, struct stat *st)
{
 ...
 56d:	e8 f1 00 00 00       	call   663 <open>
  if(fd < 0)
 ...
 581:	50                   	push   %eax
 582:	e8 f4 00 00 00       	call   67b <fstat>
  close(fd);
 587:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 58a:	89 c6                	mov    %eax,%esi
  close(fd);
 58c:	e8 ba 00 00 00       	call   64b <close>
  return r;
...
atoi(const char *s)
{
 ...
 5b4:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  n = 0;
  while('0' <= *s && *s <= '9')
 5b7:	0f be 02             	movsbl (%edx),%eax
 5ba:	8d 48 d0             	lea    -0x30(%eax),%ecx
 5bd:	80 f9 09             	cmp    $0x9,%cl
  n = 0;
 5c0:	b9 00 00 00 00       	mov    $0x0,%ecx
  while('0' <= *s && *s <= '9')
 5c5:	77 1e                	ja     5e5 <atoi+0x35>
 5c7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 5ce:	66 90                	xchg   %ax,%ax
    n = n*10 + *s++ - '0';
 5d0:	83 c2 01             	add    $0x1,%edx
 5d3:	8d 0c 89             	lea    (%ecx,%ecx,4),%ecx
 5d6:	8d 4c 48 d0          	lea    -0x30(%eax,%ecx,2),%ecx
  while('0' <= *s && *s <= '9')
 5da:	0f be 02             	movsbl (%edx),%eax
 5dd:	8d 58 d0             	lea    -0x30(%eax),%ebx
 5e0:	80 fb 09             	cmp    $0x9,%bl
 5e3:	76 eb                	jbe    5d0 <atoi+0x20>
  return n;
}
 5e5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 5e8:	89 c8                	mov    %ecx,%eax
 5ea:	c9                   	leave  
 5eb:	c3                   	ret    
 ...
 6dc:	89 d1                	mov    %edx,%ecx
{
 ...
 709:	0f b6 92 40 0b 00 00 	movzbl 0xb40(%edx),%edx
 ...
 74e:	56                   	push   %esi
 74f:	57                   	push   %edi
 750:	e8 ee fe ff ff       	call   643 <write>
  while(--i >= 0)
 ...
 789:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 7c5:	57                   	push   %edi
 7c6:	56                   	push   %esi
 7c7:	e8 77 fe ff ff       	call   643 <write>
 ...
 7f9:	ff 24 85 e8 0a 00 00 	jmp    *0xae8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 81e:	e8 20 fe ff ff       	call   643 <write>
        putc(fd, c);
 ...
 82f:	57                   	push   %edi
 830:	56                   	push   %esi
 831:	e8 0d fe ff ff       	call   643 <write>
        putc(fd, c);
 ...
 89b:	57                   	push   %edi
 89c:	56                   	push   %esi
 89d:	e8 a1 fd ff ff       	call   643 <write>
        while(*s != 0){
 ...
 8dc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 8df:	e8 5f fd ff ff       	call   643 <write>
        ap++;
 ...
 907:	90                   	nop
          s = "(null)";
 908:	ba de 0a 00 00       	mov    $0xade,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 921:	a1 60 13 00 00       	mov    0x1360,%eax
{
 ...
 961:	5b                   	pop    %ebx
  freep = p;
 962:	89 15 60 13 00 00    	mov    %edx,0x1360
}
 968:	5e                   	pop    %esi
 969:	5f                   	pop    %edi
 96a:	5d                   	pop    %ebp
 ...
 999:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 99c:	89 15 60 13 00 00    	mov    %edx,0x1360
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 9b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9bc:	8b 3d 60 13 00 00    	mov    0x1360,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 9ff:	73 4f                	jae    a50 <malloc+0xa0>
    ...
    if(p == freep)
 a01:	8b 3d 60 13 00 00    	mov    0x1360,%edi
 ...
 a13:	e8 93 fc ff ff       	call   6ab <sbrk>
  if(p == (char*)-1)
 ...
 a2a:	e8 f1 fe ff ff       	call   920 <free>
  return freep;
 a2f:	8b 15 60 13 00 00    	mov    0x1360,%edx
 ...
 a5c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 a5f:	89 15 60 13 00 00    	mov    %edx,0x1360
}
 ...
 a6f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 a70:	c7 05 60 13 00 00 64 	movl   $0x1364,0x1360
 a77:	13 00 00 
    base.s.size = 0;
 a7a:	bf 64 13 00 00       	mov    $0x1364,%edi
    base.s.ptr = freep = prevp = &base;
 a7f:	c7 05 64 13 00 00 64 	movl   $0x1364,0x1364
 a86:	13 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a89:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 a8b:	c7 05 68 13 00 00 00 	movl   $0x0,0x1368
 a92:	00 00 00 
    if(p->s.size >= nunits){
