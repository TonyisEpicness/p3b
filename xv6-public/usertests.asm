...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 68 39 00 00       	call   3993 <open>
    ...
    exit();
      40:	e8 0e 39 00 00       	call   3953 <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 3d 39 00 00       	call   3993 <open>
      56:	89 04 24             	mov    %eax,(%esp)
      59:	e8 1d 39 00 00       	call   397b <close>
  ...
  exit();
     10d:	e8 41 38 00 00       	call   3953 <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 6d 38 00 00       	call   39c3 <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 35 38 00 00       	call   39a3 <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 41 38 00 00       	call   39c3 <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 80 5f 00 00    	push   0x5f80
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 80 5f 00 00    	push   0x5f80
     1ae:	e8 0d 39 00 00       	call   3ac0 <printf>
    exit();
     1b3:	e8 9b 37 00 00       	call   3953 <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 33 3e 00 00       	push   $0x3e33
     1bf:	ff 35 80 5f 00 00    	push   0x5f80
     1c5:	e8 f6 38 00 00       	call   3ac0 <printf>
    exit();
     1ca:	e8 84 37 00 00       	call   3953 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 17 3e 00 00       	push   $0x3e17
     1d6:	ff 35 80 5f 00 00    	push   0x5f80
     1dc:	e8 df 38 00 00       	call   3ac0 <printf>
    exit();
     1e1:	e8 6d 37 00 00       	call   3953 <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 f6 3d 00 00       	push   $0x3df6
     1ed:	ff 35 80 5f 00 00    	push   0x5f80
     1f3:	e8 c8 38 00 00       	call   3ac0 <printf>
    exit();
     1f8:	e8 56 37 00 00       	call   3953 <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 80 5f 00 00    	push   0x5f80
     211:	e8 aa 38 00 00       	call   3ac0 <printf>
  pid = fork();
     216:	e8 30 37 00 00       	call   394b <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 86 37 00 00       	call   39bb <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 76 37 00 00       	call   39c3 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 3e 37 00 00       	call   39a3 <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 e2 36 00 00       	call   3953 <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 de 36 00 00       	call   395b <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 66 3e 00 00       	push   $0x3e66
     285:	ff 35 80 5f 00 00    	push   0x5f80
     ...
     2a0:	ff 35 80 5f 00 00    	push   0x5f80
     2a6:	e8 15 38 00 00       	call   3ac0 <printf>
      exit();
     2ab:	e8 a3 36 00 00       	call   3953 <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 29 4d 00 00       	push   $0x4d29
     2b7:	ff 35 80 5f 00 00    	push   0x5f80
     2bd:	e8 fe 37 00 00       	call   3ac0 <printf>
    exit();
     2c2:	e8 8c 36 00 00       	call   3953 <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 e8 3d 00 00       	push   $0x3de8
     2ce:	ff 35 80 5f 00 00    	push   0x5f80
     2d4:	e8 e7 37 00 00       	call   3ac0 <printf>
      exit();
     2d9:	e8 75 36 00 00       	call   3953 <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 52 3e 00 00       	push   $0x3e52
     2e5:	ff 35 80 5f 00 00    	push   0x5f80
     2eb:	e8 d0 37 00 00       	call   3ac0 <printf>
      exit();
     2f0:	e8 5e 36 00 00       	call   3953 <exit>
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 4c 36 00 00       	call   3993 <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 9e 35 00 00       	call   3953 <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 29 4d 00 00       	push   $0x4d29
     3bc:	ff 35 80 5f 00 00    	push   0x5f80
     3c2:	e8 f9 36 00 00       	call   3ac0 <printf>
    exit();
     3c7:	e8 87 35 00 00       	call   3953 <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 8d 3e 00 00       	push   $0x3e8d
     3d3:	ff 35 80 5f 00 00    	push   0x5f80
     3d9:	e8 e2 36 00 00       	call   3ac0 <printf>
    exit();
     3de:	e8 70 35 00 00       	call   3953 <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 a1 3e 00 00       	push   $0x3ea1
     3ea:	ff 35 80 5f 00 00    	push   0x5f80
     3f0:	e8 cb 36 00 00       	call   3ac0 <printf>
    exit();
     3f5:	e8 59 35 00 00       	call   3953 <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 80 5f 00 00    	push   0x5f80
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 6f 35 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     42e:	50                   	push   %eax
     42f:	e8 47 35 00 00       	call   397b <close>
  fd = open("doesnotexist", 0);
     434:	5a                   	pop    %edx
     435:	59                   	pop    %ecx
     436:	6a 00                	push   $0x0
     438:	68 e5 3e 00 00       	push   $0x3ee5
     43d:	e8 51 35 00 00       	call   3993 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 80 5f 00 00    	push   0x5f80
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 80 5f 00 00    	push   0x5f80
     46e:	e8 4d 36 00 00       	call   3ac0 <printf>
    exit();
     473:	e8 db 34 00 00       	call   3953 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 f2 3e 00 00       	push   $0x3ef2
     47f:	ff 35 80 5f 00 00    	push   0x5f80
     485:	e8 36 36 00 00       	call   3ac0 <printf>
    exit();
     48a:	e8 c4 34 00 00       	call   3953 <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 80 5f 00 00    	push   0x5f80
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 da 34 00 00       	call   3993 <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 80 5f 00 00    	push   0x5f80
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 83 34 00 00       	call   3973 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 67 34 00 00       	call   3973 <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 80 5f 00 00    	push   0x5f80
     52e:	e8 8d 35 00 00       	call   3ac0 <printf>
  close(fd);
     533:	89 34 24             	mov    %esi,(%esp)
     536:	e8 40 34 00 00       	call   397b <close>
  fd = open("small", O_RDONLY);
     53b:	5b                   	pop    %ebx
     53c:	5e                   	pop    %esi
     53d:	6a 00                	push   $0x0
     53f:	68 2f 3f 00 00       	push   $0x3f2f
     544:	e8 4a 34 00 00       	call   3993 <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 80 5f 00 00    	push   0x5f80
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 ef 33 00 00       	call   396b <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 80 5f 00 00    	push   0x5f80
     598:	e8 23 35 00 00       	call   3ac0 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 d6 33 00 00       	call   397b <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 2f 3f 00 00 	movl   $0x3f2f,(%esp)
     5ac:	e8 f2 33 00 00       	call   39a3 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 80 5f 00 00    	push   0x5f80
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 80 5f 00 00    	push   0x5f80
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 fa 32 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 aa 32 00 00       	call   3973 <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 90 32 00 00       	call   397b <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 77 40 00 00       	push   $0x4077
     6f4:	e8 9a 32 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 31 32 00 00       	call   396b <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 25 32 00 00       	call   397b <close>
  if(unlink("big") < 0){
     756:	c7 04 24 77 40 00 00 	movl   $0x4077,(%esp)
     75d:	e8 41 32 00 00       	call   39a3 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 80 5f 00 00    	push   0x5f80
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 80 5f 00 00    	push   0x5f80
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 08 31 00 00       	call   3993 <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 e8 30 00 00       	call   397b <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 dd 30 00 00       	call   39a3 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 80 5f 00 00    	push   0x5f80
...
000008f0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 9d 30 00 00       	call   39c3 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 85 30 00 00       	call   39c3 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 51 30 00 00       	call   39a3 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 80 5f 00 00    	push   0x5f80
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 80 5f 00 00    	push   0x5f80
     97e:	e8 3d 31 00 00       	call   3ac0 <printf>
    exit();
     983:	e8 cb 2f 00 00       	call   3953 <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 e1 40 00 00       	push   $0x40e1
     98f:	ff 35 80 5f 00 00    	push   0x5f80
     995:	e8 26 31 00 00       	call   3ac0 <printf>
    exit();
     99a:	e8 b4 2f 00 00       	call   3953 <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 d0 40 00 00       	push   $0x40d0
     9a6:	ff 35 80 5f 00 00    	push   0x5f80
     9ac:	e8 0f 31 00 00       	call   3ac0 <printf>
    exit();
     9b1:	e8 9d 2f 00 00       	call   3953 <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 bd 40 00 00       	push   $0x40bd
     9bd:	ff 35 80 5f 00 00    	push   0x5f80
     9c3:	e8 f8 30 00 00       	call   3ac0 <printf>
    exit();
     9c8:	e8 86 2f 00 00       	call   3953 <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 80 5f 00 00    	push   0x5f80
     9e1:	e8 da 30 00 00       	call   3ac0 <printf>
  if(exec("echo", echoargv) < 0){
     9e6:	5a                   	pop    %edx
     9e7:	59                   	pop    %ecx
     9e8:	68 84 5f 00 00       	push   $0x5f84
     9ed:	68 cd 3e 00 00       	push   $0x3ecd
     9f2:	e8 94 2f 00 00       	call   398b <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 80 5f 00 00    	push   0x5f80
     a0d:	e8 ae 30 00 00       	call   3ac0 <printf>
    exit();
     a12:	e8 3c 2f 00 00       	call   3953 <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 19 2f 00 00       	call   397b <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 ee 2e 00 00       	call   396b <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 9f 2e 00 00       	call   397b <close>
     ...
     b11:	e8 5d 2e 00 00       	call   3973 <write>
    ...
    exit();
     b28:	e8 26 2e 00 00       	call   3953 <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 3a 2e 00 00       	call   397b <close>
    wait();
     b41:	e8 15 2e 00 00       	call   395b <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 54 2f 00 00       	call   3ac0 <printf>
      exit();
     b6c:	e8 e2 2d 00 00       	call   3953 <exit>
    ...
    exit();
     b7f:	e8 cf 2d 00 00       	call   3953 <exit>
    ...
    exit();
     b92:	e8 bc 2d 00 00       	call   3953 <exit>
     ...
     ba0:	e8 1b 2f 00 00       	call   3ac0 <printf>
        exit();
     ba5:	e8 a9 2d 00 00       	call   3953 <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 81 2d 00 00       	call   394b <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 6c 2d 00 00       	call   394b <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 67 2d 00 00       	call   3963 <pipe>
  pid3 = fork();
     bfc:	e8 4a 2d 00 00       	call   394b <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     c39:	e8 3d 2d 00 00       	call   397b <close>
  ...
  close(pfds[0]);
     ...
     c76:	e8 00 2d 00 00       	call   397b <close>
  printf(1, "kill... ");
     c7b:	58                   	pop    %eax
     c7c:	5a                   	pop    %edx
  ...
  kill(pid1);
     ...
     c8c:	e8 f2 2c 00 00       	call   3983 <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 ea 2c 00 00       	call   3983 <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 e2 2c 00 00       	call   3983 <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 a7 2c 00 00       	call   395b <wait>
  wait();
     cb4:	e8 a2 2c 00 00       	call   395b <wait>
  wait();
     cb9:	e8 9d 2c 00 00       	call   395b <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 34 2c 00 00       	call   395b <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 16 2c 00 00       	call   394b <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 c4 2b 00 00       	call   3953 <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 28 2c 00 00       	call   39d3 <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 99 2b 00 00       	call   394b <fork>
    ...
    exit();
     e1f:	e8 2f 2b 00 00       	call   3953 <exit>
     ...
     e3a:	e8 44 2b 00 00       	call   3983 <kill>
      exit();
     e3f:	e8 0f 2b 00 00       	call   3953 <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 08 2b 00 00       	jmp    395b <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 22 2b 00 00       	call   39a3 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 23 42 00 00       	push   $0x4223
     e8d:	e8 01 2b 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 9f 2a 00 00       	call   394b <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     ebf:	50                   	push   %eax
     ec0:	56                   	push   %esi
     ec1:	e8 fa 28 00 00       	call   37c0 <memset>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 92 2a 00 00       	call   3973 <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 50 2a 00 00       	call   395b <wait>
  close(fd);
  ...
  close(fd);
     ...
     f14:	e8 62 2a 00 00       	call   397b <close>
  fd = open("sharedfd", 0);
     f19:	58                   	pop    %eax
     f1a:	5a                   	pop    %edx
     f1b:	6a 00                	push   $0x0
     f1d:	68 23 42 00 00       	push   $0x4223
     f22:	e8 6c 2a 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 1a 2a 00 00       	call   396b <read>
  ...
  close(fd);
     ...
     f86:	e8 f0 29 00 00       	call   397b <close>
  unlink("sharedfd");
     f8b:	c7 04 24 23 42 00 00 	movl   $0x4223,(%esp)
     f92:	e8 0c 2a 00 00       	call   39a3 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 53 29 00 00       	call   3953 <exit>
    ...
    exit();
    100e:	e8 40 29 00 00       	call   3953 <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 3f 29 00 00       	call   39a3 <unlink>
    pid = fork();
    1064:	e8 e2 28 00 00       	call   394b <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 ce 28 00 00       	call   395b <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 c7 28 00 00       	call   395b <wait>
    1094:	e8 c2 28 00 00       	call   395b <wait>
    1099:	e8 bd 28 00 00       	call   395b <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 e1 28 00 00       	call   3993 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 96 28 00 00       	call   396b <read>
    ...
    1104:	e8 72 28 00 00       	call   397b <close>
    if(total != 12*500){
    ...
    111e:	e8 80 28 00 00       	call   39a3 <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 62 29 00 00       	call   3ac0 <printf>
          exit();
    115e:	e8 f0 27 00 00       	call   3953 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 22 28 00 00       	call   3993 <open>
      if(fd < 0){
    ...
    1190:	e8 2b 26 00 00       	call   37c0 <memset>
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 c8 27 00 00       	call   3973 <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 94 27 00 00       	call   3953 <exit>
    ...
    11c8:	e8 f3 28 00 00       	call   3ac0 <printf>
        exit();
    11cd:	e8 81 27 00 00       	call   3953 <exit>
    ...
    11e2:	e8 d9 28 00 00       	call   3ac0 <printf>
      exit();
    11e7:	e8 67 27 00 00       	call   3953 <exit>
    ...
    11f5:	e8 c6 28 00 00       	call   3ac0 <printf>
      exit();
    11fa:	e8 54 27 00 00       	call   3953 <exit>
    ...
    1208:	e8 b3 28 00 00       	call   3ac0 <printf>
          exit();
    120d:	e8 41 27 00 00       	call   3953 <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 0c 27 00 00       	call   394b <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 01 27 00 00       	call   395b <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 f7 26 00 00       	call   395b <wait>
    1264:	e8 f2 26 00 00       	call   395b <wait>
    1269:	e8 ed 26 00 00       	call   395b <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 e5 26 00 00       	call   3993 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 a9 26 00 00       	call   397b <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 93 26 00 00       	call   39a3 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    134d:	e8 6e 27 00 00       	call   3ac0 <printf>
        exit();
    1352:	e8 fc 25 00 00       	call   3953 <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 f4 25 00 00       	call   3993 <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 cc 25 00 00       	call   397b <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 d5 25 00 00       	call   39a3 <unlink>
    ...
    13de:	e8 dd 26 00 00       	call   3ac0 <printf>
            exit();
    13e3:	e8 6b 25 00 00       	call   3953 <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 5e 25 00 00       	call   3953 <exit>
    ...
    1400:	e8 bb 26 00 00       	call   3ac0 <printf>
        exit();
    1405:	e8 49 25 00 00       	call   3953 <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 a7 26 00 00       	call   3ac0 <printf>
      exit();
    1419:	e8 35 25 00 00       	call   3953 <exit>
          printf(1, "create failed\n");
    ...
    1428:	e8 93 26 00 00       	call   3ac0 <printf>
          exit();
    142d:	e8 21 25 00 00       	call   3953 <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 2e 25 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 f1 24 00 00       	call   3973 <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 f1 24 00 00       	call   397b <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 d5 42 00 00       	push   $0x42d5
    1493:	e8 fb 24 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 f1 24 00 00       	call   39a3 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 c4 24 00 00       	call   3993 <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 52 24 00 00       	call   3973 <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 49 24 00 00       	call   397b <close>
  unlink("unlinkread");
    1532:	c7 04 24 d5 42 00 00 	movl   $0x42d5,(%esp)
    1539:	e8 65 24 00 00       	call   39a3 <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 ea 23 00 00       	call   3953 <exit>
    ...
    exit();
    1577:	e8 d7 23 00 00       	call   3953 <exit>
    ...
    exit();
    158a:	e8 c4 23 00 00       	call   3953 <exit>
    ...
    exit();
    159d:	e8 b1 23 00 00       	call   3953 <exit>
    ...
    exit();
    15b0:	e8 9e 23 00 00       	call   3953 <exit>
    ...
    exit();
    15c3:	e8 8b 23 00 00       	call   3953 <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 4a 23 00 00       	call   3973 <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 3d 23 00 00       	call   397b <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 9a 43 00 00       	push   $0x439a
    1645:	68 96 43 00 00       	push   $0x4396
    164a:	e8 64 23 00 00       	call   39b3 <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 3c 23 00 00       	call   39a3 <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 96 43 00 00       	push   $0x4396
    1670:	e8 1e 23 00 00       	call   3993 <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 04 23 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 bc 22 00 00       	call   396b <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 b7 22 00 00       	call   397b <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 9a 43 00 00       	push   $0x439a
    16cb:	68 9a 43 00 00       	push   $0x439a
    16d0:	e8 de 22 00 00       	call   39b3 <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 b6 22 00 00       	call   39a3 <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 96 43 00 00       	push   $0x4396
    16f4:	68 9a 43 00 00       	push   $0x439a
    16f9:	e8 b5 22 00 00       	call   39b3 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 9c 22 00 00       	call   39b3 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 0b 22 00 00       	call   3953 <exit>
    ...
    exit();
    1756:	e8 f8 21 00 00       	call   3953 <exit>
    ...
    exit();
    1769:	e8 e5 21 00 00       	call   3953 <exit>
    ...
    exit();
    177c:	e8 d2 21 00 00       	call   3953 <exit>
    ...
    exit();
    178f:	e8 bf 21 00 00       	call   3953 <exit>
    ...
    exit();
    17a2:	e8 ac 21 00 00       	call   3953 <exit>
    ...
    exit();
    17b5:	e8 99 21 00 00       	call   3953 <exit>
    ...
    exit();
    17c8:	e8 86 21 00 00       	call   3953 <exit>
    ...
    exit();
    17db:	e8 73 21 00 00       	call   3953 <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 64 21 00 00       	call   3993 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 39 21 00 00       	call   397b <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 11 21 00 00       	call   395b <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 41 21 00 00       	call   39a3 <unlink>
    pid = fork();
    1862:	e8 e4 20 00 00       	call   394b <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 09 21 00 00       	call   3993 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 d2 20 00 00       	call   39b3 <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 72 20 00 00       	call   395b <wait>
  for(i = 0; i < 40; i++){
  ...
  memset(fa, 0, sizeof(fa));
    ...
    18fa:	6a 00                	push   $0x0
    18fc:	50                   	push   %eax
    18fd:	e8 be 1e 00 00       	call   37c0 <memset>
  fd = open(".", 0);
    1902:	5e                   	pop    %esi
    1903:	5f                   	pop    %edi
    1904:	6a 00                	push   $0x0
    ...
    190e:	e8 80 20 00 00       	call   3993 <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 3f 20 00 00       	call   396b <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 02 20 00 00       	call   397b <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 01 20 00 00       	call   39a3 <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 f9 1f 00 00       	call   39a3 <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 f1 1f 00 00       	call   39a3 <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 e9 1f 00 00       	call   39a3 <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 91 1f 00 00       	call   395b <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 6a 1f 00 00       	call   394b <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 83 1f 00 00       	call   3993 <open>
    1a10:	89 04 24             	mov    %eax,(%esp)
    1a13:	e8 63 1f 00 00       	call   397b <close>
      close(open(file, 0));
    1a18:	58                   	pop    %eax
    1a19:	5a                   	pop    %edx
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 71 1f 00 00       	call   3993 <open>
    1a22:	89 04 24             	mov    %eax,(%esp)
    1a25:	e8 51 1f 00 00       	call   397b <close>
      close(open(file, 0));
    1a2a:	59                   	pop    %ecx
    1a2b:	58                   	pop    %eax
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 5f 1f 00 00       	call   3993 <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 3f 1f 00 00       	call   397b <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 4d 1f 00 00       	call   3993 <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 2d 1f 00 00       	call   397b <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 3a 20 00 00       	call   3ac0 <printf>
      exit();
    1a86:	e8 c8 1e 00 00       	call   3953 <exit>
    ...
    exit();
    1a99:	e8 b5 1e 00 00       	call   3953 <exit>
    ...
    1aac:	e8 0f 20 00 00       	call   3ac0 <printf>
        exit();
    1ab1:	e8 9d 1e 00 00       	call   3953 <exit>
    ...
    1ac4:	e8 f7 1f 00 00       	call   3ac0 <printf>
        exit();
    1ac9:	e8 85 1e 00 00       	call   3953 <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 a4 1e 00 00       	call   397b <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 a2 1e 00 00       	call   39a3 <unlink>
  pid = fork();
    1b01:	e8 45 1e 00 00       	call   394b <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 61 1e 00 00       	call   39a3 <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 18 1e 00 00       	call   3993 <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 f8 1d 00 00       	call   397b <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 c4 1d 00 00       	call   395b <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 f1 1d 00 00       	call   39b3 <link>
    ...
    exit();
    1bd8:	e8 76 1d 00 00       	call   3953 <exit>
    exit();
    1bdd:	e8 71 1d 00 00       	call   3953 <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 92 1d 00 00       	call   39a3 <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 e5 44 00 00       	push   $0x44e5
    1c1d:	e8 71 1d 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 40 1d 00 00       	call   397b <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 47 1d 00 00       	call   39b3 <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 16 1d 00 00       	call   39a3 <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 ec 1c 00 00       	call   39a3 <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 ce 1d 00 00       	call   3ac0 <printf>
      exit();
    1cf2:	e8 5c 1c 00 00       	call   3953 <exit>
    ...
    1d01:	e8 ba 1d 00 00       	call   3ac0 <printf>
      exit();
    1d06:	e8 48 1c 00 00       	call   3953 <exit>
    ...
    exit();
    1d19:	e8 35 1c 00 00       	call   3953 <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 64 1c 00 00       	call   39a3 <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 58 46 00 00 	movl   $0x4658,(%esp)
    1d46:	e8 70 1c 00 00       	call   39bb <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 2b 1c 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 ee 1b 00 00       	call   3973 <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 ee 1b 00 00       	call   397b <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 58 46 00 00 	movl   $0x4658,(%esp)
    1d94:	e8 0a 1c 00 00       	call   39a3 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 0a 1c 00 00       	call   39bb <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 c5 1b 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 88 1b 00 00       	call   3973 <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 88 1b 00 00       	call   397b <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 b2 45 00 00       	push   $0x45b2
    1dfc:	e8 92 1b 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 4a 1b 00 00       	call   396b <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 38 1b 00 00       	call   397b <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 f2 45 00 00       	push   $0x45f2
    1e4a:	68 8e 45 00 00       	push   $0x458e
    1e4f:	e8 5f 1b 00 00       	call   39b3 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 37 1b 00 00       	call   39a3 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 0d 1b 00 00       	call   3993 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 25 1b 00 00       	call   39c3 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 0d 1b 00 00       	call   39c3 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 f5 1a 00 00       	call   39c3 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 dd 1a 00 00       	call   39c3 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 93 1a 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 4b 1a 00 00       	call   396b <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 46 1a 00 00       	call   397b <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 8e 45 00 00       	push   $0x458e
    1f3e:	e8 50 1a 00 00       	call   3993 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 33 1a 00 00       	call   3993 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 16 1a 00 00       	call   3993 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 f9 19 00 00       	call   3993 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 df 19 00 00       	call   3993 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 c5 19 00 00       	call   3993 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 c8 19 00 00       	call   39b3 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 ab 19 00 00       	call   39b3 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 8e 19 00 00       	call   39b3 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 7e 19 00 00       	call   39bb <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 66 19 00 00       	call   39bb <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 4e 19 00 00       	call   39bb <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 1e 19 00 00       	call   39a3 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 06 19 00 00       	call   39a3 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 0e 19 00 00       	call   39c3 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 f6 18 00 00       	call   39c3 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 be 18 00 00       	call   39a3 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 a6 18 00 00       	call   39a3 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 8e 18 00 00       	call   39a3 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 76 18 00 00       	call   39a3 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 5e 18 00 00       	call   39a3 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 d9 17 00 00       	call   3953 <exit>
    ...
    exit();
    2188:	e8 c6 17 00 00       	call   3953 <exit>
    ...
    exit();
    219b:	e8 b3 17 00 00       	call   3953 <exit>
    ...
    exit();
    21ae:	e8 a0 17 00 00       	call   3953 <exit>
    ...
    exit();
    21c1:	e8 8d 17 00 00       	call   3953 <exit>
    ...
    exit();
    21d4:	e8 7a 17 00 00       	call   3953 <exit>
    ...
    exit();
    21e7:	e8 67 17 00 00       	call   3953 <exit>
    ...
    exit();
    21fa:	e8 54 17 00 00       	call   3953 <exit>
    ...
    exit();
    220d:	e8 41 17 00 00       	call   3953 <exit>
    ...
    exit();
    2220:	e8 2e 17 00 00       	call   3953 <exit>
    ...
    exit();
    2233:	e8 1b 17 00 00       	call   3953 <exit>
    ...
    exit();
    2246:	e8 08 17 00 00       	call   3953 <exit>
    ...
    exit();
    2259:	e8 f5 16 00 00       	call   3953 <exit>
    ...
    exit();
    226c:	e8 e2 16 00 00       	call   3953 <exit>
    ...
    exit();
    227f:	e8 cf 16 00 00       	call   3953 <exit>
    ...
    exit();
    2292:	e8 bc 16 00 00       	call   3953 <exit>
    ...
    exit();
    22a5:	e8 a9 16 00 00       	call   3953 <exit>
    ...
    exit();
    22b8:	e8 96 16 00 00       	call   3953 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 83 16 00 00       	call   3953 <exit>
    ...
    exit();
    22de:	e8 70 16 00 00       	call   3953 <exit>
    ...
    exit();
    22f1:	e8 5d 16 00 00       	call   3953 <exit>
    ...
    exit();
    2304:	e8 4a 16 00 00       	call   3953 <exit>
    ...
    exit();
    2317:	e8 37 16 00 00       	call   3953 <exit>
    ...
    exit();
    232a:	e8 24 16 00 00       	call   3953 <exit>
    ...
    exit();
    233d:	e8 11 16 00 00       	call   3953 <exit>
    ...
    exit();
    2350:	e8 fe 15 00 00       	call   3953 <exit>
    ...
    exit();
    2363:	e8 eb 15 00 00       	call   3953 <exit>
    ...
    exit();
    2376:	e8 d8 15 00 00       	call   3953 <exit>
    ...
    exit();
    2389:	e8 c5 15 00 00       	call   3953 <exit>
    ...
    exit();
    239c:	e8 b2 15 00 00       	call   3953 <exit>
    ...
    exit();
    23af:	e8 9f 15 00 00       	call   3953 <exit>
    ...
    exit();
    23c2:	e8 8c 15 00 00       	call   3953 <exit>
    ...
    exit();
    23d5:	e8 79 15 00 00       	call   3953 <exit>
    ...
    exit();
    23e8:	e8 66 15 00 00       	call   3953 <exit>
    ...
    exit();
    23fb:	e8 53 15 00 00       	call   3953 <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 7e 15 00 00       	call   39a3 <unlink>
    ...
    243d:	e8 51 15 00 00       	call   3993 <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 19 15 00 00       	call   3973 <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 03 15 00 00       	call   3973 <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 f5 14 00 00       	call   397b <close>
    unlink("bigwrite");
    2486:	c7 04 24 54 48 00 00 	movl   $0x4854,(%esp)
    248d:	e8 11 15 00 00       	call   39a3 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 fc 15 00 00       	call   3ac0 <printf>
        exit();
    24c4:	e8 8a 14 00 00       	call   3953 <exit>
    ...
    24d3:	e8 e8 15 00 00       	call   3ac0 <printf>
      exit();
    24d8:	e8 76 14 00 00       	call   3953 <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 a2 14 00 00       	call   39a3 <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 b0 48 00 00       	push   $0x48b0
    250d:	e8 81 14 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 0e 14 00 00       	call   397b <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 b0 48 00 00       	push   $0x48b0
    2576:	e8 18 14 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 9a 13 00 00       	call   396b <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 98 13 00 00       	call   397b <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 a4 13 00 00       	call   39a3 <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 99 14 00 00       	call   3ac0 <printf>
      exit();
    2627:	e8 27 13 00 00       	call   3953 <exit>
    ...
    2636:	e8 85 14 00 00       	call   3ac0 <printf>
      exit();
    263b:	e8 13 13 00 00       	call   3953 <exit>
    ...
    264a:	e8 71 14 00 00       	call   3ac0 <printf>
      exit();
    264f:	e8 ff 12 00 00       	call   3953 <exit>
    ...
    265e:	e8 5d 14 00 00       	call   3ac0 <printf>
      exit();
    2663:	e8 eb 12 00 00       	call   3953 <exit>
    ...
    exit();
    2676:	e8 d8 12 00 00       	call   3953 <exit>
    ...
    exit();
    2689:	e8 c5 12 00 00       	call   3953 <exit>
    ...
    exit();
    269c:	e8 b2 12 00 00       	call   3953 <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 ed 12 00 00       	call   39bb <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 d5 12 00 00       	call   39bb <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 90 12 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 64 12 00 00       	call   397b <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 08 52 00 00       	push   $0x5208
    2720:	e8 6e 12 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 46 12 00 00       	call   397b <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 7c 49 00 00 	movl   $0x497c,(%esp)
    273c:	e8 7a 12 00 00       	call   39bb <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 66 12 00 00       	call   39bb <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 d0 11 00 00       	call   3953 <exit>
    ...
    exit();
    2791:	e8 bd 11 00 00       	call   3953 <exit>
    ...
    exit();
    27a4:	e8 aa 11 00 00       	call   3953 <exit>
    ...
    exit();
    27b7:	e8 97 11 00 00       	call   3953 <exit>
    ...
    exit();
    27ca:	e8 84 11 00 00       	call   3953 <exit>
    ...
    exit();
    27dd:	e8 71 11 00 00       	call   3953 <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 ad 11 00 00       	call   39bb <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 9d 11 00 00       	call   39c3 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 65 11 00 00       	call   39a3 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 4d 11 00 00       	call   39a3 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 55 11 00 00       	call   39c3 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 1d 11 00 00       	call   39a3 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 09 11 00 00       	call   39a3 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 f5 10 00 00       	call   39a3 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 77 10 00 00       	call   3953 <exit>
    ...
    exit();
    28ea:	e8 64 10 00 00       	call   3953 <exit>
    ...
    exit();
    28fd:	e8 51 10 00 00       	call   3953 <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 3e 10 00 00       	call   3953 <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 2b 10 00 00       	call   3953 <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 18 10 00 00       	call   3953 <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 05 10 00 00       	call   3953 <exit>
    ...
    exit();
    295c:	e8 f2 0f 00 00       	call   3953 <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 ff 0f 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 d3 0f 00 00       	call   397b <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 65 4a 00 00 	movl   $0x4a65,(%esp)
    29af:	e8 0f 10 00 00       	call   39c3 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 c5 0f 00 00       	call   3993 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 a8 0f 00 00       	call   3993 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 b8 0f 00 00       	call   39bb <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 88 0f 00 00       	call   39a3 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 7b 0f 00 00       	call   39b3 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 53 0f 00 00       	call   39a3 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 29 0f 00 00       	call   3993 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 0f 0f 00 00       	call   3993 <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 dd 0e 00 00       	call   3973 <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 d5 0e 00 00       	call   397b <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 84 0e 00 00       	call   3953 <exit>
    ...
    exit();
    2add:	e8 71 0e 00 00       	call   3953 <exit>
    ...
    exit();
    2af0:	e8 5e 0e 00 00       	call   3953 <exit>
    ...
    exit();
    2b03:	e8 4b 0e 00 00       	call   3953 <exit>
    ...
    exit();
    2b16:	e8 38 0e 00 00       	call   3953 <exit>
    ...
    exit();
    2b29:	e8 25 0e 00 00       	call   3953 <exit>
    ...
    exit();
    2b3c:	e8 12 0e 00 00       	call   3953 <exit>
    ...
    exit();
    2b4f:	e8 ff 0d 00 00       	call   3953 <exit>
    ...
    exit();
    2b62:	e8 ec 0d 00 00       	call   3953 <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 1e 0e 00 00       	call   39bb <mkdir>
    ...
    2bb0:	e8 0e 0e 00 00       	call   39c3 <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 57 0d 00 00       	call   397b <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 40 47 00 00       	push   $0x4740
    2c2f:	e8 6f 0d 00 00       	call   39a3 <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 76 0d 00 00       	call   39c3 <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 4e 0e 00 00       	call   3ac0 <printf>
      exit();
    2c72:	e8 dc 0c 00 00       	call   3953 <exit>
    ...
    2c81:	e8 3a 0e 00 00       	call   3ac0 <printf>
      exit();
    2c86:	e8 c8 0c 00 00       	call   3953 <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 89 0c 00 00       	call   394b <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 86 0c 00 00       	call   395b <wait>
  ...
  if(wait() != -1){
    2cde:	e8 78 0c 00 00       	call   395b <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 52 0c 00 00       	call   3953 <exit>
    ...
    2d0b:	e8 b0 0d 00 00       	call   3ac0 <printf>
      exit();
    2d10:	e8 3e 0c 00 00       	call   3953 <exit>
    ...
    exit();
    2d23:	e8 2b 0c 00 00       	call   3953 <exit>
    ...
    exit();
    2d36:	e8 18 0c 00 00       	call   3953 <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 4f 0c 00 00       	call   39db <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 9e 0b 00 00       	call   394b <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 17 0c 00 00       	call   39db <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 0b 0c 00 00       	call   39db <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 73 0b 00 00       	call   395b <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 e9 0b 00 00       	call   39db <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 d8 0b 00 00       	call   39db <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2e11:	6a 00                	push   $0x0
    2e13:	e8 c3 0b 00 00       	call   39db <sbrk>
  c = sbrk(-4096);
    2e18:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e1f:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e21:	e8 b5 0b 00 00       	call   39db <sbrk>
  ...
  c = sbrk(0);
    ...
    2e35:	6a 00                	push   $0x0
    2e37:	e8 9f 0b 00 00       	call   39db <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e50:	6a 00                	push   $0x0
    2e52:	e8 84 0b 00 00       	call   39db <sbrk>
  c = sbrk(4096);
    2e57:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e5e:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e60:	e8 76 0b 00 00       	call   39db <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e75:	6a 00                	push   $0x0
    2e77:	e8 5f 0b 00 00       	call   39db <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ed8:	e8 f6 0a 00 00       	call   39d3 <getpid>
    2edd:	89 c6                	mov    %eax,%esi
    pid = fork();
    2edf:	e8 67 0a 00 00       	call   394b <fork>
    if(pid < 0){
    ...
    wait();
    2ef2:	e8 64 0a 00 00       	call   395b <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f0b:	50                   	push   %eax
    2f0c:	e8 52 0a 00 00       	call   3963 <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f28:	e8 1e 0a 00 00       	call   394b <fork>
    ...
    2f48:	e8 1e 0a 00 00       	call   396b <read>
  ...
  c = sbrk(4096);
    ...
    2f5f:	e8 77 0a 00 00       	call   39db <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 03 0a 00 00       	call   3983 <kill>
    wait();
    2f80:	e8 d6 09 00 00       	call   395b <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f9b:	6a 00                	push   $0x0
    2f9d:	e8 39 0a 00 00       	call   39db <sbrk>
    2fa2:	83 c4 10             	add    $0x10,%esp
    2fa5:	39 45 a4             	cmp    %eax,-0x5c(%ebp)
    2fa8:	72 68                	jb     3012 <sbrktest+0x2d2>
  printf(stdout, "sbrk test OK\n");
    2faa:	83 ec 08             	sub    $0x8,%esp
    2fad:	68 80 4c 00 00       	push   $0x4c80
    2fb2:	ff 35 80 5f 00 00    	push   0x5f80
    2fb8:	e8 03 0b 00 00       	call   3ac0 <printf>
}
    ...
    exit();
    310c:	e8 42 08 00 00       	call   3953 <exit>
    exit();
    3111:	e8 3d 08 00 00       	call   3953 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 15 4c 00 00       	push   $0x4c15
    311d:	ff 35 80 5f 00 00    	push   0x5f80
    3123:	e8 98 09 00 00       	call   3ac0 <printf>
    exit();
    3128:	e8 26 08 00 00       	call   3953 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 d4 53 00 00       	push   $0x53d4
    3134:	ff 35 80 5f 00 00    	push   0x5f80
    313a:	e8 81 09 00 00       	call   3ac0 <printf>
    exit();
    313f:	e8 0f 08 00 00       	call   3953 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 9c 53 00 00       	push   $0x539c
    314b:	ff 35 80 5f 00 00    	push   0x5f80
    3151:	e8 6a 09 00 00       	call   3ac0 <printf>
    exit();
    3156:	e8 f8 07 00 00       	call   3953 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 31 4c 00 00       	push   $0x4c31
    3162:	ff 35 80 5f 00 00    	push   0x5f80
    3168:	e8 53 09 00 00       	call   3ac0 <printf>
    exit();
    316d:	e8 e1 07 00 00       	call   3953 <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 1e 08 00 00       	call   39e3 <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 12 08 00 00       	call   39e3 <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 aa 07 00 00       	call   3983 <kill>
    wait();
    31d9:	e8 7d 07 00 00       	call   395b <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 9d 4c 00 00       	push   $0x4c9d
    31e6:	e8 c8 07 00 00       	call   39b3 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 80 5f 00 00    	push   0x5f80
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 30 07 00 00       	call   3953 <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 a8 4c 00 00       	push   $0x4ca8
    322b:	ff 35 80 5f 00 00    	push   0x5f80
    3231:	e8 8a 08 00 00       	call   3ac0 <printf>
      exit();
    3236:	e8 18 07 00 00       	call   3953 <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 80 5f 00 00    	push   0x5f80
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 80 5f 00 00    	push   0x5f80
    ...
    3293:	ff 35 80 5f 00 00    	push   0x5f80
    3299:	e8 22 08 00 00       	call   3ac0 <printf>
      exit();
    329e:	e8 b0 06 00 00       	call   3953 <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 e3 06 00 00       	call   39a3 <unlink>
  pid = fork();
    32c0:	e8 86 06 00 00       	call   394b <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 84 06 00 00       	call   395b <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 f6 4c 00 00       	push   $0x4cf6
    32e1:	e8 ad 06 00 00       	call   3993 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    32f4:	50                   	push   %eax
    32f5:	e8 81 06 00 00       	call   397b <close>
  unlink("bigarg-ok");
    32fa:	c7 04 24 f6 4c 00 00 	movl   $0x4cf6,(%esp)
    3301:	e8 9d 06 00 00       	call   39a3 <unlink>
}
    ...
    3310:	c7 04 85 c0 a6 00 00 	movl   $0x5450,0xa6c0(,%eax,4)
    3317:	50 54 00 00 
    ...
    332a:	ff 35 80 5f 00 00    	push   0x5f80
    args[MAXARG-1] = 0;
    ...
    334b:	e8 3b 06 00 00       	call   398b <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 0d 4d 00 00       	push   $0x4d0d
    3357:	ff 35 80 5f 00 00    	push   0x5f80
    ...
    336e:	e8 20 06 00 00       	call   3993 <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 00 06 00 00       	call   397b <close>
    exit();
    337b:	e8 d3 05 00 00       	call   3953 <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 36 4d 00 00       	push   $0x4d36
    3387:	ff 35 80 5f 00 00    	push   0x5f80
    338d:	e8 2e 07 00 00       	call   3ac0 <printf>
    exit();
    3392:	e8 bc 05 00 00       	call   3953 <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 1d 4d 00 00       	push   $0x4d1d
    339e:	ff 35 80 5f 00 00    	push   0x5f80
    33a4:	e8 17 07 00 00       	call   3ac0 <printf>
    exit();
    33a9:	e8 a5 05 00 00       	call   3953 <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 35 05 00 00       	call   3993 <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 ee 04 00 00       	call   3973 <write>
      if(cc < 512)
    ...
    34a2:	e8 d4 04 00 00       	call   397b <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 52 04 00 00       	call   39a3 <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 b4 03 00 00       	call   394b <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 b6 03 00 00       	call   395b <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 76 03 00 00       	call   3953 <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 63 03 00 00       	call   3953 <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 90 03 00 00       	call   3993 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 c5 03 00 00       	call   39db <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 46 03 00 00       	call   396b <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 4e 03 00 00       	call   397b <close>
...
int test_and_set(int *old_ptr, int new_ptr) {
  ...
  *old_ptr = new_ptr;
  ...
  int old = *old_ptr;
    3689:	8b 10                	mov    (%eax),%edx
  *old_ptr = new_ptr;
    368b:	89 08                	mov    %ecx,(%eax)
  return old;
}
    368d:	5d                   	pop    %ebp
...
int thread_join() {
  return 0;
    ...
    36b2:	c3                   	ret    
    36b3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    36ba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

000036c0 <lock_acquire>:
...
void lock_acquire(lock_t *lock){
  ...
  while(test_and_set(&lock->flag, 1) == 1)
    36c6:	83 38 01             	cmpl   $0x1,(%eax)
    36c9:	75 05                	jne    36d0 <lock_acquire+0x10>
    36cb:	eb fe                	jmp    36cb <lock_acquire+0xb>
    36cd:	8d 76 00             	lea    0x0(%esi),%esi
    36d0:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
    36d6:	5d                   	pop    %ebp
    36d7:	c3                   	ret    
    36d8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    36df:	90                   	nop

000036e0 <lock_release>:
...
void lock_release(lock_t *lock) {
  ...
  lock->flag = 0;
    ...
    36e6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
    36ec:	5d                   	pop    %ebp
    36ed:	c3                   	ret    
...
000036f0 <lock_init>:
    ...
    36f6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    36fc:	5d                   	pop    %ebp
    36fd:	c3                   	ret    
    ...
    3701:	31 c0                	xor    %eax,%eax
{
  ...
  return os;
    ...
    371e:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3721:	89 c8                	mov    %ecx,%eax
    3723:	c9                   	leave  
    3724:	c3                   	ret    
    3725:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
strcmp(const char *p, const char *q)
{
  ...
  while(*p && *p == *q)
    ...
    373f:	75 17                	jne    3758 <strcmp+0x28>
    3741:	eb 3a                	jmp    377d <strcmp+0x4d>
    3743:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    3747:	90                   	nop
    3748:	0f b6 42 01          	movzbl 0x1(%edx),%eax
    p++, q++;
    374c:	83 c2 01             	add    $0x1,%edx
    374f:	8d 59 01             	lea    0x1(%ecx),%ebx
  while(*p && *p == *q)
    3752:	84 c0                	test   %al,%al
    3754:	74 1a                	je     3770 <strcmp+0x40>
    p++, q++;
    3756:	89 d9                	mov    %ebx,%ecx
  while(*p && *p == *q)
    3758:	0f b6 19             	movzbl (%ecx),%ebx
    375b:	38 c3                	cmp    %al,%bl
    375d:	74 e9                	je     3748 <strcmp+0x18>
  return (uchar)*p - (uchar)*q;
    375f:	29 d8                	sub    %ebx,%eax
}
    3761:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3764:	c9                   	leave  
    3765:	c3                   	ret    
    3766:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    376d:	8d 76 00             	lea    0x0(%esi),%esi
  return (uchar)*p - (uchar)*q;
    3770:	0f b6 59 01          	movzbl 0x1(%ecx),%ebx
    3774:	31 c0                	xor    %eax,%eax
    3776:	29 d8                	sub    %ebx,%eax
}
    3778:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    377b:	c9                   	leave  
    377c:	c3                   	ret    
  return (uchar)*p - (uchar)*q;
    377d:	0f b6 19             	movzbl (%ecx),%ebx
    3780:	31 c0                	xor    %eax,%eax
    3782:	eb db                	jmp    375f <strcmp+0x2f>
...
strlen(const char *s)
{
    ...
    3793:	8b 55 08             	mov    0x8(%ebp),%edx
  int n;

  for(n = 0; s[n]; n++)
    3796:	80 3a 00             	cmpb   $0x0,(%edx)
    3799:	74 15                	je     37b0 <strlen+0x20>
    379b:	31 c0                	xor    %eax,%eax
    379d:	8d 76 00             	lea    0x0(%esi),%esi
    37a0:	83 c0 01             	add    $0x1,%eax
    37a3:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
    37a7:	89 c1                	mov    %eax,%ecx
    37a9:	75 f5                	jne    37a0 <strlen+0x10>
    ;
  return n;
}
    37ab:	89 c8                	mov    %ecx,%eax
    37ad:	5d                   	pop    %ebp
    37ae:	c3                   	ret    
    37af:	90                   	nop
  for(n = 0; s[n]; n++)
...
stosb(void *addr, int data, int cnt)
{
  asm volatile("cld; rep stosb" :
    37c7:	8b 4d 10             	mov    0x10(%ebp),%ecx
    37ca:	8b 45 0c             	mov    0xc(%ebp),%eax
    37cd:	89 d7                	mov    %edx,%edi
    37cf:	fc                   	cld    
    37d0:	f3 aa                	rep stos %al,%es:(%edi)
  stosb(dst, c, n);
  return dst;
}
    37d2:	8b 7d fc             	mov    -0x4(%ebp),%edi
    37d5:	89 d0                	mov    %edx,%eax
    37d7:	c9                   	leave  
    37d8:	c3                   	ret    
...
strchr(const char *s, char c)
{
    ...
    37e6:	0f b6 4d 0c          	movzbl 0xc(%ebp),%ecx
  for(; *s; s++)
    37ea:	0f b6 10             	movzbl (%eax),%edx
    37ed:	84 d2                	test   %dl,%dl
    37ef:	75 12                	jne    3803 <strchr+0x23>
    37f1:	eb 1d                	jmp    3810 <strchr+0x30>
    37f3:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    37f7:	90                   	nop
    37f8:	0f b6 50 01          	movzbl 0x1(%eax),%edx
    37fc:	83 c0 01             	add    $0x1,%eax
    37ff:	84 d2                	test   %dl,%dl
    3801:	74 0d                	je     3810 <strchr+0x30>
    if(*s == c)
    3803:	38 d1                	cmp    %dl,%cl
    3805:	75 f1                	jne    37f8 <strchr+0x18>
      return (char*)s;
  return 0;
}
    3807:	5d                   	pop    %ebp
  ...
  return 0;
    ...
    3812:	5d                   	pop    %ebp
    3813:	c3                   	ret    
    3814:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    cc = read(0, &c, 1);
    3825:	8d 7d e7             	lea    -0x19(%ebp),%edi
{
    3828:	53                   	push   %ebx
  for(i=0; i+1 < max; ){
    3829:	31 db                	xor    %ebx,%ebx
{
    382b:	83 ec 1c             	sub    $0x1c,%esp
  for(i=0; i+1 < max; ){
    382e:	eb 27                	jmp    3857 <gets+0x37>
    cc = read(0, &c, 1);
    3830:	83 ec 04             	sub    $0x4,%esp
    3833:	6a 01                	push   $0x1
    3835:	57                   	push   %edi
    3836:	6a 00                	push   $0x0
    3838:	e8 2e 01 00 00       	call   396b <read>
    if(cc < 1)
    383d:	83 c4 10             	add    $0x10,%esp
    3840:	85 c0                	test   %eax,%eax
    3842:	7e 1d                	jle    3861 <gets+0x41>
      break;
    buf[i++] = c;
    3844:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
    3848:	8b 55 08             	mov    0x8(%ebp),%edx
    384b:	88 44 1a ff          	mov    %al,-0x1(%edx,%ebx,1)
    if(c == '\n' || c == '\r')
    384f:	3c 0a                	cmp    $0xa,%al
    3851:	74 1d                	je     3870 <gets+0x50>
    3853:	3c 0d                	cmp    $0xd,%al
    3855:	74 19                	je     3870 <gets+0x50>
  for(i=0; i+1 < max; ){
    3857:	89 de                	mov    %ebx,%esi
    3859:	83 c3 01             	add    $0x1,%ebx
    385c:	3b 5d 0c             	cmp    0xc(%ebp),%ebx
    385f:	7c cf                	jl     3830 <gets+0x10>
      break;
  }
  buf[i] = '\0';
    3861:	8b 45 08             	mov    0x8(%ebp),%eax
    3864:	c6 04 30 00          	movb   $0x0,(%eax,%esi,1)
  return buf;
}
    3868:	8d 65 f4             	lea    -0xc(%ebp),%esp
    386b:	5b                   	pop    %ebx
    386c:	5e                   	pop    %esi
    386d:	5f                   	pop    %edi
    386e:	5d                   	pop    %ebp
  ...
  buf[i] = '\0';
    ...
    3873:	89 de                	mov    %ebx,%esi
    3875:	c6 04 30 00          	movb   $0x0,(%eax,%esi,1)
}
    3879:	8d 65 f4             	lea    -0xc(%ebp),%esp
    387c:	5b                   	pop    %ebx
    387d:	5e                   	pop    %esi
    387e:	5f                   	pop    %edi
    387f:	5d                   	pop    %ebp
    3880:	c3                   	ret    
    3881:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    3898:	6a 00                	push   $0x0
    389a:	ff 75 08             	push   0x8(%ebp)
    389d:	e8 f1 00 00 00       	call   3993 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    38ac:	ff 75 0c             	push   0xc(%ebp)
    38af:	89 c3                	mov    %eax,%ebx
    38b1:	50                   	push   %eax
    38b2:	e8 f4 00 00 00       	call   39ab <fstat>
  close(fd);
    38b7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    38ba:	89 c6                	mov    %eax,%esi
  close(fd);
    38bc:	e8 ba 00 00 00       	call   397b <close>
  return r;
...
atoi(const char *s)
{
    ...
    38e3:	53                   	push   %ebx
    38e4:	8b 55 08             	mov    0x8(%ebp),%edx
  int n;

  n = 0;
  while('0' <= *s && *s <= '9')
    38e7:	0f be 02             	movsbl (%edx),%eax
    38ea:	8d 48 d0             	lea    -0x30(%eax),%ecx
    38ed:	80 f9 09             	cmp    $0x9,%cl
  n = 0;
    38f0:	b9 00 00 00 00       	mov    $0x0,%ecx
  while('0' <= *s && *s <= '9')
    38f5:	77 1e                	ja     3915 <atoi+0x35>
    38f7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    38fe:	66 90                	xchg   %ax,%ax
    n = n*10 + *s++ - '0';
    3900:	83 c2 01             	add    $0x1,%edx
    3903:	8d 0c 89             	lea    (%ecx,%ecx,4),%ecx
    3906:	8d 4c 48 d0          	lea    -0x30(%eax,%ecx,2),%ecx
  while('0' <= *s && *s <= '9')
    390a:	0f be 02             	movsbl (%edx),%eax
    390d:	8d 58 d0             	lea    -0x30(%eax),%ebx
...
memmove(void *vdst, const void *vsrc, int n)
{
    ...
    3923:	57                   	push   %edi
    3924:	8b 45 10             	mov    0x10(%ebp),%eax
    3927:	8b 55 08             	mov    0x8(%ebp),%edx
    392a:	56                   	push   %esi
  ...
  src = vsrc;
  while(n-- > 0)
    392e:	85 c0                	test   %eax,%eax
    3930:	7e 13                	jle    3945 <memmove+0x25>
    3932:	01 d0                	add    %edx,%eax
  dst = vdst;
    3934:	89 d7                	mov    %edx,%edi
    3936:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    393d:	8d 76 00             	lea    0x0(%esi),%esi
    *dst++ = *src++;
    3940:	a4                   	movsb  %ds:(%esi),%es:(%edi)
  while(n-- > 0)
    3941:	39 f8                	cmp    %edi,%eax
    3943:	75 fb                	jne    3940 <memmove+0x20>
  return vdst;
}
    3945:	5e                   	pop    %esi
...
SYSCALL(fork)
    394b:	b8 01 00 00 00       	mov    $0x1,%eax
    3950:	cd 40                	int    $0x40
    3952:	c3                   	ret    

00003953 <exit>:
SYSCALL(exit)
    3953:	b8 02 00 00 00       	mov    $0x2,%eax
    3958:	cd 40                	int    $0x40
    395a:	c3                   	ret    

0000395b <wait>:
SYSCALL(wait)
    395b:	b8 03 00 00 00       	mov    $0x3,%eax
    3960:	cd 40                	int    $0x40
    3962:	c3                   	ret    

00003963 <pipe>:
SYSCALL(pipe)
    3963:	b8 04 00 00 00       	mov    $0x4,%eax
    3968:	cd 40                	int    $0x40
    396a:	c3                   	ret    

0000396b <read>:
SYSCALL(read)
    396b:	b8 05 00 00 00       	mov    $0x5,%eax
    3970:	cd 40                	int    $0x40
    3972:	c3                   	ret    

00003973 <write>:
SYSCALL(write)
    3973:	b8 10 00 00 00       	mov    $0x10,%eax
    3978:	cd 40                	int    $0x40
    397a:	c3                   	ret    

0000397b <close>:
SYSCALL(close)
    397b:	b8 15 00 00 00       	mov    $0x15,%eax
    3980:	cd 40                	int    $0x40
    3982:	c3                   	ret    

00003983 <kill>:
SYSCALL(kill)
    3983:	b8 06 00 00 00       	mov    $0x6,%eax
    3988:	cd 40                	int    $0x40
    398a:	c3                   	ret    

0000398b <exec>:
SYSCALL(exec)
    398b:	b8 07 00 00 00       	mov    $0x7,%eax
    3990:	cd 40                	int    $0x40
    3992:	c3                   	ret    

00003993 <open>:
SYSCALL(open)
    3993:	b8 0f 00 00 00       	mov    $0xf,%eax
    3998:	cd 40                	int    $0x40
    399a:	c3                   	ret    

0000399b <mknod>:
SYSCALL(mknod)
    399b:	b8 11 00 00 00       	mov    $0x11,%eax
    39a0:	cd 40                	int    $0x40
    39a2:	c3                   	ret    

000039a3 <unlink>:
SYSCALL(unlink)
    39a3:	b8 12 00 00 00       	mov    $0x12,%eax
    39a8:	cd 40                	int    $0x40
    39aa:	c3                   	ret    

000039ab <fstat>:
SYSCALL(fstat)
    39ab:	b8 08 00 00 00       	mov    $0x8,%eax
    39b0:	cd 40                	int    $0x40
    39b2:	c3                   	ret    

000039b3 <link>:
SYSCALL(link)
    39b3:	b8 13 00 00 00       	mov    $0x13,%eax
    39b8:	cd 40                	int    $0x40
    39ba:	c3                   	ret    

000039bb <mkdir>:
SYSCALL(mkdir)
    39bb:	b8 14 00 00 00       	mov    $0x14,%eax
    39c0:	cd 40                	int    $0x40
    39c2:	c3                   	ret    
...
000039cb <dup>:
SYSCALL(dup)
    39cb:	b8 0a 00 00 00       	mov    $0xa,%eax
    39d0:	cd 40                	int    $0x40
    39d2:	c3                   	ret    

000039d3 <getpid>:
SYSCALL(getpid)
    39d3:	b8 0b 00 00 00       	mov    $0xb,%eax
    39d8:	cd 40                	int    $0x40
    39da:	c3                   	ret    

000039db <sbrk>:
SYSCALL(sbrk)
    39db:	b8 0c 00 00 00       	mov    $0xc,%eax
    39e0:	cd 40                	int    $0x40
    39e2:	c3                   	ret    

000039e3 <sleep>:
SYSCALL(sleep)
    39e3:	b8 0d 00 00 00       	mov    $0xd,%eax
    39e8:	cd 40                	int    $0x40
    39ea:	c3                   	ret    

000039eb <uptime>:
SYSCALL(uptime)
    39eb:	b8 0e 00 00 00       	mov    $0xe,%eax
    39f0:	cd 40                	int    $0x40
    39f2:	c3                   	ret    

000039f3 <clone>:
SYSCALL(clone)
    39f3:	b8 16 00 00 00       	mov    $0x16,%eax
    39f8:	cd 40                	int    $0x40
    39fa:	c3                   	ret    

000039fb <join>:
    39fb:	b8 17 00 00 00       	mov    $0x17,%eax
    3a00:	cd 40                	int    $0x40
    3a02:	c3                   	ret    
    3a03:	66 90                	xchg   %ax,%ax
    3a05:	66 90                	xchg   %ax,%ax
    3a07:	66 90                	xchg   %ax,%ax
    3a09:	66 90                	xchg   %ax,%ax
    3a0b:	66 90                	xchg   %ax,%ax
    ...
    3a1c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3a8e:	56                   	push   %esi
    3a8f:	57                   	push   %edi
    3a90:	e8 de fe ff ff       	call   3973 <write>
  while(--i >= 0)
    ...
    3ac9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3b05:	57                   	push   %edi
    3b06:	56                   	push   %esi
    3b07:	e8 67 fe ff ff       	call   3973 <write>
  ...
  write(fd, &c, 1);
    ...
    3b5e:	e8 10 fe ff ff       	call   3973 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b6f:	57                   	push   %edi
    3b70:	56                   	push   %esi
    3b71:	e8 fd fd ff ff       	call   3973 <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3bdb:	57                   	push   %edi
    3bdc:	56                   	push   %esi
    3bdd:	e8 91 fd ff ff       	call   3973 <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3c1f:	e8 4f fd ff ff       	call   3973 <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c61:	a1 40 a7 00 00       	mov    0xa740,%eax
{
  ...
  freep = p;
    ...
    3ca1:	5b                   	pop    %ebx
  freep = p;
    3ca2:	89 15 40 a7 00 00    	mov    %edx,0xa740
}
    3ca8:	5e                   	pop    %esi
    3ca9:	5f                   	pop    %edi
    3caa:	5d                   	pop    %ebp
  ...
  freep = p;
    3cdc:	89 15 40 a7 00 00    	mov    %edx,0xa740
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3cfc:	8b 3d 40 a7 00 00    	mov    0xa740,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  return freep;
    3d6f:	8b 15 40 a7 00 00    	mov    0xa740,%edx
    ...
    3d9c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3d9f:	89 15 40 a7 00 00    	mov    %edx,0xa740
}
    ...
    3daf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3db0:	c7 05 40 a7 00 00 44 	movl   $0xa744,0xa740
    3db7:	a7 00 00 
    base.s.size = 0;
    3dba:	bf 44 a7 00 00       	mov    $0xa744,%edi
    base.s.ptr = freep = prevp = &base;
    3dbf:	c7 05 44 a7 00 00 44 	movl   $0xa744,0xa744
    3dc6:	a7 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3dc9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3dcb:	c7 05 48 a7 00 00 00 	movl   $0x0,0xa748
    3dd2:	00 00 00 
    if(p->s.size >= nunits){
