...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 57 04 00 00       	call   493 <open>
  ...
  59:	e8 1d 04 00 00       	call   47b <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 e8 03 00 00       	call   453 <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  ...
  75:	e8 46 05 00 00       	call   5c0 <printf>
      exit();
  7a:	e8 d4 03 00 00       	call   453 <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 c1 03 00 00       	call   453 <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 96 03 00 00       	call   46b <read>
 ...
 10f:	e8 cc 01 00 00       	call   2e0 <strchr>
 ...
 16f:	e8 4c 04 00 00       	call   5c0 <printf>
    exit();
 174:	e8 da 02 00 00       	call   453 <exit>
...
free(void *ap)
{
 ...
 761:	a1 20 0f 00 00       	mov    0xf20,%eax
{
 ...
 7a1:	5b                   	pop    %ebx
  freep = p;
 7a2:	89 15 20 0f 00 00    	mov    %edx,0xf20
}
 7a8:	5e                   	pop    %esi
 7a9:	5f                   	pop    %edi
 7aa:	5d                   	pop    %ebp
 ...
 7d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 7dc:	89 15 20 0f 00 00    	mov    %edx,0xf20
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7fc:	8b 3d 20 0f 00 00    	mov    0xf20,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 83f:	73 4f                	jae    890 <malloc+0xa0>
    ...
    if(p == freep)
 841:	8b 3d 20 0f 00 00    	mov    0xf20,%edi
 ...
 86a:	e8 f1 fe ff ff       	call   760 <free>
  return freep;
 86f:	8b 15 20 0f 00 00    	mov    0xf20,%edx
 ...
 89c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 89f:	89 15 20 0f 00 00    	mov    %edx,0xf20
}
 ...
 8af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8b0:	c7 05 20 0f 00 00 24 	movl   $0xf24,0xf20
 8b7:	0f 00 00 
    base.s.size = 0;
 8ba:	bf 24 0f 00 00       	mov    $0xf24,%edi
    base.s.ptr = freep = prevp = &base;
 8bf:	c7 05 24 0f 00 00 24 	movl   $0xf24,0xf24
 8c6:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8cb:	c7 05 28 0f 00 00 00 	movl   $0x0,0xf28
 8d2:	00 00 00 
    if(p->s.size >= nunits){
