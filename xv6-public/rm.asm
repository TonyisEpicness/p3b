...
main(int argc, char *argv[])
{
  ...
  4c:	ff 36                	push   (%esi)
  4e:	e8 17 03 00 00       	call   36a <unlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 420:	0f b6 92 a8 07 00 00 	movzbl 0x7a8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 4ed:	ff 24 85 50 07 00 00 	jmp    *0x750(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 552:	75 15                	jne    569 <printf+0xfa>
          s = "(null)";
 554:	be 49 07 00 00       	mov    $0x749,%esi
