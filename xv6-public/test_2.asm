...
main(int argc, char *argv[])
{
  ...
  10:	83 ec 1c             	sub    $0x1c,%esp
   ppid = getpid();
  13:	e8 4b 05 00 00       	call   563 <getpid>
   void *stack, *p = malloc(PGSIZE * 2);
  18:	83 ec 0c             	sub    $0xc,%esp
  1b:	68 00 20 00 00       	push   $0x2000
   ppid = getpid();
  20:	a3 e8 0d 00 00       	mov    %eax,0xde8
   void *stack, *p = malloc(PGSIZE * 2);
  ...
  45:	50                   	push   %eax
  46:	68 e0 0d 00 00       	push   $0xde0
  4b:	68 e4 0d 00 00       	push   $0xde4
  50:	68 90 01 00 00       	push   $0x190
  55:	e8 29 05 00 00       	call   583 <clone>
   assert(clone_pid > 0);
  ...
  6e:	66 90                	xchg   %ax,%ax
   while(global != 33);
  70:	a1 dc 0d 00 00       	mov    0xddc,%eax
  75:	83 f8 21             	cmp    $0x21,%eax
  78:	75 f6                	jne    70 <main+0x70>
   assert(arg1 == 44);
  7a:	a1 e4 0d 00 00       	mov    0xde4,%eax
  7f:	83 f8 2c             	cmp    $0x2c,%eax
  82:	75 60                	jne    e4 <main+0xe4>
   assert(arg2 == 55);
  84:	a1 e0 0d 00 00       	mov    0xde0,%eax
  89:	83 f8 37             	cmp    $0x37,%eax
  8c:	0f 84 ac 00 00 00    	je     13e <main+0x13e>
  92:	6a 28                	push   $0x28
  94:	68 78 09 00 00       	push   $0x978
  99:	68 81 09 00 00       	push   $0x981
  9e:	6a 01                	push   $0x1
  a0:	e8 ab 05 00 00       	call   650 <printf>
  a5:	83 c4 0c             	add    $0xc,%esp
  a8:	68 d9 09 00 00       	push   $0x9d9
   assert(clone_pid > 0);
  ad:	68 95 09 00 00       	push   $0x995
  b2:	6a 01                	push   $0x1
  b4:	e8 97 05 00 00       	call   650 <printf>
  b9:	5a                   	pop    %edx
  ba:	59                   	pop    %ecx
  bb:	68 a9 09 00 00       	push   $0x9a9
  c0:	6a 01                	push   $0x1
  c2:	e8 89 05 00 00       	call   650 <printf>
  c7:	5b                   	pop    %ebx
  c8:	ff 35 e8 0d 00 00    	push   0xde8
  ce:	e8 40 04 00 00       	call   513 <kill>
  d3:	e8 0b 04 00 00       	call   4e3 <exit>
     stack = p + (PGSIZE - (uint)p % PGSIZE);
  ...
  df:	e9 61 ff ff ff       	jmp    45 <main+0x45>
   assert(arg1 == 44);
  e4:	6a 27                	push   $0x27
  e6:	68 78 09 00 00       	push   $0x978
  eb:	68 81 09 00 00       	push   $0x981
  f0:	6a 01                	push   $0x1
  f2:	e8 59 05 00 00       	call   650 <printf>
  f7:	83 c4 0c             	add    $0xc,%esp
  fa:	68 ce 09 00 00       	push   $0x9ce
  ff:	eb ac                	jmp    ad <main+0xad>
   assert(clone_pid > 0);
 101:	6a 25                	push   $0x25
 103:	68 78 09 00 00       	push   $0x978
 108:	68 81 09 00 00       	push   $0x981
 10d:	6a 01                	push   $0x1
 10f:	e8 3c 05 00 00       	call   650 <printf>
 114:	83 c4 0c             	add    $0xc,%esp
 117:	68 c0 09 00 00       	push   $0x9c0
 11c:	eb 8f                	jmp    ad <main+0xad>
   assert(p != NULL);
 11e:	6a 1e                	push   $0x1e
 120:	68 78 09 00 00       	push   $0x978
 125:	68 81 09 00 00       	push   $0x981
 12a:	6a 01                	push   $0x1
 12c:	e8 1f 05 00 00       	call   650 <printf>
 131:	83 c4 0c             	add    $0xc,%esp
 134:	68 b6 09 00 00       	push   $0x9b6
 139:	e9 6f ff ff ff       	jmp    ad <main+0xad>
   printf(1, "TEST PASSED\n");
 13e:	50                   	push   %eax
 13f:	50                   	push   %eax
 140:	68 e4 09 00 00       	push   $0x9e4
 145:	6a 01                	push   $0x1
 147:	e8 04 05 00 00       	call   650 <printf>
   
   void *join_stack;
   int join_pid = join(&join_stack);
 14c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
 14f:	89 04 24             	mov    %eax,(%esp)
 152:	e8 34 04 00 00       	call   58b <join>
 ...
 174:	68 f1 09 00 00       	push   $0x9f1
 179:	e9 2f ff ff ff       	jmp    ad <main+0xad>
   free(p);
 17e:	83 ec 0c             	sub    $0xc,%esp
 181:	53                   	push   %ebx
 182:	e8 69 06 00 00       	call   7f0 <free>
   exit();
 187:	e8 57 03 00 00       	call   4e3 <exit>
...
worker(void *arg1, void *arg2) {
 ...
 1a7:	c7 00 37 00 00 00    	movl   $0x37,(%eax)
   assert(global == 1);
 1ad:	a1 dc 0d 00 00       	mov    0xddc,%eax
 1b2:	83 f8 01             	cmp    $0x1,%eax
 1b5:	74 46                	je     1fd <worker+0x6d>
 1b7:	6a 38                	push   $0x38
 1b9:	68 78 09 00 00       	push   $0x978
 1be:	68 81 09 00 00       	push   $0x981
 1c3:	6a 01                	push   $0x1
 1c5:	e8 86 04 00 00       	call   650 <printf>
 1ca:	83 c4 0c             	add    $0xc,%esp
 1cd:	68 89 09 00 00       	push   $0x989
 1d2:	68 95 09 00 00       	push   $0x995
 1d7:	6a 01                	push   $0x1
 ...
 1ec:	59                   	pop    %ecx
 1ed:	ff 35 e8 0d 00 00    	push   0xde8
 1f3:	e8 1b 03 00 00       	call   513 <kill>
 1f8:	e8 e6 02 00 00       	call   4e3 <exit>
   global = tmp1 + tmp2;
 1fd:	01 d9                	add    %ebx,%ecx
 1ff:	89 0d dc 0d 00 00    	mov    %ecx,0xddc
   exit();
 205:	e8 d9 02 00 00       	call   4e3 <exit>
 20a:	66 90                	xchg   %ax,%ax
 20c:	66 90                	xchg   %ax,%ax
 20e:	66 90                	xchg   %ax,%ax

00000210 <test_and_set>:
#include "stat.h"
#include "fcntl.h"
#include "user.h"
#include "x86.h"
...
void lock_acquire(lock_t *lock){
 ...
 256:	83 38 01             	cmpl   $0x1,(%eax)
 259:	75 05                	jne    260 <lock_acquire+0x10>
 25b:	eb fe                	jmp    25b <lock_acquire+0xb>
 25d:	8d 76 00             	lea    0x0(%esi),%esi
 260:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
 266:	5d                   	pop    %ebp
 267:	c3                   	ret    
 ...
 5ac:	89 d1                	mov    %edx,%ecx
{
 ...
 5d9:	0f b6 92 68 0a 00 00 	movzbl 0xa68(%edx),%edx
 ...
 659:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6c9:	ff 24 85 10 0a 00 00 	jmp    *0xa10(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 7d7:	90                   	nop
          s = "(null)";
 7d8:	ba 07 0a 00 00       	mov    $0xa07,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 7f1:	a1 ec 0d 00 00       	mov    0xdec,%eax
{
 ...
 831:	5b                   	pop    %ebx
  freep = p;
 832:	89 15 ec 0d 00 00    	mov    %edx,0xdec
}
 838:	5e                   	pop    %esi
 839:	5f                   	pop    %edi
 83a:	5d                   	pop    %ebp
 ...
 869:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 86c:	89 15 ec 0d 00 00    	mov    %edx,0xdec
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 889:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 88c:	8b 3d ec 0d 00 00    	mov    0xdec,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 8cf:	73 4f                	jae    920 <malloc+0xa0>
    ...
    if(p == freep)
 8d1:	8b 3d ec 0d 00 00    	mov    0xdec,%edi
 ...
 8fa:	e8 f1 fe ff ff       	call   7f0 <free>
  return freep;
 8ff:	8b 15 ec 0d 00 00    	mov    0xdec,%edx
 ...
 92c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 92f:	89 15 ec 0d 00 00    	mov    %edx,0xdec
}
 ...
 93f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 940:	c7 05 ec 0d 00 00 f0 	movl   $0xdf0,0xdec
 947:	0d 00 00 
    base.s.size = 0;
 94a:	bf f0 0d 00 00       	mov    $0xdf0,%edi
    base.s.ptr = freep = prevp = &base;
 94f:	c7 05 f0 0d 00 00 f0 	movl   $0xdf0,0xdf0
 956:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 959:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 95b:	c7 05 f4 0d 00 00 00 	movl   $0x0,0xdf4
 962:	00 00 00 
    if(p->s.size >= nunits){
