   ...
   e:	be 0a 00 00 00       	mov    $0xa,%esi
{
  ...
  15:	83 ec 0c             	sub    $0xc,%esp
   ppid = getpid();
  18:	e8 e6 04 00 00       	call   503 <getpid>
  1d:	a3 ac 0d 00 00       	mov    %eax,0xdac

   int i, thread_pid, join_pid;
   for(i = 0; i < 10; i++) {
  22:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      global = 1;
  28:	c7 05 a8 0d 00 00 01 	movl   $0x1,0xda8
  2f:	00 00 00 
  ...
  3e:	e8 8d 01 00 00       	call   1d0 <thread_create>
      assert(thread_pid > 0);
  ...
  4c:	e8 8f 01 00 00       	call   1e0 <thread_join>
      assert(join_pid == thread_pid);
  51:	39 c3                	cmp    %eax,%ebx
  53:	0f 85 84 00 00 00    	jne    dd <main+0xdd>
      assert(global == 5);
  59:	a1 a8 0d 00 00       	mov    0xda8,%eax
...
//	  printf(1, "%d\n", (uint)sbrk(0));
  ...
  6a:	6a 00                	push   $0x0
  6c:	e8 9a 04 00 00       	call   50b <sbrk>
  ...
  84:	50                   	push   %eax
  85:	50                   	push   %eax
  86:	68 89 09 00 00       	push   $0x989
  8b:	6a 01                	push   $0x1
  8d:	e8 5e 05 00 00       	call   5f0 <printf>
   exit();
  92:	e8 ec 03 00 00       	call   483 <exit>
      assert(thread_pid > 0);
  97:	6a 20                	push   $0x20
  99:	68 18 09 00 00       	push   $0x918
  9e:	68 22 09 00 00       	push   $0x922
  a3:	6a 01                	push   $0x1
  a5:	e8 46 05 00 00       	call   5f0 <printf>
  aa:	83 c4 0c             	add    $0xc,%esp
  ad:	68 57 09 00 00       	push   $0x957
      assert(join_pid == thread_pid);
  b2:	68 36 09 00 00       	push   $0x936
  b7:	6a 01                	push   $0x1
  ...
  c5:	6a 01                	push   $0x1
  c7:	e8 24 05 00 00       	call   5f0 <printf>
  cc:	5b                   	pop    %ebx
  cd:	ff 35 ac 0d 00 00    	push   0xdac
  d3:	e8 db 03 00 00       	call   4b3 <kill>
  d8:	e8 a6 03 00 00       	call   483 <exit>
  dd:	6a 22                	push   $0x22
  df:	68 18 09 00 00       	push   $0x918
  e4:	68 22 09 00 00       	push   $0x922
  e9:	6a 01                	push   $0x1
  eb:	e8 00 05 00 00       	call   5f0 <printf>
  f0:	83 c4 0c             	add    $0xc,%esp
  f3:	68 66 09 00 00       	push   $0x966
  f8:	eb b8                	jmp    b2 <main+0xb2>
      assert(global == 5);
  fa:	6a 23                	push   $0x23
  fc:	68 18 09 00 00       	push   $0x918
 101:	68 22 09 00 00       	push   $0x922
 106:	6a 01                	push   $0x1
 108:	e8 e3 04 00 00       	call   5f0 <printf>
 10d:	83 c4 0c             	add    $0xc,%esp
 110:	68 7d 09 00 00       	push   $0x97d
 115:	eb 9b                	jmp    b2 <main+0xb2>
      assert((uint)sbrk(0) < (150 * 4096) && "shouldn't even come close");
 117:	6a 25                	push   $0x25
 119:	68 18 09 00 00       	push   $0x918
 11e:	68 22 09 00 00       	push   $0x922
 123:	6a 01                	push   $0x1
 125:	e8 c6 04 00 00       	call   5f0 <printf>
 12a:	83 c4 0c             	add    $0xc,%esp
 12d:	68 98 09 00 00       	push   $0x998
...
worker(void *arg1, void *arg2) {
 ...
 143:	83 ec 08             	sub    $0x8,%esp
   assert(global == 1);
 146:	a1 a8 0d 00 00       	mov    0xda8,%eax
 14b:	83 f8 01             	cmp    $0x1,%eax
 14e:	74 46                	je     196 <worker+0x56>
 150:	6a 2e                	push   $0x2e
 152:	68 18 09 00 00       	push   $0x918
 157:	68 22 09 00 00       	push   $0x922
 15c:	6a 01                	push   $0x1
 15e:	e8 8d 04 00 00       	call   5f0 <printf>
 163:	83 c4 0c             	add    $0xc,%esp
 166:	68 2a 09 00 00       	push   $0x92a
 16b:	68 36 09 00 00       	push   $0x936
 170:	6a 01                	push   $0x1
 172:	e8 79 04 00 00       	call   5f0 <printf>
 177:	58                   	pop    %eax
 178:	5a                   	pop    %edx
 179:	68 4a 09 00 00       	push   $0x94a
 17e:	6a 01                	push   $0x1
 180:	e8 6b 04 00 00       	call   5f0 <printf>
 185:	59                   	pop    %ecx
 186:	ff 35 ac 0d 00 00    	push   0xdac
 18c:	e8 22 03 00 00       	call   4b3 <kill>
 191:	e8 ed 02 00 00       	call   483 <exit>
   global += 4;
 196:	a1 a8 0d 00 00       	mov    0xda8,%eax
 19b:	83 c0 04             	add    $0x4,%eax
 19e:	a3 a8 0d 00 00       	mov    %eax,0xda8
   exit();
 1a3:	e8 db 02 00 00       	call   483 <exit>
 ...
 54c:	89 d1                	mov    %edx,%ecx
{
 ...
 579:	0f b6 92 34 0a 00 00 	movzbl 0xa34(%edx),%edx
 ...
 5f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 669:	ff 24 85 dc 09 00 00 	jmp    *0x9dc(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 777:	90                   	nop
          s = "(null)";
 778:	ba d4 09 00 00       	mov    $0x9d4,%edx
        while(*s != 0){
 ...
 791:	a1 b0 0d 00 00       	mov    0xdb0,%eax
{
 ...
 7d1:	5b                   	pop    %ebx
  freep = p;
 7d2:	89 15 b0 0d 00 00    	mov    %edx,0xdb0
}
 7d8:	5e                   	pop    %esi
 7d9:	5f                   	pop    %edi
 7da:	5d                   	pop    %ebp
 ...
 809:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 80c:	89 15 b0 0d 00 00    	mov    %edx,0xdb0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 829:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 82c:	8b 3d b0 0d 00 00    	mov    0xdb0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 86f:	73 4f                	jae    8c0 <malloc+0xa0>
    ...
    if(p == freep)
 871:	8b 3d b0 0d 00 00    	mov    0xdb0,%edi
 ...
 89a:	e8 f1 fe ff ff       	call   790 <free>
  return freep;
 89f:	8b 15 b0 0d 00 00    	mov    0xdb0,%edx
 ...
 8cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8cf:	89 15 b0 0d 00 00    	mov    %edx,0xdb0
}
 ...
 8df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8e0:	c7 05 b0 0d 00 00 b4 	movl   $0xdb4,0xdb0
 8e7:	0d 00 00 
    base.s.size = 0;
 8ea:	bf b4 0d 00 00       	mov    $0xdb4,%edi
    base.s.ptr = freep = prevp = &base;
 8ef:	c7 05 b4 0d 00 00 b4 	movl   $0xdb4,0xdb4
 8f6:	0d 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8fb:	c7 05 b8 0d 00 00 00 	movl   $0x0,0xdb8
 902:	00 00 00 
    if(p->s.size >= nunits){
