...
main(int argc, char **argv)
{
  ...
  39:	e8 25 03 00 00       	call   363 <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 e9 02 00 00       	call   333 <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  ...
  53:	e8 48 04 00 00       	call   4a0 <printf>
    exit();
  58:	e8 d6 02 00 00       	call   333 <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
...
free(void *ap)
{
 ...
 641:	a1 9c 0b 00 00       	mov    0xb9c,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 9c 0b 00 00    	mov    %edx,0xb9c
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 9c 0b 00 00    	mov    %edx,0xb9c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d 9c 0b 00 00    	mov    0xb9c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d 9c 0b 00 00    	mov    0xb9c,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 9c 0b 00 00    	mov    0xb9c,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 9c 0b 00 00    	mov    %edx,0xb9c
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 9c 0b 00 00 a0 	movl   $0xba0,0xb9c
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf a0 0b 00 00       	mov    $0xba0,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 a4 0b 00 00 00 	movl   $0x0,0xba4
 7b2:	00 00 00 
    if(p->s.size >= nunits){
