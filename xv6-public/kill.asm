...
main(int argc, char **argv)
{
  ...
  2e:	83 c3 01             	add    $0x1,%ebx
    kill(atoi(argv[i]));
  31:	e8 6a 02 00 00       	call   2a0 <atoi>
  36:	89 04 24             	mov    %eax,(%esp)
  39:	e8 05 03 00 00       	call   343 <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 c9 02 00 00       	call   313 <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  4c:	68 98 07 00 00       	push   $0x798
  51:	6a 02                	push   $0x2
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 b4 07 00 00 	jmp    *0x7b4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba ac 07 00 00       	mov    $0x7ac,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 44 0b 00 00       	mov    0xb44,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 44 0b 00 00    	mov    %edx,0xb44
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 44 0b 00 00    	mov    %edx,0xb44
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d 44 0b 00 00    	mov    0xb44,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d 44 0b 00 00    	mov    0xb44,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 44 0b 00 00    	mov    0xb44,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 44 0b 00 00    	mov    %edx,0xb44
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 44 0b 00 00 48 	movl   $0xb48,0xb44
 767:	0b 00 00 
    base.s.size = 0;
 76a:	bf 48 0b 00 00       	mov    $0xb48,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 48 0b 00 00 48 	movl   $0xb48,0xb48
 776:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 4c 0b 00 00 00 	movl   $0x0,0xb4c
 782:	00 00 00 
    if(p->s.size >= nunits){
