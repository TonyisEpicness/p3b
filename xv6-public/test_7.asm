...
main(int argc, char *argv[])
{
   ...
   ppid = getpid();
  11:	e8 1d 04 00 00       	call   433 <getpid>
  16:	a3 64 0c 00 00       	mov    %eax,0xc64

   int fork_pid = fork();
  1b:	e8 8b 03 00 00       	call   3ab <fork>
   if(fork_pid == 0) {
  ...
  2c:	50                   	push   %eax
  2d:	e8 29 04 00 00       	call   45b <join>
   assert(join_pid == -1);
  32:	83 c4 10             	add    $0x10,%esp
  35:	83 c0 01             	add    $0x1,%eax
  38:	74 68                	je     a2 <main+0xa2>
  3a:	6a 22                	push   $0x22
  3c:	68 48 08 00 00       	push   $0x848
  41:	68 51 08 00 00       	push   $0x851
  46:	6a 01                	push   $0x1
  48:	e8 d3 04 00 00       	call   520 <printf>
  4d:	83 c4 0c             	add    $0xc,%esp
  50:	68 87 08 00 00       	push   $0x887
  55:	68 66 08 00 00       	push   $0x866
  5a:	6a 01                	push   $0x1
  5c:	e8 bf 04 00 00       	call   520 <printf>
  61:	5a                   	pop    %edx
  62:	59                   	pop    %ecx
  63:	68 7a 08 00 00       	push   $0x87a
  68:	6a 01                	push   $0x1
  6a:	e8 b1 04 00 00       	call   520 <printf>
  6f:	58                   	pop    %eax
  70:	ff 35 64 0c 00 00    	push   0xc64
  76:	e8 68 03 00 00       	call   3e3 <kill>
  7b:	e8 33 03 00 00       	call   3b3 <exit>
   assert(fork_pid > 0);
  80:	6a 1e                	push   $0x1e
  82:	68 48 08 00 00       	push   $0x848
  87:	68 51 08 00 00       	push   $0x851
  8c:	6a 01                	push   $0x1
  8e:	e8 8d 04 00 00       	call   520 <printf>
  93:	83 c4 0c             	add    $0xc,%esp
  96:	68 59 08 00 00       	push   $0x859
  9b:	eb b8                	jmp    55 <main+0x55>
     exit();
  9d:	e8 11 03 00 00       	call   3b3 <exit>

   assert(wait() > 0);
  a2:	e8 14 03 00 00       	call   3bb <wait>
  a7:	85 c0                	test   %eax,%eax
  a9:	7e 13                	jle    be <main+0xbe>
   printf(1, "TEST PASSED\n");
  ab:	50                   	push   %eax
  ac:	50                   	push   %eax
  ad:	68 a1 08 00 00       	push   $0x8a1
  b2:	6a 01                	push   $0x1
  b4:	e8 67 04 00 00       	call   520 <printf>
   exit();
  b9:	e8 f5 02 00 00       	call   3b3 <exit>
   assert(wait() > 0);
  be:	6a 24                	push   $0x24
  c0:	68 48 08 00 00       	push   $0x848
  c5:	68 51 08 00 00       	push   $0x851
  ca:	6a 01                	push   $0x1
  cc:	e8 4f 04 00 00       	call   520 <printf>
  d1:	83 c4 0c             	add    $0xc,%esp
  d4:	68 96 08 00 00       	push   $0x896
  d9:	e9 77 ff ff ff       	jmp    55 <main+0x55>
  de:	66 90                	xchg   %ax,%ax

000000e0 <test_and_set>:
#include "stat.h"
#include "fcntl.h"
#include "user.h"
#include "x86.h"
...
void lock_acquire(lock_t *lock){
 ...
 126:	83 38 01             	cmpl   $0x1,(%eax)
 129:	75 05                	jne    130 <lock_acquire+0x10>
 12b:	eb fe                	jmp    12b <lock_acquire+0xb>
 12d:	8d 76 00             	lea    0x0(%esi),%esi
 130:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
 136:	5d                   	pop    %ebp
 137:	c3                   	ret    
 ...
 47c:	89 d1                	mov    %edx,%ecx
{
 ...
 4a9:	0f b6 92 10 09 00 00 	movzbl 0x910(%edx),%edx
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 599:	ff 24 85 b8 08 00 00 	jmp    *0x8b8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6a7:	90                   	nop
          s = "(null)";
 6a8:	ba ae 08 00 00       	mov    $0x8ae,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c1:	a1 68 0c 00 00       	mov    0xc68,%eax
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	89 15 68 0c 00 00    	mov    %edx,0xc68
}
 708:	5e                   	pop    %esi
 709:	5f                   	pop    %edi
 70a:	5d                   	pop    %ebp
 ...
 739:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 73c:	89 15 68 0c 00 00    	mov    %edx,0xc68
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 3d 68 0c 00 00    	mov    0xc68,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 4f                	jae    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 7a1:	8b 3d 68 0c 00 00    	mov    0xc68,%edi
 ...
 7ca:	e8 f1 fe ff ff       	call   6c0 <free>
  return freep;
 7cf:	8b 15 68 0c 00 00    	mov    0xc68,%edx
 ...
 7fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ff:	89 15 68 0c 00 00    	mov    %edx,0xc68
}
 ...
 80f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 68 0c 00 00 6c 	movl   $0xc6c,0xc68
 817:	0c 00 00 
    base.s.size = 0;
 81a:	bf 6c 0c 00 00       	mov    $0xc6c,%edi
    base.s.ptr = freep = prevp = &base;
 81f:	c7 05 6c 0c 00 00 6c 	movl   $0xc6c,0xc6c
 826:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 829:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 82b:	c7 05 70 0c 00 00 00 	movl   $0x0,0xc70
 832:	00 00 00 
    if(p->s.size >= nunits){
