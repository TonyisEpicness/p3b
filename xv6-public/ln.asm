   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 4b 04 00 00       	call   470 <printf>
    exit();
  25:	e8 e9 02 00 00       	call   313 <exit>
  }
  ...
  32:	e8 3c 03 00 00       	call   373 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 d0 02 00 00       	call   313 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
...
void lock_acquire(lock_t *lock){
  ...
  86:	83 38 01             	cmpl   $0x1,(%eax)
  89:	75 05                	jne    90 <lock_acquire+0x10>
  8b:	eb fe                	jmp    8b <lock_acquire+0xb>
  8d:	8d 76 00             	lea    0x0(%esi),%esi
  90:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
  96:	5d                   	pop    %ebp
  97:	c3                   	ret    
...
000000b0 <lock_init>:
  ...
  b6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  bc:	5d                   	pop    %ebp
  bd:	c3                   	ret    
  be:	66 90                	xchg   %ax,%ax
 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 20 08 00 00 	movzbl 0x820(%edx),%edx
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 c8 07 00 00 	jmp    *0x7c8(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba bf 07 00 00       	mov    $0x7bf,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 4c 0b 00 00       	mov    0xb4c,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d 4c 0b 00 00    	mov    0xb4c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d 4c 0b 00 00    	mov    0xb4c,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
 ...
 74c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 74f:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
}
 ...
 75f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 4c 0b 00 00 50 	movl   $0xb50,0xb4c
 767:	0b 00 00 
    base.s.size = 0;
 76a:	bf 50 0b 00 00       	mov    $0xb50,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 50 0b 00 00 50 	movl   $0xb50,0xb50
 776:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 54 0b 00 00 00 	movl   $0x0,0xb54
 782:	00 00 00 
    if(p->s.size >= nunits){
