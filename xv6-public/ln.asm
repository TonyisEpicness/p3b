   ...
   a:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  20:	e8 7b 04 00 00       	call   4a0 <printf>
    exit();
  25:	e8 09 03 00 00       	call   333 <exit>
  }
  ...
  32:	e8 5c 03 00 00       	call   393 <link>
  37:	83 c4 10             	add    $0x10,%esp
  3a:	85 c0                	test   %eax,%eax
  3c:	78 05                	js     43 <main+0x43>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
  exit();
  3e:	e8 f0 02 00 00       	call   333 <exit>
    printf(2, "link %s %s: failed\n", argv[1], argv[2]);
...
void lock_acquire(lock_t *lock){
  ...
  a6:	83 38 01             	cmpl   $0x1,(%eax)
  a9:	75 05                	jne    b0 <lock_acquire+0x10>
  ab:	eb fe                	jmp    ab <lock_acquire+0xb>
  ad:	8d 76 00             	lea    0x0(%esi),%esi
  b0:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
  b6:	5d                   	pop    %ebp
  b7:	c3                   	ret    
...
free(void *ap)
{
 ...
 641:	a1 a4 0b 00 00       	mov    0xba4,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 a4 0b 00 00    	mov    %edx,0xba4
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 a4 0b 00 00    	mov    %edx,0xba4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d a4 0b 00 00    	mov    0xba4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d a4 0b 00 00    	mov    0xba4,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 a4 0b 00 00    	mov    0xba4,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 a4 0b 00 00    	mov    %edx,0xba4
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 a4 0b 00 00 a8 	movl   $0xba8,0xba4
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf a8 0b 00 00       	mov    $0xba8,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 a8 0b 00 00 a8 	movl   $0xba8,0xba8
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 ac 0b 00 00 00 	movl   $0x0,0xbac
 7b2:	00 00 00 
    if(p->s.size >= nunits){
