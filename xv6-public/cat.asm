...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 c7 03 00 00       	call   403 <open>
  ...
  57:	e8 8f 03 00 00       	call   3eb <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 5a 03 00 00       	call   3c3 <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	push   (%ebx)
  ...
  73:	e8 a8 04 00 00       	call   520 <printf>
      exit();
  78:	e8 46 03 00 00       	call   3c3 <exit>
    cat(0);
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 33 03 00 00       	call   3e3 <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 11 03 00 00       	call   3db <read>
  ...
  e6:	e8 35 04 00 00       	call   520 <printf>
      exit();
  eb:	e8 d3 02 00 00       	call   3c3 <exit>
  ...
  f9:	e8 22 04 00 00       	call   520 <printf>
    exit();
  fe:	e8 c0 02 00 00       	call   3c3 <exit>
...
void lock_acquire(lock_t *lock){
 ...
 136:	83 38 01             	cmpl   $0x1,(%eax)
 139:	75 05                	jne    140 <lock_acquire+0x10>
 13b:	eb fe                	jmp    13b <lock_acquire+0xb>
 13d:	8d 76 00             	lea    0x0(%esi),%esi
 140:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
 146:	5d                   	pop    %ebp
 147:	c3                   	ret    
 ...
 529:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 6a7:	90                   	nop
          s = "(null)";
 6a8:	ba 80 08 00 00       	mov    $0x880,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c1:	a1 60 0e 00 00       	mov    0xe60,%eax
{
 ...
 701:	5b                   	pop    %ebx
  freep = p;
 702:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 708:	5e                   	pop    %esi
 709:	5f                   	pop    %edi
 70a:	5d                   	pop    %ebp
 ...
 739:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 73c:	89 15 60 0e 00 00    	mov    %edx,0xe60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 759:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 75c:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 79f:	73 4f                	jae    7f0 <malloc+0xa0>
    ...
    if(p == freep)
 7a1:	8b 3d 60 0e 00 00    	mov    0xe60,%edi
 ...
 7ca:	e8 f1 fe ff ff       	call   6c0 <free>
  return freep;
 7cf:	8b 15 60 0e 00 00    	mov    0xe60,%edx
 ...
 7fc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7ff:	89 15 60 0e 00 00    	mov    %edx,0xe60
}
 ...
 80f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 810:	c7 05 60 0e 00 00 64 	movl   $0xe64,0xe60
 817:	0e 00 00 
    base.s.size = 0;
 81a:	bf 64 0e 00 00       	mov    $0xe64,%edi
    base.s.ptr = freep = prevp = &base;
 81f:	c7 05 64 0e 00 00 64 	movl   $0xe64,0xe64
 826:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 829:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 82b:	c7 05 68 0e 00 00 00 	movl   $0x0,0xe68
 832:	00 00 00 
    if(p->s.size >= nunits){
