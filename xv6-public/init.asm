...
main(void)
{
  ...
  19:	e8 c5 03 00 00       	call   3e3 <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 e8 03 00 00       	call   41b <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 dc 03 00 00       	call   41b <dup>
  ...
  52:	e8 a9 04 00 00       	call   500 <printf>
    pid = fork();
  57:	e8 3f 03 00 00       	call   39b <fork>
    if(pid < 0){
  ...
  70:	e8 36 03 00 00       	call   3ab <wait>
  ...
  9a:	e8 61 04 00 00       	call   500 <printf>
      exit();
  9f:	e8 ff 02 00 00       	call   3a3 <exit>
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 04 0c 00 00       	push   $0xc04
  ab:	68 56 08 00 00       	push   $0x856
  b0:	e8 26 03 00 00       	call   3db <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  be:	e8 3d 04 00 00       	call   500 <printf>
      exit();
  c3:	e8 db 02 00 00       	call   3a3 <exit>
    mknod("console", 1, 1);
  c8:	50                   	push   %eax
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 28 08 00 00       	push   $0x828
  d2:	e8 14 03 00 00       	call   3eb <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 28 08 00 00       	push   $0x828
  e0:	e8 fe 02 00 00       	call   3e3 <open>
  e5:	83 c4 10             	add    $0x10,%esp
  e8:	e9 3c ff ff ff       	jmp    29 <main+0x29>
  ed:	66 90                	xchg   %ax,%ax
  ef:	90                   	nop

000000f0 <test_and_set>:
#include "stat.h"
#include "fcntl.h"
#include "user.h"
#include "x86.h"
...
int test_and_set(int *old_ptr, int new_ptr) {
  ...
  *old_ptr = new_ptr;
  ...
  int old = *old_ptr;
  f9:	8b 10                	mov    (%eax),%edx
  *old_ptr = new_ptr;
  fb:	89 08                	mov    %ecx,(%eax)
  return old;
}
  fd:	5d                   	pop    %ebp
...
void lock_acquire(lock_t *lock){
 ...
 116:	83 38 01             	cmpl   $0x1,(%eax)
 119:	75 05                	jne    120 <lock_acquire+0x10>
 11b:	eb fe                	jmp    11b <lock_acquire+0xb>
 11d:	8d 76 00             	lea    0x0(%esi),%esi
 120:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
 126:	5d                   	pop    %ebp
 127:	c3                   	ret    
...
void lock_release(lock_t *lock) {
 ...
 136:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
}
 13c:	5d                   	pop    %ebp
 13d:	c3                   	ret    
...
free(void *ap)
{
 ...
 6a1:	a1 0c 0c 00 00       	mov    0xc0c,%eax
{
 ...
 6e1:	5b                   	pop    %ebx
  freep = p;
 6e2:	89 15 0c 0c 00 00    	mov    %edx,0xc0c
}
 6e8:	5e                   	pop    %esi
 6e9:	5f                   	pop    %edi
 6ea:	5d                   	pop    %ebp
 ...
 719:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 71c:	89 15 0c 0c 00 00    	mov    %edx,0xc0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 3d 0c 0c 00 00    	mov    0xc0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 77f:	73 4f                	jae    7d0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	8b 3d 0c 0c 00 00    	mov    0xc0c,%edi
 ...
 7aa:	e8 f1 fe ff ff       	call   6a0 <free>
  return freep;
 7af:	8b 15 0c 0c 00 00    	mov    0xc0c,%edx
 ...
 7dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7df:	89 15 0c 0c 00 00    	mov    %edx,0xc0c
}
 ...
 7ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 0c 0c 00 00 10 	movl   $0xc10,0xc0c
 7f7:	0c 00 00 
    base.s.size = 0;
 7fa:	bf 10 0c 00 00       	mov    $0xc10,%edi
    base.s.ptr = freep = prevp = &base;
 7ff:	c7 05 10 0c 00 00 10 	movl   $0xc10,0xc10
 806:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 809:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 80b:	c7 05 14 0c 00 00 00 	movl   $0x0,0xc14
 812:	00 00 00 
    if(p->s.size >= nunits){
