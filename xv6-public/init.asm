...
main(void)
{
  ...
  19:	e8 e5 03 00 00       	call   403 <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 08 04 00 00       	call   43b <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 fc 03 00 00       	call   43b <dup>
  ...
  52:	e8 d9 04 00 00       	call   530 <printf>
    pid = fork();
  57:	e8 5f 03 00 00       	call   3bb <fork>
    if(pid < 0){
  ...
  70:	e8 56 03 00 00       	call   3cb <wait>
  ...
  9a:	e8 91 04 00 00       	call   530 <printf>
      exit();
  9f:	e8 1f 03 00 00       	call   3c3 <exit>
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 5c 0c 00 00       	push   $0xc5c
  ab:	68 86 08 00 00       	push   $0x886
  b0:	e8 46 03 00 00       	call   3fb <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  ...
  be:	e8 6d 04 00 00       	call   530 <printf>
      exit();
  c3:	e8 fb 02 00 00       	call   3c3 <exit>
    mknod("console", 1, 1);
  c8:	50                   	push   %eax
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 58 08 00 00       	push   $0x858
  d2:	e8 34 03 00 00       	call   40b <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 58 08 00 00       	push   $0x858
  e0:	e8 1e 03 00 00       	call   403 <open>
 ...
 6d1:	a1 64 0c 00 00       	mov    0xc64,%eax
{
 ...
 711:	5b                   	pop    %ebx
  freep = p;
 712:	89 15 64 0c 00 00    	mov    %edx,0xc64
}
 718:	5e                   	pop    %esi
 719:	5f                   	pop    %edi
 71a:	5d                   	pop    %ebp
 ...
 749:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 74c:	89 15 64 0c 00 00    	mov    %edx,0xc64
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 769:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 76c:	8b 3d 64 0c 00 00    	mov    0xc64,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7af:	73 4f                	jae    800 <malloc+0xa0>
    ...
    if(p == freep)
 7b1:	8b 3d 64 0c 00 00    	mov    0xc64,%edi
 ...
 7da:	e8 f1 fe ff ff       	call   6d0 <free>
  return freep;
 7df:	8b 15 64 0c 00 00    	mov    0xc64,%edx
 ...
 81f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 820:	c7 05 64 0c 00 00 68 	movl   $0xc68,0xc64
 827:	0c 00 00 
    base.s.size = 0;
 82a:	bf 68 0c 00 00       	mov    $0xc68,%edi
    base.s.ptr = freep = prevp = &base;
 82f:	c7 05 68 0c 00 00 68 	movl   $0xc68,0xc68
 836:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 839:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 83b:	c7 05 6c 0c 00 00 00 	movl   $0x0,0xc6c
 842:	00 00 00 
    if(p->s.size >= nunits){
